  ...
  render() {
    ...
    return (
      <div class="relative w-full max-w-xs font-sans text-right" dir="rtl">
        ...
        <button
          type="button"
          class="w-full bg-white border border-[#ecf2f7]/80 rounded-lg max-lg:shadow-13 h-[48px] px-4 py-2 text-right flex items-center justify-between focus:outline-none focus:ring-1 focus:ring-primary-500"
          onClick={this.toggleDropdown}
        >
          <span class="text-[#0F172B] font-extrabold truncate">
