    ...
    return (
      <Host class="flex justify-center items-center gap-2 select-none">
        <button
          ...
          class="w-9 h-9 flex items-center justify-center rounded-lg border border-[#E4EBF0] bg-white hover:bg-gray-50 disabled:opacity-50 disabled:cursor-not-allowed transition-colors text-navyBlue"
        >
          ...
          page === '...' ? (
            ...
            <button
              ...
              class={{
                ...
                'bg-white text-navyBlue border border-[#E4EBF0] hover:border-primary-500 hover:text-primary-500': this.currentPage !== page
              }}
            >
              {page}
            </button>
