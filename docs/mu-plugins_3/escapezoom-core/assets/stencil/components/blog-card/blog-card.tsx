...
export class EzBlogCard {
  ...
  render() {
    return (
      <Host class={{
        'relative grow-0 shrink-0 w-[310px] max-lg:h-[174px] lg:h-[230px] block': true,
        'embla__slide': !!this.isSlide
      }}>
        <a class="relative block overflow-hidden rounded-[16px] shadow-8 w-[310px] max-lg:h-[174px] lg:h-[230px]"
          href={this.href || '#'}>
          <slot name="image" />
          <div class="absolute right-0 top-0 flex h-full w-full flex-col justify-between bg-gradient-to-t from-[#09192D] to-transparent max-lg:p-3 lg:p-6 text-white/90">
