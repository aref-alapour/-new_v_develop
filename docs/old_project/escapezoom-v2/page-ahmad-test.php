...
$home_trends_rooms = json_decode(ez_webservice(array('type' => 'sort_products_get', 'data' => $args)))->products;
/*===============================================================*/
...
<section class="max-w-full py-4 md:py-5 lg:py-9">
    ...
    <div class="swiper products-carousel relative">
        <div id="trends-rooms-slider" class="swiper-wrapper first:child:before:hidden child:before:w-px child:before:absolute child:before:bg-gradient-to-t child:before:from-white child:before:via-slate-110 child:before:to-white child:before:-right-3.5 child:lg:before:-right-6 child:before:h-full min-h-[200px] child:box-content lg:min-h-[300px]">
            <?= $home_trends_rooms ?>
        </div>
...
$cities_cinema = json_decode(ez_webservice(array('type' => 'sort_products_get', 'data' => $args)))->products;
/*===============================================================*/
?>
<section class="max-w-full py-4 md:py-5 lg:py-9">
    <div class="mb-6 md:mb-8">
    ...
    <div class="swiper products-carousel relative">
        <div id="cities-cinema-slider" class="swiper-wrapper first:child:before:hidden child:before:w-px child:before:absolute child:before:bg-gradient-to-t child:before:from-white child:before:via-slate-110 child:before:to-white child:before:-right-3.5 child:lg:before:-right-6 child:before:h-full min-h-[200px] child:box-content lg:min-h-[300px]">
            <?= $cities_cinema ?>
        </div>
...
$discountEvent = json_decode(ez_webservice(array('type' => 'sort_products_get', 'data' => $args)))->products;
/*===============================================================*/
?>
<section class="max-w-full py-8 md:py-5 max-md:px-8 max-md:bg-[#E4EBF0] max-md:max-w-none max-md:-ml-4 max-md:-mr-4">
            ...
            <div class="flex">
                <div class="items-center md:flex gap-0 lg:[&>h2]:bg-slate-50 lg:[&>h2]:h-full lg:[&>h2]:rounded-tr-4xl lg:[&>h2]:pr-8 [&>h2_b]:text-secondary-500">
                    <h2 class="flex items-center gap-4">
                        <div class="hidden md:block">
                            <img alt="[object Object]" loading="lazy" width="32" height="32" decoding="async"
                                 data-nimg="1"
                                 src="https://escapezoom.ir/wp-content/themes/escapezoom-v1/img/Takhfif.svg"
                    ...
                    <div class="hidden md:block" style="margin-right: -2px; margin-bottom: -2px;">
                        <svg xmlns="http://www.w3.org/2000/svg" width="178" height="90" fill="none" viewBox="0 0 178 90"
                             class="max-lg:hidden">
...
$cities_lasertag = json_decode(ez_webservice(array('type' => 'sort_products_get', 'data' => $args)))->products;
/*===============================================================*/
?>
<section class="max-w-full py-4 md:py-5 lg:py-9 max-lg:mt-8">
    ...
    <div class="swiper products-carousel relative">
        <div id="cities-lasertag-slider" class="swiper-wrapper first:child:before:hidden child:before:w-px child:before:absolute child:before:bg-gradient-to-t child:before:from-white child:before:via-slate-110 child:before:to-white child:before:-right-3.5 child:lg:before:-right-6 child:before:h-full min-h-[200px] child:box-content lg:min-h-[300px]">
            <?= $cities_lasertag ?>
        </div>
            ...
            <div class="flex justify-between">
                <div class="items-center gap-6 md:flex">
                    <h3 class="flex items-center gap-4">
                        <svg xmlns="http://www.w3.org/2000/svg" width="20" viewBox="0 0 22 23"
                             class="max-md:hidden">
        ...
        <div class="swiper blogs-carousel relative pb-6">
            <div class="swiper-wrapper" id="blog-slider">
                <?php while ($query->have_posts()) : $query->the_post(); ?>
                    <div class="swiper-slide relative grow-0 shrink-0 w-[264px] h-[300px]">
                        <a class="relative block w-full overflow-hidden rounded-lg lg:rounded-3xl shadow-8  max-lg:[&_.ez-post-category]:hidden max-lg:[&_.ez-post-desc]:hidden max-lg:[&_.ez-post-info]:hidden w-[264px] h-[300px]"
                           href="<?php the_permalink(); ?>">
                            ...
                            <div class="absolute right-0 top-0 flex h-full w-full flex-col justify-between bg-slate-900/60 p-6 text-white/90 max-lg:justify-center">
                                ...
                                <div class="text-center">
                                    ...
                                    <p class="ez-post-desc mx-auto mt-3.5 max-w-[500px] text-2xs leading-6 lg:mt-5 line-clamp-4"><?= get_the_excerpt() ?></p>
                           ...
                           href="${data.url}">
                            ...
                            <div class="absolute right-0 top-0 flex h-full w-full flex-col justify-between bg-slate-900/60 p-6 text-white/90 max-lg:justify-center">
                                ...
                                <div class="text-center">
                                    ...
                                    <p class="ez-post-desc mx-auto mt-3.5 max-w-[500px] text-2xs leading-6 lg:mt-5 line-clamp-4">${data.excerpt}</p>
                                    <div class="ez-post-info mt-4 flex items-center justify-center gap-5 text-xs lg:mt-6">
                                        <span>0 دیدگاه</span>
                                        <span class="h-3.5 border-l border-white/40"></span>
                                        <span>نویسنده</span>
