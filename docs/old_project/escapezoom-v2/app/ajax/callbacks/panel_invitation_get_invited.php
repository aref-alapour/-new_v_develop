...
<div class="max-lg:divide-y-2 lg:space-y-7">
    <?php if ($items) { ?>
        ...
        <?php foreach ($items as $item) { ?>
            <div class="max-lg:py-8 lg:grid lg:grid-cols-2 lg:rounded-xlh lg:border lg:border-[#E4EBF0] lg:p-5">

                <div class="flex max-lg:items-center max-lg:justify-between lg:gap-x-6">
                    <div class="lg:order-1">
                        <div class="lg:flex lg:items-center lg:gap-x-3">
                            <span class="-mt-1.5 flex h-6 w-10 items-center justify-center rounded bg-[#EFC101] max-lg:hidden">
                        ...
                        <div class="my-3 space-x-px space-x-reverse text-4xs text-[#889BAD] max-lg:hidden">
                            <span><?php echo esc_html($item['product']['hood']) ?></span>
                            .
                            <span><?php echo esc_html($item['product']['city']) ?></span>
                        </div>
                        <div class="space-x-px space-x-reverse text-4xs text-[#889BAD]">
                        ...
                        <div>
                            <a href="<?php echo $item['product']['url']; ?>">
                                <?php echo wp_get_attachment_image($item['product']['image'], 'large', '', [
                                    'class' => 'h-[52px] w-[43px] rounded-md object-cover lg:h-[115px] lg:w-[95px]',
                                ]) ?>
                            </a>
                        </div>
                    <?php } ?>
                ...
                <div class="lg:content-center lg:space-y-4">
                    ...
                    <div class="flex items-center justify-between rounded-lg bg-[#F2F6FA] px-3 py-2 max-lg:my-4">

                        <div class="flex h-8 w-8 items-center justify-center rounded-lg bg-white shadow">
                            <svg class="mx-0" xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 9 9" fill="none">
                        ...
                        <div class="space-x-3 space-x-reverse">
                            <?php if ($status == 'was-invited') { ?>
                                <span class="inline-block text-[14px] text-[#889BAD]">'دعوت کننده</span>
                                <a href="<?php echo esc_html($item['invitation']['url']); ?>" class="inline-block text-base text-[#3F7FF5]">
                            ...
                            <?php } else { ?>
                                ...
                                <span class="inline-block text-[14px] text-[#889BAD]">
                                    دعوت کردید
                                </span>
                            <?php } ?>
                    ...
                    <div id="item-<?php echo esc_attr($item['ID']); ?>-actions">
                        <?php if ($item['invitation']['status'] == 'pending') { ?>
                            ...
                            <?php if ($status === 'was-invited') { ?>
                                <div class="grid grid-cols-2 gap-x-5">
                                    <button type="button" data-invite-action="approved" data-id="<?php echo esc_attr($item['ID']); ?>" class="flex h-12.5 w-full items-center justify-center gap-x-4 rounded-lg border border-[#E4EBF0]">
                                        <span>می‌پذیرم</span>
                                        <span>
                                    ...
                                    <button type="button" data-invite-action="declined" data-id="<?php echo esc_attr($item['ID']); ?>" class="flex h-12.5 w-full items-center justify-center gap-x-4 rounded-lg border border-[#E4EBF0]">
                                        <span>نمی‌پذیرم</span>
                                        <span>
                            ...
                            <?php } else { ?>
                                <div class="flex h-12.5 w-full items-center justify-center gap-x-5 rounded-lg bg-[#FDF9E6]">
                        ...
                        <?php } elseif ($item['invitation']['status'] == 'approved') { ?>
                            ...
                            <?php if ($status === 'was-invited') { ?>
                                <div class="flex h-12.5 items-center justify-center gap-x-5 rounded-lg bg-[#E6FAF1]">
                                    <span>پذیرفتم</span>
                                    <span class="-mt-1">
                            ...
                            <?php } else { ?>
                                <a href="tel:+98<?php echo str_starts_with(0, $item['invitation']['phone']) ? substr($item['invitation']['phone'], 0, 1) : $item['invitation']['phone']; ?>" class="flex h-12.5 items-center justify-center gap-x-5 rounded-lg bg-[#02C96F]">
                                    <div class="flex items-center gap-x-4">
                                        <span class="text-[14px] text-[#E4EBF0]">
                        ...
                        <?php } elseif ($item['invitation']['status'] == 'declined') { ?>
                            ...
                            <?php if ($status === 'was-invited') { ?>
                                <div class="flex h-12.5 items-center justify-center gap-x-5 rounded-lg bg-[#FEE8EC]">
                                    <span>نپذیرفتم</span>
                                    <span class="-mt-1">
    ...
    <?php } else { ?>
        <div class="text-[22px] font-bold lg:text-lg text-center mt-16 mb-12 text-gray-500">
            <?php echo $alert; ?>
        </div>
    <?php } ?>
                    ...
                    if (result.isConfirmed) {
                        $.ajax({
                            ...
                            beforeSend: function() {
                                ...
                                <div class="flex h-12.5 w-full items-center justify-center gap-x-4 rounded-lg border border-[#E4EBF0]">
