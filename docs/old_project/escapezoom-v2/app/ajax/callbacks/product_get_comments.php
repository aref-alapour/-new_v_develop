...
if ($sort_type === 'pro') {
    ...
    foreach ($all_comments as $comment) {
        ...
        // فقط کامنت‌های با level 3 (با تجربه) و 4 (کارکشته)
        if ($user_level >= 3) {
...
foreach ($comments as $comment) {
    ...
    // User level
    $instant_user_level = get_comment_meta($comment_id, 'user_level', true) ?: 1;
    ...
    <div class="border border-[#E4EBF0] flex justify-between items-start rounded-2xl max-lg:pt-7 lg:p-7 mt-8">
        <div class="flex flex-col w-full">
                                ...
                                <span class="min-w-36">
                                    <div class="flex items-center justify-center" dir="ltr">
                                        ...
                                        <div class="w-full h-1 rounded-full bg-slate-110">
                                            <div class="h-1 rounded-full bg-[#2B7FFF]" style="width: <?php echo isset($comment_ratings[1094]) ? $comment_ratings[1094] * 20 : 0; ?>%;"></div>
                                        </div>
                                    </div>
                                </span>
                            </div>
                            <div class="flex items-center justify-between">
                                ...
                                <span class="min-w-36">
                                    <div class="flex items-center justify-center" dir="ltr">
                                        ...
                                        <div class="w-full h-1 rounded-full bg-slate-110">
                                            <div class="h-1 rounded-full bg-[#2B7FFF]" style="width: <?php echo isset($comment_ratings[1095]) ? $comment_ratings[1095] * 20 : 0; ?>%;"></div>
                                        </div>
                                    </div>
                                </span>
                            </div>
                            <div class="flex items-center justify-between">
                                ...
                                <span class="min-w-36">
                                    <div class="flex items-center justify-center" dir="ltr">
                                        ...
                                        <div class="w-full h-1 rounded-full bg-slate-110">
                                            <div class="h-1 rounded-full bg-[#2B7FFF]" style="width: <?php echo isset($comment_ratings[1098]) ? $comment_ratings[1098] * 20 : 0; ?>%;"></div>
                                        </div>
                                    </div>
                                </span>
                            </div>
                            <div class="flex items-center justify-between">
                                ...
                                <span class="min-w-36">
                                    <div class="flex items-center justify-center" dir="ltr">
                                        ...
                                        <div class="w-full h-1 rounded-full bg-slate-110">
                                            <div class="h-1 rounded-full bg-[#2B7FFF]" style="width: <?php echo isset($comment_ratings[1096]) ? $comment_ratings[1096] * 20 : 0; ?>%;"></div>
                                        </div>
                                    </div>
                                </span>
                            </div>
                            <div class="flex items-center justify-between">
                                ...
                                <span class="min-w-36">
                                    <div class="flex items-center justify-center" dir="ltr">
                                        ...
                                        <div class="w-full h-1 rounded-full bg-slate-110">
                                            <div class="h-1 rounded-full bg-[#2B7FFF]" style="width: <?php echo isset($comment_ratings[1097]) ? $comment_ratings[1097] * 20 : 0; ?>%;"></div>
                                        </div>
                                    </div>
                                </span>
                            </div>
            ...
            <div class="flex justify-between items-center border-t botder-t-[#E4EBF0] lg:border lg:border-[#E4EBF0] lg:rounded-xl p-2 lg:my-3">
                ...
                <p class="text-xs font-bold text-[#889BAD]"><?php echo human_time_diff($comment_date, current_time('U')) ?> پیش</p>
            </div>
            ...
            <?php if ($reply_content) { ?>
                <div class="bg-[#F3F9FC] rounded-lg flex flex-col p-2 max-lg:hidden">
                    ...
                    <div class="flex mt-3">
                        ...
                        <p class="text-[#62748E]"><?= esc_html($reply_content); ?></p>
                    </div>
                </div>
            <?php } ?>
        </div>
