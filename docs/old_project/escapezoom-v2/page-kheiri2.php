...
add_action('wp_enqueue_scripts', function() {
    if (is_page_template('page-kheiri2.php')) {
        wp_enqueue_script('qrcode-js', Theme_URL . 'assets/vendor/qrcode/qrcode.js', [], '1.0', true);
    }
}, 20);
...
<body>
    ...
    jQuery(document).ready(function($) {
        ...
        const ajaxUrl = "<?php echo get_template_directory_uri(); ?>/template/func/kheiri2-ajax.php";
