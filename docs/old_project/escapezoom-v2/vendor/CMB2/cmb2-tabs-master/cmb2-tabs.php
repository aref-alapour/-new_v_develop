...
if( !class_exists( 'RGC_CMB2_Tabs' ) ) {
    ...
    class RGC_CMB2_Tabs {
        ...
        public function setup_admin_scripts() {
            wp_register_script( 'cmb-tabs',Theme_URL.'vendor/CMB2/cmb2-tabs-master/js/tabs.js', array( 'jquery' ), self::VERSION, true );
            wp_enqueue_script( 'cmb-tabs' );

            wp_enqueue_style( 'cmb-tabs', Theme_URL.'vendor/CMB2/cmb2-tabs-master/css/tabs.css', array(), self::VERSION );
