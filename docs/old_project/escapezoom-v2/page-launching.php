<?php get_header(); ?>
    ...
    <!-- start-section-1 --------------------------------------------->
      <section
              class="container mx-auto mb-[70px] px-4 sm:px-6 md:px-8 lg:mt-[80px] h-[100%]" >
        <div
                class="relative flex flex-col lg:flex-row items-center justify-center lg:justify-around pb-[50px] lg-[35px] px-[26px] lg:gap-x-20"
                style="
          ...
          <div  class="flex flex-col  justify-start max-w-[521px] shrink-0">
            <h2 class="text-4xl lg:text-5xl text-salte-700 mb-5 font-fat-yekanbakh !leading-[1.7] text-center">
              زمین بازی عوض شد...!
            </h2>
          ...
          <div class="lg:h-[340px] mt-[30px] lg:mt-[0px] lg:w-1/2 aspect-[6/4]">
            ...
            <div id="hero-video" class="max-w-[80%] shadow h-[80%] fixed z-[200] aspect-[3/5] top-1/2 left-1/2 -translate-y-1/2 -translate-x-1/2 hidden">
              <button type="button" id="hero-video-close" class="absolute left-0 text-primary-500 bg-white w-6 h-6 rounded-full flex items-center justify-center text-3xl leading-[16px] cursor-pointer z-10"><span class="mt-1">×</span></button>
      ...
      <!-- start-section-2--------------------------------------------->
      <section class="container mx-auto mb-[70px] px-4 sm:px-6 md:px-8">
        <h2 class="text-4xl lg:text-5xl text-salte-700 mb-5 font-fat-yekanbakh !leading-[1.7] text-center">
          مهم ترین ویژگی‌های جدید
        </h2>

        <div class="flex flex-col lg:flex-row justify-around  lg:items-center mt-[60px] gap-[37px] px-[15px]">

          <div class="flex flex-col justify-center items-start gap-[37px] lg:gap-[59px] ">
            <div class="flex gap-[18px]">
              <img src="<?= Theme_URL ?>assets/images/ShowUp/tick.png" alt="tick" class="w-[31px] h-[26px]"/>
              <p class="text-[19px] lg:text-2xl font-black">نقشه‌بازی‌ایران</p>
            </div>

            <div class="flex gap-[18px]">
              <img src="<?= Theme_URL ?>assets/images/ShowUp/tick.png" alt="tick" class="w-[31px] h-[26px]"/>
              <p class="text-[19px] lg:text-2xl font-black">ساخت کالکشن پیشنهادی بازی</p>
            </div>
          </div>
          ...
          <div class="flex flex-col justify-center items-start gap-[37px] lg:gap-[59px]">
            <div class="flex gap-[18px]">
              <img src="<?= Theme_URL ?>assets/images/ShowUp/tick.png" alt="tick" class="w-[31px] h-[26px]"/>
              <p class="text-[19px] lg:text-2xl font-black">سطح بندی‌ و‌ قدرت متفاوت کاربران</p>
            </div>

            <div class="flex gap-[18px]">
              <img src="<?= Theme_URL ?>assets/images/ShowUp/tick.png" alt="tick" class="w-[31px] h-[26px]"/>
              <p class="text-[19px] lg:text-2xl font-black">سانس یاب حرفه‌ای</p>
            </div>
          </div>
          ...
          <div class="flex flex-col justify-center items-start gap-[37px] lg:gap-[59px]">
            <div class="flex gap-[18px]">
              <img src="<?= Theme_URL ?>assets/images/ShowUp/tick.png" alt="tick" class="w-[31px] h-[26px]"/>
              <p class="text-[19px] lg:text-2xl font-black">دعوت از پلیرها برای بازی</p>
            </div>

            <div class="flex gap-[18px]">
              <img src="<?= Theme_URL ?>assets/images/ShowUp/tick.png" alt="tick" class="w-[31px] h-[26px]"/>
              <p class="text-[19px] lg:text-2xl font-black">پنل کاربری پیشرفته</p>
            </div>
          </div>
      ...
      <section class="container mx-auto mb-[70px] px-4 sm:px-6 md:px-8">
        <div class="flex flex-col lg:flex-row items-center lg:justify-between mt-[50px] lg:mt-[111px]">
          <p class="text-lg lg:text-2xl font-bold text-center">بازی از همین جا شروع شده، آماده ای؟!</p>

          <button
                  class="rounded-2xl text-nowrap text-center bg-primary-500 text-slate-100 border border-primary-500 h-[52px] w-[250px] lg:w-[169px] px-3 mt-[14px] lg:mt-[0px] md:px-5 flex justify-center items-center text-xl"
      ...
      <!-- start-section-3--------------------------------------------->
      <section class="lg:container mx-auto mb-[70px] mt-[100px] sm:px-6 md:px-8">
        <div class="lg:mx-[200px]">
          <div class="swiper mySwiperShowUp relative">
            ...
            <div class="swiper-wrapper">
                ...
                <!-- <img src="./assets/images/ShowUp/slider-2.png" alt="Slide 3" class="w-[300px] h-[533px] rounded-[20px]" />
                ...
                <div class="swiper-slide">
                <!-- <img src="./assets/images/ShowUp/slider-2.png" alt="Slide 4" class="w-[300px] h-[533px] rounded-[20px]" />
                <img src="./assets/images/ShowUp/icon-player.svg" alt="Play Icon" class="absolute left-1/2 top-1/2 -translate-y-1/2 -translate-x-1/2" style="width: 83px; height: 83px;" /> -->
                <video controls style="border-radius:20px" >
              ...
              <div class="swiper-slide">
                <!-- <img src="./assets/images/ShowUp/slider-1.png" alt="Slide 1" class="w-[300px] h-[533px] rounded-[20px]" />
                <img src="./assets/images/ShowUp/icon-player.svg" alt="Play Icon" class="absolute left-1/2 top-1/2 -translate-y-1/2 -translate-x-1/2" style="width: 83px; height: 83px;" /> -->
                <video controls style="border-radius:20px" >
              ...
              <div class="swiper-slide">
                <!-- <img src="./assets/images/ShowUp/slider3.png" alt="Slide 2" class="w-[300px] h-[533px] rounded-[20px]" />
                <img src="./assets/images/ShowUp/icon-player.svg" alt="Play Icon" class="absolute left-1/2 top-1/2 -translate-y-1/2 -translate-x-1/2" style="width: 83px; height: 83px;" /> -->
                <video controls style="border-radius:20px" >
      ...
      <!-- start-section-4--------------------------------------------->
     <!-- <section class="container mx-auto mb-[40px] px-4 sm:px-6 lg:px-8">
        <div class="flex flex-col justify-center lg:mx-[200px] mb-[70px]">
          <p class="text-4xl lg:text-5xl text-salte-700 mb-5 font-fat-yekanbakh !leading-[1.7] text-center mt-[40px] mb-[20px]">
            شکار تخفیف‌های هیجان انگیز
          </p>

          <p class="text-base lg:text-2xl font-bold text-center px-[20px]" style="line-height: 50px;">
        ...
        <div class="mt-auto flex items-center justify-center" dir="ltr">
          <div class="flex items-center justify-between gap-1">
            <span class="product-timer hours-tens flex h-[48px] lg:h-[100px] w-[42px] lg:w-[86px] items-center justify-center rounded-lg bg-secondary-600 text-[40px] lg:text-[60px] font-black text-white shadow-5">5</span>
            <span class="product-timer hours-units flex h-[48px] lg:h-[100px] w-[42px] lg:w-[86px] items-center justify-center rounded-lg bg-secondary-600 text-[40px] lg:text-[60px] font-black text-white shadow-5">2</span>
          </div>
          <span class="px-1 text-2xl lg:text-[60px] text-slate-150">:</span>
          <div class="flex items-center justify-between gap-1">
            <span class="product-timer minutes-tens flex h-[48px] lg:h-[100px] w-[42px] lg:w-[86px] items-center justify-center rounded-lg bg-secondary-600 text-[40px] lg:text-[60px] font-black text-white shadow-5">5</span>
            <span class="product-timer minutes-units flex h-[48px] lg:h-[100px] w-[42px] lg:w-[86px] items-center justify-center rounded-lg bg-secondary-600 text-[40px] lg:text-[60px] font-black text-white shadow-5">2</span>
          </div>
          <span class="px-1 text-2xl lg:text-[60px] text-slate-150">:</span>
          <div class="flex items-center justify-between gap-1">
            <span class="product-timer seconds-tens flex h-[48px] lg:h-[100px] w-[42px] lg:w-[86px] items-center justify-center rounded-lg bg-secondary-600 text-[40px] lg:text-[60px] font-black text-white shadow-5">5</span>
            <span class="product-timer seconds-units flex h-[48px] lg:h-[100px] w-[42px] lg:w-[86px] items-center justify-center rounded-lg bg-secondary-600 text-[40px] lg:text-[60px] font-black text-white shadow-5">2</span>
          </div>
        </div>
        <h2 class="text-4xl lg:text-5xl text-salte-700 mb-5 font-fat-yekanbakh !leading-[1.7] text-center mt-[40px]">
      ...
      <!-- end-section-4 ---------------------------------------------->
    <!-- end-section-5----------------------------------------------->
    <section class="container mx-auto pb-[70px] px-4 sm:px-6 md:px-8">
