<?php get_header(); ?>
    ...
    <section class="container mx-auto px-4 sm:px-6 md:px-8">
        ...
        <div class="flex flex-row flex-wrap justify-start items-center my-[30px] lg:my-[53px] gap-[28px]">
            ...
            <div class="flex flex-row gap-2">
                <button type="button" data-time="1-week" class="time-option rounded-[12px] p-[10px] text-xs font-bold bg-primaryColor text-white active" style="border: 1px solid #E4EBF0;">
                    در یک هفته
                </button>
                <button type="button" data-time="1-month" class="time-option rounded-[12px] p-[10px] text-xs font-bold text-[#889BAD]" style="border: 1px solid #E4EBF0;">
                    در یک ماه
                </button>
                <button type="button" data-time="3-month" class="time-option rounded-[12px] p-[10px] text-xs font-bold text-[#889BAD]" style="border: 1px solid #E4EBF0;">
                    در سه ماه
                </button>
                <button type="button" data-time="1-year" class="time-option rounded-[12px] p-[10px] text-xs font-bold text-[#889BAD]" style="border: 1px solid #E4EBF0;">
                    در یک سال
                </button>
            </div>
    ...
    <section class="container mx-auto lg:mb-[70px] lg:px-8">
        <div class="flex flex-col gap-[14px] lg:rounded-[20px] bg-[#E8EDF1] h-[100%] w-full px-[30px] lg:px-[100px] py-10 rounded-xl mb-8 results">
    ...
    <script>
        jQuery(document).ready(function ($) {
            ...
            $("body").on('click', '.time-option', function () {
                $(".time-option").removeClass('bg-primaryColor text-white active').addClass('text-[#889BAD]')
                $(this).addClass('bg-primaryColor text-white active').removeClass('text-[#889BAD]')
