...
//     تبدیل درخواست ها به موعد بررسی گذشت
    if ($hours_to_sans <= TIME_TO_EXPIRE) {
            ...
            <div class="flex-col items-center justify-center bg-[#F8FAFB] px-[20px] pt-2 pb-[20px] description hidden">
                ...
                <div class="flex justify-between items-center mt-[14px] mx-[20px]">
                    ...
                    <div class="flex">
                        ...
                        <div class="rounded-[24px] h-5.5 px-2.5 leading-none content-center text-2xs text-center <?php echo $themeColor ?>" style="background-color: rgba(253, 112, 19, 0.2)">
                            <?php echo $themeText; ?>
                        </div>
                    </div>
                    <div class="flex flex-col">
