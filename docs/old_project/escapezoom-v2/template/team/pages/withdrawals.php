...
<div class="flex justify-between items-center flex-wrap gap-8">
    <div class="flex justify-center items-center gap-[50px] flex-wrap">
        <h1 class="text-base font-extrabold lg:text-2xl">تسویه حساب ها</h1>
        <!-- فیلتر نوع کاربر -->
        <div class="flex gap-2" id="filterTabsType">
            <div class="taborder text-sm font-yekan-bold p-2 text-center w-[80px] bg-white border border-[#E4EBF0]  text-grayy rounded-xl cursor-pointer active" data-type="compiler"> مجموعه دار </div>
            <div class="taborder text-sm font-yekan-bold text-center text-grayy w-[93px] p-2 bg-white border border-[#E4EBF0] rounded-xl cursor-pointer" data-type="customer"> پلیر </div>
        </div>
    </div>
    <!-- فیلتر وضعیت -->
    ...
    <!-- جست‌وجو -->
    <div id="withdrawal_search" class="relative w-[304px] h-[58px]" style="z-index: 99">
        <input type="text" id="searchInput" class="w-[304px] h-[58px] border border-[#E4EBF0] bg-[#FAFDFF] rounded-xl outline-none px-6 py-5 text-xs font-yekan-bold text-navyBlue" placeholder="جست و جو" />
