...
<div class="flex justify-between items-center mb-6">
    ...
    <button id="addUserBtn" class="bg-[#FD7013] hover:bg-[#CA5608] text-white px-6 py-3 rounded-lg text-base font-yekan-bold cursor-pointer">
        افزودن کاربر
    </button>
</div>
<!-- Search and Filter -->
<div class="flex items-center gap-4 mb-6">
    <div class="relative w-full max-w-md">
        <input id="userSearch" type="text" placeholder="جستجو کاربر (شماره موبایل، نام، نام خانوادگی، آیدی، نام بازی)"
            class="w-full h-[58px] border border-[#E4EBF0] bg-[#FAFDFF] rounded-xl outline-none px-6 py-5 text-xs font-bold text-navyBlue" />
        ...
        <div id="searchLoading" class="absolute top-5 right-6 hidden">
            <div class="animate-spin rounded-full h-4 w-4 border-b-2 border-[#FD7013]"></div>
        </div>
    </div>
    <div class="flex items-center gap-2">
        <select id="roleFilter" class="h-[58px] px-4 py-2 rounded-lg text-xs font-bold border border-[#E4EBF0] bg-[#FAFDFF] text-navyBlue outline-none">
        ...
        <select id="levelFilter" class="h-[58px] px-4 py-2 rounded-lg text-xs font-bold border border-[#E4EBF0] bg-[#FAFDFF] text-navyBlue outline-none">
        ...
        <select id="itemsPerPage" class="h-[58px] px-4 py-2 rounded-lg text-xs font-bold border border-[#E4EBF0] bg-[#FAFDFF] text-navyBlue outline-none">
    ...
    <div class="bg-white rounded-lg w-full max-w-md p-6 shadow-xl absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2">
        ...
        <form id="addUserForm">
            <div class="space-y-4">
                <div>
                    ...
                    <input type="tel" id="userPhone" name="phone" required
                        class="w-full h-12 border border-[#E8EDF1] rounded-xl p-3 text-sm outline-none focus:ring-2 focus:ring-[#FD7013]"
            ...
            <div class="flex gap-3 mt-6">
                <button type="submit" class="flex-1 flex items-center justify-center gap-x-2 bg-[#FD7013] hover:bg-[#CA5608] text-white py-3 rounded-lg text-base font-yekan-bold">
                    افزودن کاربر
                </button>
...
<div id="editUserModal" class="fixed inset-0 z-50 backdrop-blur-sm bg-white/30" style="display: none;">
    <div class="bg-white rounded-lg w-full max-w-2xl p-6 shadow-xl absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 max-h-[90vh] overflow-y-auto">
        <div class="flex justify-between items-center mb-6">
        ...
        <div id="editUserTabs" class="mb-6 border-b border-gray-200" style="display: none;">
            <div class="flex gap-4">
                <button class="edit-tab-btn active px-4 py-2 text-sm font-yekan-bold border-b-2 border-[#FD7013] text-[#FD7013]" data-tab="user">
                    ویرایش کاربر
                </button>
            ...
            <div class="space-y-6">
                ...
                <div id="ownerGamesSection" class="border border-gray-200 rounded-lg p-4">
                    ...
                    <div class="space-y-3">
                        <div>
                            ...
                            <div class="relative">
                                <input type="text" id="ownerGameSearchInput" 
                                    class="w-full h-12 border border-[#E8EDF1] rounded-xl p-3 pr-10 text-sm outline-none focus:ring-2 focus:ring-[#FD7013]"
                        ...
                        <div>
                            ...
                            <div id="selectedOwnerGames" class="space-y-2 max-h-48 overflow-y-auto border border-gray-200 rounded-lg p-3 min-h-[100px]">
                ...
                <div id="sansManagerGamesSection" class="border border-gray-200 rounded-lg p-4">
                    ...
                    <div class="space-y-3">
                        ...
                        <div>
                            <label class="block text-sm font-yekan-bold text-navyBlue mb-2">بازی‌های انتخاب شده</label>
                            <div id="selectedSansGames" class="space-y-2 max-h-48 overflow-y-auto border border-gray-200 rounded-lg p-3 min-h-[100px]">
                                <div class="text-sm text-gray-400 text-center py-4">هیچ بازی‌ای انتخاب نشده است</div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="flex gap-3 mt-6">
                    <button type="button" id="saveGamesConnection" class="flex-1 flex items-center justify-center gap-x-2 bg-[#FD7013] hover:bg-[#CA5608] text-white py-3 rounded-lg text-base font-yekan-bold">
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input type="text" id="bankingShaba" name="shaba" required maxlength="24"
                            class="w-full h-12 border border-[#E8EDF1] rounded-xl p-3 pr-8 text-sm outline-none focus:ring-2 focus:ring-[#FD7013]"
...
<div id="gameSelectionModal" class="fixed inset-0 z-50 backdrop-blur-sm bg-white/30" style="display: none;">
    <div class="bg-white rounded-lg w-full max-w-2xl p-6 shadow-xl absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 max-h-[80vh] overflow-y-auto">
        ...
        <div class="flex gap-3 mt-6">
            <button type="button" id="confirmGameSelection" class="flex-1 flex items-center justify-center gap-x-2 bg-[#FD7013] hover:bg-[#CA5608] text-white py-3 rounded-lg text-base font-yekan-bold">
                تأیید و ادامه
            </button>
...
<div id="createPasswordModal" class="fixed inset-0 z-50 backdrop-blur-sm bg-white/30" style="display: none;">
    <div class="bg-white rounded-lg w-full max-w-md p-6 shadow-xl absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2">
        ...
        <div class="mb-4">
            ...
            <p class="text-sm text-gray-800 font-bold mb-4">شماره موبایل: <span id="modalUserPhone" class="text-[#FD7013]"></span></p>
...
<script>
    jQuery(document).ready(function($) {
        ...
        $('#addUserForm').on('submit', function(e) {
            ...
            $submitBtn.html('<svg class="animate-spin -ml-1 mr-2 h-4 w-4 text-white mx-0" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"><circle class="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" stroke-width="4"></circle><path class="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4zm2 5.291A7.962 7.962 0 014 12H0c0 3.042 1.135 5.824 3 7.938l3-2.647z"></path></svg>منتظر بمانید...');
            const formData = {
                'action': 'team_ajax_handler',
                'nonce': "<?php echo wp_create_nonce('team-ajax-nonce') ?>",
                'callback': 'users_add',
        ...
        $(document).on('click', '.edit-user-btn', function() {
            ...
            $button.html('<svg class="animate-spin h-4 w-4 text-[#137cb1] mx-0" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"><circle class="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" stroke-width="4"></circle><path class="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4zm2 5.291A7.962 7.962 0 014 12H0c0 3.042 1.135 5.824 3 7.938l3-2.647z"></path></svg>');
        ...
        function switchEditTab(tab) {
            $('.edit-tab-btn').removeClass('active border-[#FD7013] text-[#FD7013]').addClass('text-gray-500');
            $('.edit-tab-btn[data-tab="' + tab + '"]').addClass('active border-[#FD7013] text-[#FD7013]').removeClass('text-gray-500');
        ...
        function loadUserGames(userId) {
            ...
            $('#selectedOwnerGames').html('<div class="text-sm text-gray-500 text-center py-4"><div class="inline-block animate-spin rounded-full h-5 w-5 border-b-2 border-[#FD7013]"></div><div class="mt-2">در حال بارگذاری بازی‌ها...</div></div>');
            $('#selectedSansGames').html('<div class="text-sm text-gray-500 text-center py-4"><div class="inline-block animate-spin rounded-full h-5 w-5 border-b-2 border-[#FD7013]"></div><div class="mt-2">در حال بارگذاری بازی‌ها...</div></div>');
        ...
        $(document).on('click', '.delete-user-btn', function() {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    // Show loading state
                    $button.prop('disabled', true);
                    $button.html('<svg class="animate-spin h-4 w-4 text-red-600 mx-0" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"><circle class="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" stroke-width="4"></circle><path class="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4zm2 5.291A7.962 7.962 0 014 12H0c0 3.042 1.135 5.824 3 7.938l3-2.647z"></path></svg>');
                    $.ajax({
                        type: 'POST',
                        url: "<?php echo admin_url('admin-ajax.php') ?>",
                        data: {
