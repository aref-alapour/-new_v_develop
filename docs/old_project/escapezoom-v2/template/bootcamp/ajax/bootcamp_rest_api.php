...
$theme_dir = dirname(dirname(dirname(dirname($current_file)))); // From template/bootcamp/ajax/ to theme root
...
$puzzle_functions_path = $theme_path . '/template/bootcamp/ajax/bootcamp_check_answer.php';
