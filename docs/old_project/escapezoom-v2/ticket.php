...
$args = array(
    'meta_key'   => '_order_key',
    'meta_value' => 'wc_order_' . $wp->query_vars['ticket'],
    'limit'      => 1,
);
$query      = new WC_Order_Query($args);
$order_id   = $query->get_orders()[0]->get_id();

$order = wc_get_order($order_id);

$item = end($order->get_items());
...
$product = [
    ...
    'meta'     => ez_get_product_meta($item['product_id']),
    'rules'    => get_post_meta($item['product_id'], 'product_rules', true)
];
...
$brand_data = get_the_terms($product['id'], 'yith_product_brand')[0];
...
$prepaid = (float) get_post_meta($order_id, 'prepaid', true);
...
<section class="container mx-auto mt-16" style="overflow: hidden">
    ...
    <div class="flex flex-col py-12 px-16 bg-[#F9FAFB] border border-[#E8EDF1] rounded-2xl max-lg:px-6 max-lg:py-10">
        <div class="flex max-lg:flex-col bg-white border border-[#E8EDF1] rounded-2xl p-10 max-lg:p-6 lg:gap-12 gap-6 items-center">
            ...
            <div class="flex flex-col grow">
                    ...
                    <div class="flex lg:items-center">
                        ...
                        <div class="flex flex-col">
                            ...
                            <div class="lg:flex lg:items-center">
                                ...
                                <a class="text-4xl font-extrabold text-[#09192D] lg:mt-1.5 text-nowrap" href="<?php echo esc_url($product['url']); ?>">
                                ...
                                <div class="flex items-center gap-x-4 lg:mr-4">
                                    ...
                                    <span class="text-4xl font-extrabold text-[#FD7013]"><?php echo esc_html($product['quantity']); ?></span>
                ...
                <div class="flex max-lg:items-start justify-between items-center">
                    ...
                    <div class="flex flex-col text-2xl text-left">
                        <img src="<?php echo wp_get_attachment_url(get_term_meta($brand_data->term_id, 'thumbnail_id', true)); ?>" style="width: 70px; height: 70px;">
                    </div>
            ...
            <div class="relative justify-between rounded-xl border border-slate-120 shadow-13 flex px-8">
                <div class="flex flex-wrap items-center justify-between py-12">
                    <div class="flex gap-x-5 px-6">
                        ...
                        <div class="space-y-4">
                            <div class="text-xl font-bold text-[#889BAD]"><?php echo $product['meta']->product_type ?></div>
                            <div class="space-y-4 flex items-center">
                                <a class="text-4xl font-extrabold text-[#09192D] mt-1.5" href="<?php echo esc_url($product['url']); ?>"><?php echo esc_html($product['title']); ?></a>
                    ...
                    <div class="my-5 px-6">
                        <div class="flex justify-center gap-x-12 flex-col items-end gap-y-2"><span class="text-2xl font-bold text-[#FD7013] order-2"><?php echo esc_html($order_date); ?></span><bdo dir="ltr" class="text-2xl font-bold text-[#09192D] order-1"><?php echo esc_html($order_time); ?></bdo></div>
                    </div>
                    <div class="flex justify-between gap-x-4 px-6 pt-12 mt-12.5 w-full border-t border-t-[#E4EBF0]">
                        <div class="w-full">
                            <div class="flex items-center gap-x-5">
                                <h2 class="text-xl font-bold text-[#09192D]"><?php echo esc_html($brand_data->name); ?></h2>
