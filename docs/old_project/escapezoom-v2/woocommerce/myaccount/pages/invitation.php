<div class="lg:col-span-8 2xl:col-span-9">
    <section class="tab border-[#E8EDF1] lg:h-full lg:rounded-3xl lg:border lg:p-10">
        <div class="flex max-lg:flex-col max-lg:gap-y-6 lg:items-center">

            <div class="text-lg max-lg:hidden lg:ml-8">دعوت‌ها</div>

            <div class="space-x-6 space-x-reverse overflow-hidden max-lg:grid max-lg:h-12.5 max-lg:grid-cols-2 max-lg:rounded-[10px] max-lg:border max-lg:border-[#E4EBF0]">
                ...
                <button type="button" data-show-tab="invited" class="text-[#889BAD]">دعوت کردم</button>
            </div>
            ...
            <div class="flex gap-x-2.5 rounded-lg bg-[#FDF7DE] px-3 py-2 lg:mr-auto lg:items-center">
                ...
                <p class="text-md font-bold text-[#BF9A00]">پس‌از پذیرفتن دعوت، شماره تماس فرد دعوت‌شده، جهت ایجاد هماهنگی برای فرد دعوت‌کننده نمایش داده می‌شود.</p>
            </div>
