...
<div class="lg:col-span-8 2xl:col-span-9 max-lg:-mx-4">
    <section class="border-[#E8EDF1] bg-[#F2F6FA] lg:h-full lg:rounded-3xl lg:border">
        <div class="rounded-t-3xl bg-white p-7.5 text-lg font-bold shadow-13 max-lg:hidden">اطلاعیه‌ها</div>
        <div class="grid gap-6.5 p-4 max-lg:border max-lg:border-[#E8EDF1] lg:grid-cols-2 lg:p-6 max-lg:rounded-none max-lg:border-none max-lg:shadow-none max-lg:py-7.5">
                    ...
                    <div
                        ...
                        <div class="lg:flex lg:w-full lg:justify-between lg:gap-x-1">
                            <div>
                                ...
                                <div class="font-bold text-[#4E5C6D] text-12 notification-excerpt <?php echo $index !== 0 ? "line-clamp-1" : "" ?>">
									<?php
                    ...
                    <div class="notification-details bg-white border border-l-0 p-7.5 rounded-xlh rounded-tl-none rounded-bl-none sticky top-5 flex gap-x-5 font-bold">
                        ...
                        <div class="lg:flex lg:w-full lg:justify-between lg:gap-x-1">
                            <div class="pt-3.5">
                                ...
                                <div class="font-bold text-[#4E5C6D] text-12 text-justify notification-content">
    								<?php echo $notification['description']; ?>
                                </div>
                            </div>
                            <div>
                                <bdo dir="ltr" class="font-semibold text-[#889BAD] text-14 notification-date absolute left-7.5 top-7 leading-none">
    								<?php echo jdate( "Y.m.d", $notification['date'] ); ?>
                                </bdo>
                            </div>
                        </div>
