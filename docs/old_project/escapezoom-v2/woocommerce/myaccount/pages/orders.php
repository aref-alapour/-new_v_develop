    ...
    <section class="rounded-2xl border border-slate-120 px-8 shadow-12 max-lg:mb-0 max-lg:rounded-none max-lg:px-0 max-lg:shadow-none py-12 max-lg:border-0 max-lg:py-0">
        <div class="md:mb-8 mb-0 lg:mb-8 max-lg:border-b max-lg:border-slate-120 max-lg:pb-6">
            <div class="flex max-lg:flex-col justify-start gap-6 lg:gap-12">
                ...
                <div class="space-x-6 space-x-reverse overflow-hidden max-lg:flex grow max-lg:rounded-[10px] max-lg:border max-lg:border-[#E4EBF0]">
					<?php foreach ( $statuses as $status => $label ) { ?>
                        <button type="button"
                                data-status="<?php echo esc_attr( $status ); ?>"
                                class="grow max-lg:p-2.5 <?php echo esc_attr( $status == 'all' ? 'active max-lg:bg-primary-500 max-lg:text-white lg:border-b lg:border-b-primary-500' : 'text-[#889BAD]' ); ?>">
            ...
            jQuery(document).ready(function ($) {
                ...
                $("button[data-status]").on('click', function () {
                    ...
                    $("button[data-status]")
                        ...
                        .addClass('grow text-[#889BAD]')

                    // Add Active Class To Current Button
                    $(this)
                        .removeClass('grow text-[#889BAD]')
