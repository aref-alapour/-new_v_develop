    ...
    <div class="col-span-3">
        ...
        <div class="mb-9 lg:hidden">
            <div class="mb-5 flex gap-2.5">
                ...
                <a href="<?php echo esc_url( wc_get_account_endpoint_url( 'points' ) ); ?>" class="flex items-center justify-between max-lg:w-3/12 max-lg:flex-col max-lg:rounded-lg max-lg:border max-lg:border-[#ebe6db] max-lg:bg-[#f7f4ed] max-lg:p-4 max-lg:shadow-13 lg:mt-3 lg:gap-3">
                ...
                <div class="flex flex-col gap-6">
					<?php foreach ( wc_get_account_menu_items() as $endpoint => $label ) : ?>
						<?php if ( $endpoint == 'customer-logout' ) { ?>
                            <hr>
						<?php } ?>
                        <a class="flex w-full items-center justify-between text-xs <?php echo wc_get_account_menu_item_classes( $endpoint ); ?> <?php echo wc_is_current_account_menu_item( $endpoint ) ? 'text-primary-500' : 'text-slate-700'; ?>" href="<?php echo esc_url( wc_get_account_endpoint_url( $endpoint ) ); ?>" <?php echo $endpoint == 'customer-logout' ? 'onclick="zebline.user.logout();"' : ''; ?>>
                            <div class="flex items-center gap-3">
								<?php echo esc_html( $label ); ?>
                            </div>
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" width="10" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="m-0">
        ...
        <section class="rounded-2xl border border-slate-120 shadow-12 sticky top-2 z-10 px-9 py-10 max-lg:hidden">
            ...
            <div class="max-lg:hidden">
                ...
                <div class="flex items-center justify-between max-lg:w-5/12 max-lg:flex-col max-lg:rounded-lg max-lg:border max-lg:border-[#ebe6db] max-lg:bg-[#f7f4ed] max-lg:p-4 max-lg:shadow-13 lg:mt-3 lg:gap-3">
