...
<div class="rounded-lg py-2 px-3 bg-[#FAFAFA] content-center">
    <label for="payment_method_<?php echo esc_attr( $gateway->id ); ?>" class="flex items-center gap-x-4 cursor-pointer peer-checked:text-white">
        ...
        <span class="bg-white flex items-center justify-center w-7.5 h-7.5 rounded-full border border-[#DADADA] peer-checked:bg-[#1ED982] peer-checked:border-[#1ED982]">
