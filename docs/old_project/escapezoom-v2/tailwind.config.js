...
module.exports = {
    content: [
        './*.{html,php,js}',
        './ahmadreza/**/*.{html,php,js}',
        './app/**/*.{html,php,js}',
        './assets/**/*.{html,php,js}',
        './HTML/**/*.{html,php,js}',
        './inc/**/*.{html,php,js}',
        './template/**/*.{html,php,js}',
        './vendor/**/*.{html,php,js}',
        './woocommerce/**/*.{html,php,js}',
    ],
    darkMode: 'class',
    theme: {
        extend: {
            ...
            backgroundImage: {
                ...
                'vip': 'conic-gradient(from 0deg at 50% 50%, #fd7013 0%, #FFF 20%, #FFF 30%, #fd7013 50%, #FFF 70%, #FFF 80%, #fd7013 100%)'
            },
