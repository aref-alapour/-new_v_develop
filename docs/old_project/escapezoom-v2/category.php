...
<?php if ( count( $sticky ) > 0 ) { ?>
    ...
    <section class="bg-gray-50 p-4 flex flex-col gap-8 lg:hidden max-sm:max-w-[calc(100%+2rem)] max-sm:w-[calc(100%+2rem)] -mx-4">
