...
<section class="w-screen relative left-1/2 right-1/2 -ml-50vw -mr-50vw overflow-hidden my-4 lg:my-10">
    ...
    <div class="container mx-auto px-4 sm:px-6 md:px-8">
        ...
        <div id="esfahan-150-discount-box" class="relative bg-gradient-to-br from-promo-1 via-promo-2 to-promo-3 rounded-lg lg:rounded-2xl p-3 lg:p-5 shadow-xl overflow-hidden transform transition-all duration-500 hover:scale-[1.02]">
            ...
            <div class="relative z-10 flex flex-col lg:flex-row items-center justify-between gap-2.5 lg:gap-4">
                ...
                <div class="flex flex-row items-center gap-2.5 lg:gap-3 bg-white/20 backdrop-blur-sm rounded-lg lg:rounded-xl px-3 py-2 lg:px-6 lg:py-3.5 border border-white/30 w-full lg:w-auto justify-between lg:justify-center">
                    ...
                    <button id="copy-esfahan-150-promo" type="button" class="flex items-center justify-center gap-1.5 bg-white text-promo-3 px-3 py-1.5 lg:px-4 lg:py-2 rounded-lg font-bold text-xs lg:text-base hover:bg-white/90 transition-all duration-300 hover:scale-105 active:scale-95 shadow-lg shrink-0" title="کپی کد تخفیف">
