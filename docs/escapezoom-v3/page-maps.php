...
<?php if (wp_is_mobile()): ?>
    <div class="flex">
        ...
        <div class="px-4 fixed bottom-5 w-screen z-[600]">
            <div class="bg-white px-8 py-2 rounded-lg w-full shadow-13 border flex">
                <button type="button" class="w-full flex items-center justify-between gap-8" id="open-rooms">
                    لیست بازی ها
                    <svg xmlns="http://www.w3.org/2000/svg" width="19" height="14" viewBox="0 0 19 14" fill="none" class="m-0">
        ...
        <div class="modals">
            ...
            <div id="rooms"
                 class="max-h-[calc(100vh-235px)] w-[calc(100vw-2rem)] fixed bottom-d80 shadow-13 z-[600] scale-75 opacity-0 pointer-events-none overflow-y-auto overflow-x-hidden rounded-xl no-scrollbar mx-4 transition-all duration-300">
                ...
                <div class="bg-white p-4">
                    <form action="#" method="post">
                        <div class="flex flex-col gap-4 justify-between">
                            ...
                            <button type="submit"
                                    class="flex gap-4 items-center justify-center relative text-sm font-semibold focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 transition-all duration-300 ease-in-out disabled:bg-slate-110 disabled:text-disabled disabled:cursor-not-allowed disabled:shadow-none bg-primaryColor text-white shadow-13 h-16 min-w-16 px-9 py-2 rounded-xl w-full">
            ...
            <div class="p-8 flex flex-col gap-8">
                <div class="flex justify-between items-center">
                    <a class="flex items-center gap-4.5" href="/">
                        <svg xmlns="http://www.w3.org/2000/svg" width="113" fill="none" viewBox="0 0 113 29" class="w-40 2xl:w-44 m-0">
                    ...
                    <div class="flex items-center flex-col-reverse justify-between">
                        ...
                        <div class="flex items-center">
                            ...
                            <svg width="16" height="16" class="-mt-1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" fill="none">
                        ...
                        data.products.forEach(element => {
                            ...
                            let resultItem = `
                                    <a href="<?= home_url('/room/') ?>${element.url}" class="flex p-3 gap-3 border shadow-13 rounded-xl">
                                        <div>
                                            <img src="${element.image}" alt="${element.url}" class="rounded-xl w-d70">
                                        </div>
                                        <div class="flex flex-col grow justify-between">
                                            ...
                                            <div class="flex justify-between items-center gap-x-6">
                                                ...
                                                <div class="bg-yellow-500 leading-5 px-2 rounded" dir="ltr">
                            ...
                            marker = L.marker({lat: geoArray[0], lon: geoArray[1]}, {icon: primaryIcon})
                                .bindPopup(`<div class="flex gap-4 p-1">
                                                <div>
                                                    ...
                                                    <img src="${element.image}" alt="${element.title}" class="rounded-xl w-d70">
                                                    </a>
                                                </div>
