...
<section class="py-4 md:py-5 lg:py-9">
    ...
    <section class="flex justify-center mt-4 lg:hidden bg-timer-takhfif-mobile px-auto">
        <h3 class="text-40 font-fat-yekanbakh !leading-17 text-white text-center flex justify-center">تخفیف های
            ویژه</h3>
    </section>
    <!-- end-navar-takhfif-mobile -------------------------------------------------------->

    <!-- srart-baner-header -------------------------------------------------------------->
    <section class="container mx-auto mb-d70 mt-10 px-4 sm:px-6 md:px-8">

        <div
            class="relative flex flex-col lg:flex-row items-center justify-center lg:justify-center pb-d50 lg-[35px]  gap-d28 lg:gap-d54"
            style="
          ...
          ">
            ...
            <img src="<?= Theme_ASSET_URL ?>images/discounts/Desktop II.png" alt=""
                class="w-d450 h-d380 hidden lg:flex" />

            <img src="<?= Theme_ASSET_URL ?>images/discounts/Mobile II.png" alt=""
                class="h-d340 object-contain flex lg:hidden" />
            <div class="flex flex-col items-center lg:items-start px-d26">
                <div class="flex flex-row lg:justify-between justify-center w-full max-w-d537 relative">
                    <h1 class="text-34 lg:text-5xl font-fat-yekanbakh !leading-17 text-center lg:text-start">
                        تجربه‌ای هیجان انگیز <br />با تخفیف های ویژه!</h1>
                    <img src="<?= Theme_ASSET_URL ?>images/discounts/Group 119.png" alt=""
                        class="hidden lg:flex w-d57 h-d57 absolute top-d75 left-0" />
                </div>
                <p class="text-lg mt-5 max-w-d547 text-center lg:text-start text-justify">فرصتی استثنایی برای عاشقان
    ...
    <!-- start-navar-takhfif -------------------------------------------------------------->
    <section class="">
        <div class="bg-timer-takhfif py-5 lg:px-d60">
            <div class="flex flex-col items-center justify-center mx-auto my-auto lg:flex-row lg:justify-between">
                <div class="flex items-center">
                    <img src="<?= Theme_ASSET_URL ?>images/discounts/Group 119 (1).png" alt=""
                        class="w-d57 h-d57 hidden lg:flex" />
                    <h4 class="text-30 lg:text-40 font-fat-yekanbakh !leading-17 text-white lg:mr-d32">
                        تخفیف‌های ویژه</h4>
                    <hr class="w-d1 h-d52 mx-d15 bg-primary-2" />
                    <p class="text-5 lg:text-28 font-black text-white">به مدت محدود</p>
                </div>

                <div class="flex flex-row items-center gap-d10 mt-5 lg:mt-0">
                    <div class="w-d64 h-d64 lg:w-d86 lg:h-d86 bg-white flex justify-center items-center rounded-10">
                        <div class="flex flex-col items-center gap-2">
                            <p id="seconds"
                                class="text-28 lg:text-44 font-fat-yekanbakh text-primary-500 mt-[-20px]">0</p>
                            <p class="text-lg font-black text-primary-500 mt-[-30px]">ثانیه</p>
                        </div>
                    </div>
                    ...
                    <div class="w-d64 h-d64 lg:w-d86 lg:h-d86 bg-white flex justify-center items-center rounded-10">
                        <div class="flex flex-col items-center gap-2">
                            <p id="minutes"
                                class="text-28 lg:text-44 font-fat-yekanbakh text-primary-500 mt-[-20px]">0</p>
                            <p class="text-lg font-black text-primary-500 mt-[-30px]">دقیقه</p>
                        </div>
                    </div>
                    ...
                    <div class="w-d64 h-d64 lg:w-d86 lg:h-d86 bg-white flex justify-center items-center rounded-10">
                        <div class="flex flex-col items-center gap-2">
                            <p id="hours"
                                class="text-28 lg:text-44 font-fat-yekanbakh text-primary-500 mt-[-20px]">0</p>
                            <p class="text-lg font-black text-primary-500 mt-[-30px]">ساعت</p>
                        </div>
                    </div>
                    <div class="w-d64 h-d64 lg:w-d86 lg:h-d86 bg-white flex justify-center items-center rounded-10">
                        <div class="flex flex-col items-center gap-2">
                            <p id="days"
                                class="text-28 lg:text-44 font-fat-yekanbakh text-primary-500 mt-[-20px]">0</p>
                            <p class="text-lg font-black text-primary-500 mt-[-30px]">روز</p>
                        </div>
                    </div>
                </div>
    ...
    $discountEventRoom = ez_products_snapshot_swiper($roomArgs);
    ...
    ?>
            ...
            <section class="max-w-full py-4 md:py-5 lg:py-9">
                <div class="mb-6 md:mb-8">
                    ...
                    <div class="flex justify-between gap-4 max-lg:flex-col">
                        ...
                        <div class="relative grid content-center grid-cols-2 gap-4">
                            <div class="w-full min-w-d156 grow">
                                <div class="relative w-full max-w-xs">
                                    <div class="relative sans-dropdown-container">
                                        <button type="button"
                                            ...
                                            <svg class="w-4 h-4 m-0 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div class="relative overflow-hidden embla_normal">
                    <div class="embla__viewport">
                        <div id="room-slider" class="embla__container first-child:before:hidden child:before:w-px child:before:absolute child:before:bg-gradient-to-t child:before:from-white child:before:via-slate-110 child:before:to-white child:before:-right-3.5 child:lg:before:-right-6 child:before:h-full min-h-d200 child:box-content lg:min-h-d300 flex child:ml-7 md:child:ml-12  last-child:ml-0 child:shrink-0 child:grow-0 child:w-d156 md:child:w-d200 child:py-2.5 child:relative">
                            <?= $discountEventRoom->products ?>
                        </div>
                    </div>
                    <button class="embla__button embla__button--prev room-btn absolute right-0 top-1/2 -translate-y-115 rotate-180 z-50 cursor-pointer touch-manipulation appearance-none -mr-px hidden" type="button">
                    ...
                    <button class="embla__button embla__button--next room-btn absolute left-0 top-1/2 -translate-y-115 z-50 cursor-pointer touch-manipulation appearance-none -ml-px hidden" type="button">
                        <svg xmlns="http://www.w3.org/2000/svg" width="30" fill="none" viewBox="0 0 30 113">
                            <g clip-path="url(#arrow_aa)">
                                <path fill="#BFCBD9" fill-rule="evenodd" d="M0 3.75c0 28.814 30 32.928 30 52.823 0 21.023-30 26.414-30 56.595V3.75Z" clip-rule="evenodd"></path>
                                <path fill="#fff" fill-rule="evenodd" d="M0 1c0 28.814 27 33.679 27 53.573 0 21.022-27 23.914-27 54.094V1Z" clip-rule="evenodd"></path>
        ...
        <svg xmlns="http://www.w3.org/2000/svg" width="1332" height="12" viewBox="0 0 1332 12" fill="none" class="my-d70 container mx-auto mb-d70 mt-10 px-4 sm:px-6 md:px-8">
    ...
    $discountEventLaser = ez_products_snapshot_swiper($laserArgs);
    ...
    ?>
        <section class="container mx-auto mb-d70 mt-10 px-4 sm:px-6 md:px-8">
            <section class="max-w-full py-4 md:py-5 lg:py-9">
                ...
                <div class="relative overflow-hidden embla_normal">
                    <div class="embla__viewport">
                        <div id="laser-slider" class="embla__container first-child:before:hidden child:before:w-px child:before:absolute child:before:bg-gradient-to-t child:before:from-white child:before:via-slate-110 child:before:to-white child:before:-right-3.5 child:lg:before:-right-6 child:before:h-full min-h-d200 child:box-content lg:min-h-d300 flex child:ml-7 md:child:ml-12  last-child:ml-0 child:shrink-0 child:grow-0 child:w-d156 md:child:w-d200 child:py-2.5 child:relative">
                            <?= $discountEventLaser->products ?>
                        </div>
                    </div>
                    <button class="embla__button embla__button--prev laser-btn absolute right-0 top-1/2 -translate-y-115 rotate-180 z-50 cursor-pointer touch-manipulation appearance-none -mr-px hidden" type="button">
                        <svg xmlns="http://www.w3.org/2000/svg" width="30" fill="none" viewBox="0 0 30 113">
                            <g clip-path="url(#arrow_aa)">
                                <path fill="#BFCBD9" fill-rule="evenodd" d="M0 3.75c0 28.814 30 32.928 30 52.823 0 21.023-30 26.414-30 56.595V3.75Z" clip-rule="evenodd"></path>
                                <path fill="#fff" fill-rule="evenodd" d="M0 1c0 28.814 27 33.679 27 53.573 0 21.022-27 23.914-27 54.094V1Z" clip-rule="evenodd"></path>
                    ...
                    <button class="embla__button embla__button--next laser-btn absolute left-0 top-1/2 -translate-y-115 z-50 cursor-pointer touch-manipulation appearance-none -ml-px hidden" type="button">
                        <svg xmlns="http://www.w3.org/2000/svg" width="30" fill="none" viewBox="0 0 30 113">
                            <g clip-path="url(#arrow_aa)">
                                <path fill="#BFCBD9" fill-rule="evenodd" d="M0 3.75c0 28.814 30 32.928 30 52.823 0 21.023-30 26.414-30 56.595V3.75Z" clip-rule="evenodd"></path>
                                <path fill="#fff" fill-rule="evenodd" d="M0 1c0 28.814 27 33.679 27 53.573 0 21.022-27 23.914-27 54.094V1Z" clip-rule="evenodd"></path>
    ...
    $discountEventCinema = ez_products_snapshot_swiper($cinemaArgs);
    ...
    ?>
        <section class="container mx-auto mb-d70 mt-10 px-4 sm:px-6 md:px-8">
            <section class="max-w-full py-4 md:py-5 lg:py-9">
                ...
                <div class="relative overflow-hidden embla_normal">
                    <div class="embla__viewport">
                        <div id="cinema-slider" class="embla__container first-child:before:hidden child:before:w-px child:before:absolute child:before:bg-gradient-to-t child:before:from-white child:before:via-slate-110 child:before:to-white child:before:-right-3.5 child:lg:before:-right-6 child:before:h-full min-h-d200 child:box-content lg:min-h-d300 flex child:ml-7 md:child:ml-12  last-child:ml-0 child:shrink-0 child:grow-0 child:w-d156 md:child:w-d200 child:py-2.5 child:relative">
                            <?= $discountEventCinema->products ?>
                        </div>
                    </div>
                    <button class="embla__button embla__button--prev cinema-btn absolute right-0 top-1/2 -translate-y-115 rotate-180 z-50 cursor-pointer touch-manipulation appearance-none -mr-px hidden" type="button">
                        <svg xmlns="http://www.w3.org/2000/svg" width="30" fill="none" viewBox="0 0 30 113">
                            <g clip-path="url(#arrow_aa)">
                                <path fill="#BFCBD9" fill-rule="evenodd" d="M0 3.75c0 28.814 30 32.928 30 52.823 0 21.023-30 26.414-30 56.595V3.75Z" clip-rule="evenodd"></path>
                                <path fill="#fff" fill-rule="evenodd" d="M0 1c0 28.814 27 33.679 27 53.573 0 21.022-27 23.914-27 54.094V1Z" clip-rule="evenodd"></path>
                    ...
                    <button class="embla__button embla__button--next cinema-btn absolute left-0 top-1/2 -translate-y-115 z-50 cursor-pointer touch-manipulation appearance-none -ml-px hidden" type="button">
                        <svg xmlns="http://www.w3.org/2000/svg" width="30" fill="none" viewBox="0 0 30 113">
                            <g clip-path="url(#arrow_aa)">
                                <path fill="#BFCBD9" fill-rule="evenodd" d="M0 3.75c0 28.814 30 32.928 30 52.823 0 21.023-30 26.414-30 56.595V3.75Z" clip-rule="evenodd"></path>
                                <path fill="#fff" fill-rule="evenodd" d="M0 1c0 28.814 27 33.679 27 53.573 0 21.022-27 23.914-27 54.094V1Z" clip-rule="evenodd"></path>
