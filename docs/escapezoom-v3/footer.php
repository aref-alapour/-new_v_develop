<?php if (! is_wc_login_page()) { ?>
    ...
    <!------------------start-footer-pwa------------------------->
    <div class="menu flex justify-between lg:hidden fixed -bottom-px w-screen right-1/2 left-1/2 -ml-50vw -mr-50vw bg-white z-50 bg-cover rounded-t-3xl px-4"
        style="filter: drop-shadow(0 -1px 5px rgba(9, 25, 45, 0.15));">

        <svg class="absolute top-[-11.5px] left-1/2 right-1/2 translate-x-1/2" width="74" height="12" viewBox="0 0 74 12" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path
        ...
        <div class="grid grid-cols-5 gap-x-3.5 w-full pt-2">
            <a href="<?= home_url(); ?>" class=" flex flex-col items-center cursor-pointer pb-2 text-muted-blue" style="<?= is_front_page() ? 'color:#f97316;' : '' ?>">
                ...
                <p class="menu-label text-sm font-bold text-text-3 mt-3" style="<?= is_front_page() ? 'color:#09192D;' : ''; ?>">خانه</p>
            </a>

            <div id="game-list-toggle" class=" flex flex-col items-center cursor-pointer pb-2 text-muted-blue">
                <svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" viewBox="0 0 28 28" fill="none">
                ...
                <p class="menu-label text-sm font-bold text-text-3 mt-3">لیست بازی</p>
            </div>

            <a href="<?= home_url('/game-finder') . '/'; ?>" class=" flex flex-col items-center cursor-pointer pb-2 relative">
                <div class="w-13 h-13 rounded-full -mt-3 flex items-center justify-center text-muted-blue"
                    style="box-shadow: 0 4px 4px 0 rgba(9, 25, 45, 0.06) inset; <?= is_page('game-finder') ? 'color:#f97316;' : ''; ?>">
                ...
                <p class="menu-label text-sm font-bold text-text-3 -mt-0.5" style="<?= is_page('game-finder') ? 'color: #09192D;' : '' ?>">سانس یاب</p>
            </a>

            <a href="<?= home_url('/maps') . '/'; ?>" class=" flex flex-col items-center cursor-pointer pb-2 text-muted-blue" style="<?= is_page('maps') ? 'color:#f97316;' : ''; ?>">
                <svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" viewBox="0 0 28 28" fill="none">
                ...
                <p class="menu-label text-sm font-bold text-text-3 mt-3" style="<?= is_page('maps') ? 'color: #09192D;' : '' ?>">زوم مپ</p>
            </a>

            <a href="<?= home_url('/panel') . '/'; ?>" class=" flex flex-col items-center cursor-pointer pb-2 text-muted-blue" style="<?= is_page('panel') ? 'color:#f97316;' : ''; ?>">
                ...
                <p class="menu-label text-sm font-bold text-text-3 mt-3" style="<?= is_page('panel') ? 'color: #09192D;' : '' ?>">پنل کاربری</p>
            </a>
        </div>
    </div>
    <!------------------menu-listGames----------------------------->
    <div class="menu-overlay fixed top-0 left-0 right-0 bottom-0 z-30" id="menu-overlay"></div>
    <div
        class="slide-menu lg:hidden fixed right-0 left-0 bottom-d60 z-40 bg-white flex flex-col gap-4 p-10 border rounded-t-30 max-h-d372">
        <a href="<?= home_url('/city/اتاق-فرار') . '/'; ?>" class="flex justify-start gap-6 bg-surface-sunken rounded-2xl w-full p-4">
            <svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" viewBox="0 0 28 28" fill="none">
                <path
            ...
            <p class="text-2xl font-bold">اتاق فرار</p>
        </a>

        <a href="<?= home_url('/city/سینما-ترس') . '/'; ?>" class="flex justify-start gap-6 bg-surface-sunken rounded-2xl w-full p-4">
            <svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" viewBox="0 0 28 28" fill="none">
                <path
            ...
            <p class="text-2xl font-bold">سینماترس</p>
        </a>

        <a href="<?= home_url('/city/لیزرتگ/') . '/'; ?>" class="flex justify-start gap-6 bg-surface-sunken rounded-2xl w-full p-4">
            <svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" viewBox="0 0 28 28" fill="none">
            ...
            <p class="text-2xl font-bold">لیزرتگ</p>
        </a>
    </div>
    <!------------------end-footer-pwa--------------------------->
    <?php endif; ?>
    <footer class="max-lg:hidden" style="z-index: 5; position: relative;">
        <div class="relative bg-slate-200 text-white">
            <div class="container mx-auto">
                <div class="px-4 pb-1 sm:px-6 2xl:relative">
                    <div class="flex justify-between gap-20 lg:gap-d70 lg:mr-2.5">
                        <div class="w-full">
                            <div class="pt-3 max-2xl:pl-28">
                                <div class="flex flex-wrap items-center justify-between gap-4 sm:max-lg:justify-start sm:max-lg:gap-12">
                                    <div class="hidden divide-y divide-white/10 max-lg:block">
                            ...
                            <div class="flex justify-between gap-8 pt-9 max-md:flex-wrap lg:pt-11 2xl:gap-15 lg:mr-d120">
                                <div class="text-justify text-2xs leading-8 md:border-l md:border-white/10 md:pl-8 2xl:pl-15 lg:max-w-d500">
                                    <div class="mb-6 flex items-center gap-x-20 lg:justify-between text-xs font-bold max-lg:hidden">
                                        <p>اسکیپ زوم، مرجع معرفی و رزرو بازی‌های گروهی سراسر ایران</p>
                                    ...
                                    <div class="lg:hidden">
                                        <div class="mb-10 mt-15 flex items-center justify-between gap-x-4">
                                            <div class="shrink-0 font-bold text-white">نشان های اعتماد اسکیپ زوم</div>
                                            <div class="h-px w-full bg-gray-200"></div>
                                        </div>
                                        <div class="grid grid-cols-4auto items-center justify-between gap-4">
                                            ...
                                            <!--</a>-->
                                            <a target="_blank" href="https://trustseal.enamad.ir/?id=346259&Code=fbGkMCGn9UU31loYShJV"><img referrerpolicy='origin' src='https://trustseal.enamad.ir/logo.aspx?id=346259&Code=fbGkMCGn9UU31loYShJV' alt='' style='cursor:pointer' code='fbGkMCGn9UU31loYShJV'></a>
                                            <a class="w-fit" href="https://eanjoman.ir/member/NAAK5SE04K2A9snx2E3kKqg47">
                                                <img src="<?php echo esc_url(ez_theme_asset_uri('images/license/digital.svg')); ?>" alt="">
                                            </a>
                                            <a class="w-fit" href="javascript:">
                                                <img src="<?php echo esc_url(ez_theme_asset_uri('images/license/senfi.svg')); ?>" alt="">
                                            </a>
                                            <a class="w-fit" href="javascript:">
                                                <img src="<?php echo esc_url(ez_theme_asset_uri('images/license/etehaiye.svg')); ?>" alt="">
                                            </a>
                                        </div>
                                    </div>
                                </div>
                                <?php
                                // دریافت منوی footer از مگامنو
                                $footer_menu_items = get_option('ez_mega_menu_footer', []);

                                if (!empty($footer_menu_items)):
                                ?>
                                    <div class="grid grow grid-cols-2 gap-4 text-xs lg:grid-cols-4">
                                        <?php foreach ($footer_menu_items as $menu_item):
                                            // بررسی visibility - این بخش برای دسکتاپ است
                                            ...
                                            if (!$has_children) continue; // در footer فقط آیتم‌های دارای فرزند نمایش داده می‌شوند

                                            // تعیین کلاس ستون (برای آیتم آخر که خط جداکننده دارد)
                                            $column_class = '';
                                            if (isset($menu_item['css_class']) && strpos($menu_item['css_class'], 'max-lg:text-right') !== false) {
                                                $column_class = 'max-lg:text-right';
                                            }
                                        ?>
                                            <div class="<?php echo esc_attr($column_class); ?>">
                                                <?php if ($column_class === 'max-lg:text-right'): ?>
                                                    <div class="mb-4 flex items-center justify-between gap-x-4">
                                                        <p class="text-xs font-bold text-white/60 text-nowrap"><?php echo esc_html($menu_item['title']); ?></p>
                                                        <div class="h-px w-full bg-gray-200 lg:hidden"></div>
                                                    </div>
                                                <?php else: ?>
                                                    <p class="mb-4 text-xs font-bold text-white/60"><?php echo esc_html($menu_item['title']); ?></p>
                                                <?php endif; ?>

                                                <ul class="mb-6">
                                                    <?php foreach ($menu_item['children'] as $child):
                                                        // بررسی visibility فرزند - این بخش برای دسکتاپ است
                                                        ...
                                                        // بررسی دقیق URL
                                                        if (rtrim($current_url, '/') === rtrim($child_url, '/')) {
                                                            $is_active = true;
                                                        }

                                                        // بررسی‌های خاص برای صفحات مختلف
                                                        if (!$is_active) {
                                                            if (is_front_page() && (rtrim($child_url, '/') === home_url() || rtrim($child_url, '/') === site_url())) {
                                                                $is_active = true;
                                                            } elseif (is_home() && strpos($child_url, '/blog') !== false) {
                                                                $is_active = true;
                                                            } elseif (is_singular('post') && strpos($child_url, '/blog') !== false) {
                                                                $is_active = true;
                                                            } elseif (is_account_page() && strpos($child_url, 'my-account') !== false) {
                                                                $is_active = true;
                                                            } elseif (is_page()) {
                                                                $page_slug = get_post_field('post_name', get_queried_object_id());
                                                                if (strpos($child_url, $page_slug) !== false) {
                                                                    $is_active = true;
                                                                }
                                                            }
                                                        }
                                                    ...
                                                    ?>
                                                        <li class="leading-8">
                                                            <a href="<?php echo esc_url($child_url); ?>" class="<?php echo esc_attr($active_class); ?>">
                                ...
                                <?php else: ?>
                                    <!-- Fallback: منوی پیش‌فرض در صورتی که مگامنو تنظیم نشده باشد -->
                                    <div class="grid grow grid-cols-2 gap-4 text-xs lg:grid-cols-4">
                                        <div class="">
                                            <p class="mb-4 text-xs font-bold text-white/60">صفحات مهم</p>
                                            <ul class="mb-6">
                                                <li class="leading-8">
                                                    <a href="<?php echo site_url(); ?>" class="<?php echo is_front_page() ? 'active' : ''; ?>">صفحه اصلی</a>
                                                </li>
                                                <li class="leading-8">
                                                    <a href="#">راهنمای سایت</a>
                                                </li>
                                                <li class="leading-8">
                                                    <a href="<?php echo home_url('blog'); ?>" class="<?php echo is_home() || is_singular('post') ? 'active' : ''; ?>">بلاگ بازی</a>
                                                </li>
                                                <li class="leading-8">
                                                    <a href="#">ویدیوها</a>
                                                </li>
                                                <li class="leading-8">
                                                    <a href="<?php echo home_url('terms'); ?>" class="<?php echo is_page('terms') ? 'active' : ''; ?>">قوانین</a>
                                                </li>
                                            </ul>
                                        </div>
                                        <div class="max-lg:text-right">
                                            <p class="mb-4 text-xs font-bold text-white/60">محبوب کاربران</p>
                                            <ul class="mb-6">
                                                <li class="leading-8">
                                                    <a href="<?php echo home_url('city/اتاق-فرار'); ?>" class="<?php echo (is_page() && get_post_field('post_name') == 'اتاق-فرار') ? 'active' : ''; ?>">اتاق فرار</a>
                                                </li>
                                                <li class="leading-8">
                                                    <a href="<?php echo home_url('city/لیزرتگ'); ?>" class="<?php echo (is_page() && get_post_field('post_name') == 'لیزرتگ') ? 'active' : ''; ?>">لیزرتگ</a>
                                                </li>
                                                <li class="leading-8">
                                                    <a href="<?php echo home_url('city/سینما-ترس'); ?>" class="<?php echo (is_page() && get_post_field('post_name') == 'سینما-ترس') ? 'active' : ''; ?>">سینما ترس</a>
                                                </li>
                                                <li class="leading-8">
                                                    <a href="<?php echo home_url('collections'); ?>" class="<?php echo is_page('collections') ? 'active' : ''; ?>">کالکشن ها</a>
                                                </li>
                                            </ul>
                                        </div>
                                        <div class="">
                                            <p class="mb-4 text-xs font-bold text-white/60">دسترسی سریع</p>
                                            <ul class="mb-6">
                                                <li class="leading-8">
                                                    <a href="<?php echo get_permalink(wc_get_page_id('myaccount')) ?>" class="<?php echo is_account_page() ? 'active' : ''; ?>">
                                                        پنل کاربری من
                                                    </a>
                                                </li>
                                                <li class="leading-8">
                                                    <a href="<?php echo site_url('maps') ?>" class="<?php echo is_page('maps') ? 'active' : ''; ?>">
                                                        نقشه بازی ایران
                                                    </a>
                                                </li>
                                                <li class="leading-8">
                                                    <a href="<?= home_url('/discounts/') ?>" class="<?php echo is_page('discounts') ? 'active' : ''; ?>">
                                                        تخفیف های داغ
                                                    </a>
                                                </li>
                                                <li class="leading-8">
                                                    <a href="<?php echo home_url('game-finder'); ?>" class="<?php echo is_page('game-finder') ? 'active' : ''; ?>">
                                                        سانس یاب
                                                    </a>
                                                </li>
                                                <li class="leading-8">
                                                    <a href="<?= home_url('/top-players/') ?>" class="<?php echo is_page('top-players') ? 'active' : ''; ?>">
                                                        کاربران برتر
                                                    </a>
                                                </li>
                                            </ul>
                                        ...
                                        <div class="max-lg:text-right">
                                            <div class="mb-4 flex items-center justify-between gap-x-4">
                                                <p class="text-xs font-bold text-white/60 text-nowrap">ارتباط با اسکیپ روم</p>
                                                <div class="h-px w-full bg-gray-200 lg:hidden"></div>
                                            </div>
                                            <ul class="mb-6">
                                                <li class="leading-8">
                                                    <a href="<?php echo home_url('contact-us'); ?>" class="<?php echo is_page('contact-us') ? 'active' : ''; ?>">تماس با ما</a>
                                                </li>
                                                <li class="leading-8">
                                                    <a href="<?php echo home_url('partnership'); ?>" class="<?php echo is_page('partnership') ? 'active' : ''; ?>">همکاری با ما</a>
                                                </li>
                                                <li class="leading-8">
                                                    <a href="<?php echo home_url('about-us'); ?>" class="<?php echo is_page('about-us') ? 'active' : ''; ?>">درباره ما</a>
                                                </li>
                                                <li class="leading-8">
                                                    <a href="<?php echo home_url('ads-job'); ?>" class="<?php echo is_page('ads-job') ? 'active' : ''; ?>">استخدام ها</a>
                                                </li>
                                                <li class="leading-8">
                                                    <a href="<?= home_url('/organization-sales/') ?>" class="<?php echo is_page('organization-sales') ? 'active' : ''; ?>">همکاری سازمانی</a>
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
                            ...
                            <div class="lg:mt-8 lg:mr-d120">
                                <p class="mb-5 text-xs font-bold opacity-60 max-lg:hidden">نشان های اعتماد اسکیپ زوم</p>
                                <div class="flex w-full items-center justify-between gap-6 border-b border-t border-white/10 pb-3 pt-3 text-2xs md:order-1 lg:py-0">
                                    <div class="flex w-full flex-wrap items-center justify-between gap-6 text-3xs lg:hidden">
                                    ...
                                    <div class="flex w-full items-center justify-between gap-x-20 max-lg:hidden">
                                        <div class="relative grid grid-cols-4auto items-center justify-between gap-4 before:absolute before:-top-1 before:h-2 before:w-full before:bg-slate-200 before:content-['']">
                                            ...
                                            <!--        alt="" class="w-8">-->
                                            <!--</a>-->
                                            <a target="_blank" href="https://trustseal.enamad.ir/?id=346259&Code=fbGkMCGn9UU31loYShJV" style="width:80px"><img referrerpolicy='origin' src='https://trustseal.enamad.ir/logo.aspx?id=346259&Code=fbGkMCGn9UU31loYShJV' alt='' style='cursor:pointer' code='fbGkMCGn9UU31loYShJV'></a>
                                            <a class="relative z-1 w-fit"
                                                href="https://eanjoman.ir/member/NAAK5SE04K2A9snx2E3kKqg47">
                                                <img src="<?php echo esc_url(ez_theme_asset_uri('images/license/digital.svg')); ?>"
                                                    alt="" class="w-8">
                                            </a>
                                            <a class="relative z-1 w-fit" href="javascript:">
                                                <img src="<?php echo esc_url(ez_theme_asset_uri('images/license/senfi.svg')); ?>"
                                                    alt="" class="w-8">
                                            </a>
                                            <a class="relative z-1 w-fit" href="javascript:">
                                                <img src="<?php echo esc_url(ez_theme_asset_uri('images/license/etehaiye.svg')); ?>"
                                                    alt="" class="w-8">
                                            </a>
                                        </div>
                                        <div class="flex items-center justify-between gap-x-10">
                                            <div class="flex items-center gap-x-10 text-sm">
                                                <div>ایمیل پشتیبانی</div>
                                            ...
                                            <div class="flex items-center gap-x-10 text-base">
                                                <div>پشتیبان همیشگی شما هستیم</div>
                                                <div class="flex items-center gap-x-4">
                            ...
                            <div class="flex items-center justify-between gap-20 lg:mr-d120">
                                <div class="mb-4.5 mt-4 grid grid-cols-3auto items-center justify-between gap-x-4 text-3xs font-bold max-lg:w-full">
                                    <div class="flex items-center gap-x-2">
                                        <div class="opacity-60">رابط کاربری</div>
                                        <div>I Vahid</div>
                                    </div>
                                    <div class="flex items-center gap-x-2">
                                        <div class="opacity-60">توسعه وب</div>
                                        <div>آرتین فناوران برخط</div>
                                    </div>
                                    <div class="flex items-center gap-x-2">
                                        <div class="opacity-60">از سال</div>
                                        <div>2020</div>
                                        <div class="opacity-60">تا</div>
                                        <div><?php echo date('Y') ?></div>
                                    </div>
                                </div>
                                <div class="flex flex-wrap items-center justify-between gap-6 text-3xs max-lg:hidden">
...
<?php } ?>
<!-- شروع کدهای دکمه شناور بله -->
<style>
/* انیمیشن لرزش (تکان خوردن) */
@keyframes baleShake {
...
.bale-floating-btn {
  ...
  bottom: 90px;
  left: 20px;
  width: 45px; /* می‌توانید اندازه را تغییر دهید */
  height: 45px;
  cursor: pointer;
  z-index: 9998;
  border-radius: 50%;
...
.bale-modal-overlay {
  ...
  z-index: 9999;
  display: none; /* پنهان در حالت پیش‌فرض */
  align-items: center;
...
.bale-modal-close:hover {
  color: #d32f2f;
}
@media screen and (min-width: 780px) {
    .bale-floating-btn {bottom: 30px;}
}
</style>

<!-- دکمه شناور (آدرس عکس را جایگزین کنید) -->
<!-- توجه: عکس Bale-Logo-PNG-Way2pay-96-12-07.png را در رسانه وردپرس آپلود کرده و آدرس آن را در ویژگی src قرار دهید -->
<img src="<?= Theme_ASSET_URL ?>images/Bale-Logo.png" alt="بله" id="baleFloatingBtn" class="bale-floating-btn" />

<!-- مودال و پس زمینه تاریک -->
<div id="baleModalOverlay" class="bale-modal-overlay">
  <div class="bale-modal-content">
    <span class="bale-modal-close" id="baleModalClose">&times;</span>
    <h3 style="margin-top: 15px; margin-bottom: 15px; font-size: 1.1rem; color: #333; line-height: 1.6;">
    تخفیف اتاق فرار و تیم یابی در کانال و گروه «بله»
    </h3>
    <a href="https://ble.ir/escapezoom" target="_blank" style="font-size: 1.2rem; font-weight: bold; color: #2196f3; direction: ltr; margin-bottom: 5px;">
        مشاهده کانال
    </a>
  </div>
</div>
...
document.addEventListener("DOMContentLoaded", function() {
    const floatBtn = document.getElementById("baleFloatingBtn");
    const modalOverlay = document.getElementById("baleModalOverlay");
    const closeBtn = document.getElementById("baleModalClose");
    ...
    modalOverlay.addEventListener("click", function(event) {
        // بررسی می‌کنیم که کلیک دقیقاً روی خود پس‌زمینه باشد نه محتوای مودال
        if (event.target === modalOverlay) {
            modalOverlay.style.display = "none";
        }
    });

    // اجرای انیمیشن تکان خوردن هر 60 ثانیه (60000 میلی‌ثانیه)
    setInterval(function() {
        floatBtn.classList.add("bale-shake-anim");
        
        // برداشتن کلاس بعد از 1 ثانیه (پایان انیمیشن) تا بتواند دوباره اجرا شود
        setTimeout(function() {
            floatBtn.classList.remove("bale-shake-anim");
        }, 1000);
    }, 10000); 
});
</script>
<!-- پایان کدهای دکمه شناور بله -->
...
(function () {
    ...
    if (typeof window.zebline === 'undefined' || typeof window.zebline.init !== 'function') {
        return;
    }
    window.zebline.init({
            ...
            <?php if (is_user_logged_in()) :
                ...
                // Add product-specific data if this is a single product page
                global $ez_product_type, $ez_city_name;
                if (is_product() && isset($ez_product_type) && isset($ez_city_name)) {
                    $tracking_data["product_type"] = $ez_product_type;

                    // Get city data using the Persian city name
                    $city_data = get_city_by_persian_name($ez_city_name);
                    if ($city_data) {
                        $tracking_data["city_name_persian"] = $city_data['name'];
                        $tracking_data["city_name_english"] = $city_data['slug'];
                    } else {
                        // Fallback: use the city name directly if not found in settings
                        $tracking_data["city_name_persian"] = $ez_city_name;
                        $tracking_data["city_name_english"] = '';
                    }
                }
            ?>
                let currentPage = window.location.href;
                let currentPageTitle = '<?= esc_js($tracking_data["current_page_title"]) ?>';
                let currentPageId = '<?= esc_js($tracking_data["current_page_id"]) ?>';
                let trackingData = {
                    "current_page": currentPage,
                    "current_page_title": currentPageTitle,
                    "current_page_id": currentPageId,
                    "page_type": "<?= esc_js($tracking_data["page_type"]) ?>",
                    "utm_source": (new URLSearchParams(window.location.search)).get('utm_source') || '',
                    "url": window.location.href,
                    "referrer": document.referrer
                };

                <?php if (isset($tracking_data["product_type"])) : ?>
                    trackingData["product_type"] = "<?= esc_js($tracking_data["product_type"]) ?>";
                <?php endif; ?>

                <?php if (isset($tracking_data["city_name_persian"])) : ?>
                    trackingData["city_name_persian"] = "<?= esc_js($tracking_data["city_name_persian"]) ?>";
                    trackingData["city_name_english"] = "<?= esc_js($tracking_data["city_name_english"]) ?>";
                <?php endif; ?>

                if (window.zebline.event && typeof window.zebline.event.track === 'function') {
                    window.zebline.event.track('page_view_track', trackingData);
                }
            <?php endif; ?>
})();
</script>
