...
<section class="max-w-full py-4 md:py-5 lg:py-9">
  <form action="<?= home_url("/game-finder/") ?>" method="get" id="game-finder-form">
    <div class="max-lg:relative max-lg:w-screen max-lg:right-1/2 max-lg:left-1/2 max-lg:-ml-50vw max-lg:-mr-50vw max-lg:bg-stone-100 max-lg:before:w-screen max-lg:before:h-1.5 max-lg:before:bg-slate-120 max-lg:before:absolute max-lg:before:top-0 max-lg:before:left-0 max-lg:before:right-0 lg:rounded-xl lg:w-full lg:bg-gradient-to-t lg:from-transparent lg:from-75% lg:to-slate-700/40 to-200% lg:shadow-9">
      <div
        ...
        <div class="flex items-center max-lg:gap-x-4 lg:grid lg:grid-cols-4 lg:gap-x-5 max-lg:col-span-3 lg:col-span-10">
          ...
          <button
            type="submit"
            class="flex gap-4 items-center justify-center relative text-sm font-semibold focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 transition-all duration-300 ease-in-out disabled:bg-slate-110 disabled:text-disabled disabled:cursor-not-allowed disabled:shadow-none bg-primary-600 text-white shadow-14 hover:bg-primary-500 focus-visible:outline-primary-600 h-12 lg:px-5 p-4 lg:py-1 mr-auto rounded-lg max-lg:col-span-3 lg:order-2 max-lg:max-w-d56 lg:w-full">
...
<section class="mt-10">
  ...
  <div
    ...
    <div class="embla__viewport max-lg:relative">
      <div class="embla__container child:box-content flex child:ml-7 md:child:ml-12 xl:child:ml-15 last-child:ml-0 child:shrink-0 child:grow-0 child:w-d124 md:child:w-d178 child:py-2.5 child:relative max-lg:relative"
...
<section class="max-w-full py-4 md:py-5 lg:py-9 mt-2">
  ...
  <div class="relative overflow-hidden embla_normal">
    <div class="embla__viewport">
      <div id="cities-rooms-slider" class="embla__container first-child:before:hidden child:before:w-px child:before:absolute child:before:bg-gradient-to-t child:before:from-white child:before:via-slate-110 child:before:to-white child:before:-right-3.5 child:lg:before:-right-6 child:before:h-full min-h-d200 child:box-content lg:min-h-d300 flex child:ml-7 md:child:ml-12  last-child:ml-0 child:shrink-0 child:grow-0 child:w-d156 md:child:w-d190 child:py-2.5 child:relative"> <?= $cities_rooms ?> </div>
    </div>
...
<!--    <img src="<?= Theme_ASSET_URL ?>images/cat-id/text.avif" alt="بازی‌های گروهی بر فراز نقشه ایران" class="max-w-d300 lg:max-w-d600 max-lg:mx-auto" />-->
<!--  </div>-->
<!--  <div class="max-lg:col-span-3 col-span-2 max-lg:mr-7 max-lg:max-w-d170 max-lg:text-sm lg:text-2xl max-lg:leading-6 max-lg:mt-8 lg:mr-25 lg:-mt-10">-->
<!--    <p>با نقشه اسکیپ زوم نزدیک ترین سرگرمی به خودت رو پیدا کن</p>-->
<!--    <a href="<?= home_url('/maps/') ?>"-->
<!--      class="bg-slate-800 text-white shadow-8 w-d90 h-d34 rounded-lg lg:w-d135 lg:h-d48 lg:rounded-xl block text-center content-center hover:scale-105 transition-all max-lg:mt-4 lg:text-lg lg:mt-10">مشاهده-->
<!--      نقشه</a>-->
<!--  </div>-->
<!--  <div class="max-lg:col-span-2 lg:absolute lg:bottom-0 lg:left-20"><img-->
<!--      src="<?= Theme_ASSET_URL ?>images/cat-id/cto-home.avif" alt="" class="w-d250 lg:w-d400"></div>-->
<!--</section>-->
<?php
/*===============================================================*/
// آخرین کامنت ها
...
<section class="max-w-full py-4 md:py-5 lg:py-9">
  ...
  <div class="relative overflow-hidden embla_normal horizontal dragFree slider-event" data-slider-event="trends-rooms">
    <div class="embla__viewport">
      <div id="trends-rooms-slider" class="embla__container first-child:before:hidden child:before:w-px child:before:absolute child:before:bg-gradient-to-t child:before:from-white child:before:via-slate-110 child:before:to-white child:before:-right-3.5 child:lg:before:-right-6 child:before:h-full min-h-d200 child:box-content lg:min-h-d300 flex child:ml-7 md:child:ml-12  last-child:ml-0 child:relative child:shrink-0 child:grow-0 child:w-d156 md:child:w-d190 child:py-2.5"> <?= $home_trends_rooms ?> </div>
    </div>
  ...
  <section class="max-w-full py-4 md:py-5 lg:py-9">
    ...
    <div class="flex justify-between max-lg:gap-5  max-lg:overflow-x-auto  [scrollbar-width:none] [-ms-overflow-style:none] [&::-webkit-scrollbar]:hidden">
      <?php while ($query->have_posts()): $query->the_post(); ?>
        <div class="relative grow-0 shrink-0 w-d310 max-lg:h-d174 lg:h-d230">
          <a class="relative block overflow-hidden rounded-16 shadow-8 w-d310 max-lg:h-d174 lg:h-d230"
            ...
            <div
              class="absolute right-0 top-0 flex h-full w-full flex-col justify-between bg-gradient-to-t from-slate-700 to-transparent max-lg:p-3 lg:p-6 text-white/90">
              <div class="ez-post-category">
                <div class="text-white rounded-lg py-1 px-2 max-w-d55 text-xs font-bold" style="background: rgba(255, 255, 255, 0.25);backdrop-filter: blur(2px);">سرگرمی</div>
              </div>
              <div>
                ...
                <div
                  ...
                  <div class="flex gap-1">
                    ...
                    ?>
                    <p class="text-xs font-bold text-gray-600"><?php echo $reading_time; ?> دقیقه</p>
                  </div>

                  <div class="flex gap-1">
                    <p class="text-xs font-bold text-gray-600"><?= get_the_date('Y-m-d') ?></p>
                    <svg xmlns="http://www.w3.org/2000/svg" width="15" height="15" viewBox="0 0 15 15" fill="none">
