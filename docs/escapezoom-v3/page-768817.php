...
<div class="container mx-auto py-8 max-lg:mb-25 overflow-x-hidden scrollbar-hide" id="bootcamp-container" style="overflow-x: hidden !important; overflow-y: visible;">
    <!-- Puzzle 1 -->
    <div id="puzzle-1" class="puzzle-section max-lg:mb-d30">
        <div class="flex max-lg:flex-col justify-between relative w-full h-full rounded-4xl bg-surface-sunken lg:pr-d100 lg:pl-12 mt-d74 pb-7 max-lg:h-d170">
            <div class="flex justify-between w-full">
                <div class="absolute right-4 lg:right-7 -30-d">
                    <p class="text-70 font-black leading-70 text-transparent bg-clip-text bg-gradient-to-b from-primary-2 to-primary-2/10">1</p>
                </div>

                <div class="flex flex-col pt-6 pb-7 max-lg:pr-8 max-lg:pt-8">
                    <p class="text-base lg:text-xl font-bold flex-wrap max-lg:max-w-d169">کلمه ای که توی معمای اول پیدا کردی رو وارد کن.</p>
                    ...
                    <div class="flex items-center max-h-12 mt-10 z-1 gap-4 max-lg:absolute max-lg:bottom-5 max-lg:right-10">
                        <div class="flex items-center" id="puzzle-1-inputs">
                            <input type="text" maxlength="1" class="puzzle-input w-12 h-12 border border-slate-120 outline-none pr-4 text-lg rounded-tr-lg rounded-br-lg" data-index="0" />
                            <input type="text" maxlength="1" class="puzzle-input w-12 h-12 border border-slate-120 outline-none pr-4 text-lg" data-index="1" />
                            <input type="text" maxlength="1" class="puzzle-input w-12 h-12 border border-slate-120 outline-none pr-4 text-lg" data-index="2" />
                            <input type="text" maxlength="1" class="puzzle-input w-12 h-12 border border-slate-120 outline-none pr-4 text-lg rounded-bl-lg rounded-tl-lg" data-index="3" />
                        </div>

                        <button id="submit-puzzle-1" class="w-12 h-12 bg-focus-blue rounded-lg flex items-center justify-center cursor-pointer transition-all hover:bg-blue disabled:opacity-50 disabled:cursor-not-allowed relative">
...
jQuery(document).ready(function($) {
    ...
    const bootcampAjaxUrl = '<?php echo esc_url_raw( get_template_directory_uri() . '/inc/bootcamp/ajax/bootcamp_rest_api.php' ); ?>';
            ...
            $('body').append(`
                <div id="bootcamp-timer" class="fixed bottom-4 right-4 bg-white rounded-lg shadow-lg p-4 z-50">
                    <div class="flex items-center gap-2">
                        <svg class="w-5 h-5 text-focus-blue" fill="none" stroke="currentColor" viewBox="0 0 24 24">
