    ...
    <div class="lg:hidden">
		<?php foreach ( $points as $index => $point ) { ?>
            <div class="border-b py-4 flex gap-4 items-center">
                <div class="flex items-center justify-between max-lg:flex-col max-lg:rounded-lg max-lg:border max-lg:border-gray-100 max-lg:bg-warn-surface-2 py-4 px-2 max-lg:shadow-13 lg:mt-3 lg:gap-3">
