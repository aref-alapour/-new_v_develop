...
if ($user) {
    ...
    <form action="#" method="post" id="password-form" class="w-full flex flex-col hidden">
        <strong class="text-22 text-textColor font-bold block mt-9 text-center">ورود به حساب</strong>
    ...
    <form action="#" method="post" id="otp-form" class="w-full flex flex-col hidden">
        ...
        <strong class="text-22 text-textColor font-bold block mt-9 text-center" id="otp-title">تایید کد</strong>
    ...
    <form action="#" method="post" id="new-password-form" class="w-full flex flex-col hidden">
        <strong class="text-22 text-textColor font-bold block mt-9">تغییر رمز عبور</strong>
    ...
    <form action="#" method="post" id="profile-form" class="w-full flex flex-col hidden">
        <strong class="text-22 text-textColor font-bold block mt-9">اطلاعات شخصی</strong>
