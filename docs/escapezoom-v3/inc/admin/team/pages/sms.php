        ...
        <?php else: ?>
            <div class="grid grid-cols-2 gap-x-12.5 gap-y-10">
                <?php foreach ($sms_templates as $template_id => $template_data) : ?>
                    <div class="mobile-form template-card flex flex-col justify-between w-d350 h-full min-w-d356 p-7 border border-edge rounded-2.5xl bg-surface-sunken"
                        ...
                        <div>
                            ...
                            <p class="template-text text-base font-yekan-bold text-navyBlue leading-38"><?php echo nl2br(esc_html($template_data['content'])); ?></p>
                        </div>
                    </div>
                <?php endforeach; ?>
            </div>
