...
<div class="flex justify-between items-center">
    ...
    <div class="flex items-center gap-x-6">
        <div class="relative w-full min-w-75 h-d58" style="z-index: 99;">
            <input id="gameSearch" class="w-full min-w-75 h-d58 border border-slate-105 bg-white rounded-xl outline-none px-6 py-5 text-xs font-bold text-navyBlue" placeholder="جست و جو بازی" />
        ...
        <div class="flex items-center justify-between mx-auto">
            <div class="flex items-center gap-2">
                <input id="term_filter_text" type="text" placeholder="جستجو دیدگاه" class="h-d58 w-d179 px-4 py-2.5 rounded-lg text-xs font-bold border border-slate-105 bg-white text-navyBlue outline-none" />
                <button id="term_filter_btn" class="h-d58 text-orange-500 border border-orange-400 px-4 py-2 rounded-lg hover:bg-orange-50 text-base font-bold cursor-pointer text-nowrap"> اعمال فیلتر </button>
            </div>
        </div>
    </div>
</div>
...
<div id="modalOverlay" class="fixed inset-0 z-50 backdrop-blur-sm bg-white/30"
    ...
    <div id="modalContent" class="bg-white rounded-lg w-full max-w-xl p-6 shadow-xl absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2">
        ...
        <input type="hidden" id="currentCommentApproved" value="">

        <p id="modalTrashNote" class="hidden text-sm font-yekan-bold text-center text-amber-800 mb-3">این کامنت در سطل زباله است؛ عملیات انتشار، عدم نمایش، ویرایش و حذف غیرفعال است.</p>

        <input type="hidden" id="teamCommentPendingAction" value="">

        <div class="flex flex-wrap justify-center items-center gap-3 mb-1">
            <button id="publishBtn"
                class="modal-action-btn bg-accent-700 hover:bg-green-700 text-white py-2 rounded-lg w-d103 h-d38 text-base font-yekan-bold cursor-pointer">انتشار</button>
            <button id="editCommentBtn"
                class="modal-action-btn bg-focus-blue hover:bg-blue-700 text-white py-2 rounded-lg w-d103 h-d38 text-base font-yekan-bold cursor-pointer">ویرایش
                کامنت</button>
            <button id="hideBtn"
                class="modal-action-btn bg-amber-ring hover:bg-yellow-700 text-white py-2 rounded-lg w-d103 h-d38 text-base font-yekan-bold cursor-pointer">عدم
                نمایش</button>
            <button id="showDeleteReason"
                class="modal-action-btn bg-red-500 hover:bg-red-700 text-white py-2 rounded-lg w-d103 h-d38 text-base font-yekan-bold cursor-pointer">حذف</button>
        </div>

        <div id="actionReasonPanel" class="hidden mt-4 mb-2 border border-edge rounded-xl p-4 bg-white">
            <label id="actionReasonDynamicLabel" for="inlineActionReason" class="block text-sm font-yekan-bold text-navyBlue mb-2"></label>
            <textarea id="inlineActionReason" rows="3"
                class="w-full border border-edge rounded-xl p-3 shadow-3 text-sm outline-none resize-none mb-3"></textarea>
            <button type="button" id="actionReasonProceedBtn"
                class="w-full bg-accent-700 hover:bg-green-700 text-white py-2 rounded-lg text-base font-yekan-bold cursor-pointer">تأیید و ادامه</button>
        </div>

        <div id="deleteReasonBox" style="display: none;">

            <hr class="text-slate-105 my-3" />
            ...
            <form class="space-y-3">
                ...
                <label class="block text-sm font-yekan-bold text-navyBlue mt-3 mb-1">دلیل حذف <span class="text-red-500">*</span></label>
                <textarea placeholder="دلیل حذف این کامنت را بنویسید..." id="reason_text" rows="3" class="w-full border border-edge rounded-md p-2 text-sm resize-none outline-none"></textarea>
        ...
        <div id="editCommentBox" style="display: none;">
            <hr class="text-slate-105 mt-3 mb-5" />
            <form>
                <!-- Edit Username -->
                ...
                <input type="text" id="editUsername" placeholder="نام کاربر را وارد کنید..."
                    class="w-full border border-edge rounded-xl p-3 shadow-3 text-sm outline-none">
                <hr class="text-slate-105 border-2 my-5" />
                <!-- Edit Comment Text -->
                ...
                <textarea id="editCommentText" placeholder="متن کامنت را وارد کنید..." rows="4"
                    class="w-full border border-edge rounded-xl p-3 shadow-3 text-sm outline-none"></textarea>
                <hr class="text-slate-105 border-2 my-5" />
                <!-- Rating Sections -->
                <div class="grid grid-cols-5 gap-2">
                    ...
                    <div class="flex flex-col gap-y-2">
                        ...
                        <div class="relative w-full">
                            <select id="act"
                                class="appearance-none bg-white border border-edge rounded-10 px-3 py-2 pl-6 text-sm font-yekan-bold focus:outline-none focus:ring-2 focus:ring-amber-ring w-full shadow-3"
                                style="color: #D08700;">
                ...
                <hr class="text-slate-105 border-2 my-5" />
                <label class="block text-sm font-yekan-bold text-navyBlue mb-2">دلیل ویرایش <span class="text-red-500">*</span></label>
                <textarea id="editReason" placeholder="دلیل ویرایش این کامنت را بنویسید..." rows="3"
                    class="w-full border border-edge rounded-xl p-3 shadow-3 text-sm outline-none resize-none"></textarea>

                <button type="button"
                    class="w-full bg-primary-2 hover:bg-primary-deep text-white py-2 rounded-lg mt-4 text-lg font-yekan-heavy cursor-pointer"
...
<div id="modalOverlaylevel" class="fixed inset-0 z-50 backdrop-blur-sm bg-white/30"
    style="display: none;">
    <div id="modalContentlevel" class="bg-white rounded-lg max-w-xl p-6 shadow-xl w-d400 min-h-d300 absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2">
        <div class="flex flex-col">
            ...
            <div class="space-y-4">
                <div class="flex justify-between items-center">
                    <p class="text-sm font-yekan-bold text-slate-250 w-32">بازیگردانی‌واکت</p>
                    ...
                    <p class="text-sm font-yekan-bold text-amber-ring w-6 text-center" id="actingRating">0</p>
                </div>

                <div class="flex justify-between items-center">
                    <p class="text-sm font-yekan-bold text-slate-250 w-32">کیفیت معما</p>
                    <div class="flex-1 mx-4">
                        <div class="w-full bg-gray-200 rounded-full h-2">
                            <div
                    ...
                    <p class="text-sm font-yekan-bold text-amber-ring w-6 text-center" id="puzzleRating">0</p>
                </div>

                <div class="flex justify-between items-center">
                    <p class="text-sm font-yekan-bold text-slate-250 w-32">فضاسازی</p>
                    <div class="flex-1 mx-4">
                        <div class="w-full bg-gray-200 rounded-full h-2">
                            <div
                    ...
                    <p class="text-sm font-yekan-bold text-amber-ring w-6 text-center" id="atmosphereRating">0</p>
                </div>

                <div class="flex justify-between items-center">
                    <p class="text-sm font-yekan-bold text-slate-250 w-32">تازگی و خلاقیت</p>
                    <div class="flex-1 mx-4">
                        <div class="w-full bg-gray-200 rounded-full h-2">
                            <div
                    ...
                    <p class="text-sm font-yekan-bold text-amber-ring w-6 text-center" id="creativityRating">0</p>
                </div>

                <div class="flex justify-between items-center">
                    <p class="text-sm font-yekan-bold text-slate-250 w-32">برخورد پرسنل</p>
                    <div class="flex-1 mx-4">
                        <div class="w-full bg-gray-200 rounded-full h-2">
                            <div
                    ...
                    <p class="text-sm font-yekan-bold text-amber-ring w-6 text-center" id="staffRating">0</p>
                </div>
            </div>
...
<script>
    jQuery(document).ready(function($) {
        ...
        $('body').on('click', "#deleteReasonBox button", function() {
            const arDel = ($('#reason_text').val() || '').trim();
            if (!arDel) {
                showToast('وارد کردن دلیل حذف الزامی است.', 'error', 5000);
                return;
            }
            ...
            $.ajax({
                ...
                error: function(xhr) {
                    ...
                    showToast(parseTeamAjaxError(xhr, 'خطا در حذف کامنت. لطفاً دوباره تلاش کنید'), 'error', 5000);
                }
            });
        });
        ...
        $('body').on('click', "#editCommentBox button", function() {
            ...
            const editReasonVal = ($("#editReason").val() || '').trim();
            if (!editReasonVal) {
                showToast('وارد کردن دلیل ویرایش الزامی است.', 'error', 5000);
                return;
            }
            ...
            $.ajax({
                ...
                data: {
                    ...
                    'edit_reason': $("#editReason").val(),
                    'action_reason': $("#editReason").val(),
                    'ratings': ratings,
                    'comment_id': $("#currentCommentId").val(),
                },
                success: function(data) {
                ...
                error: function(xhr) {
                    let msg = 'خطا در ویرایش کامنت. لطفاً دوباره تلاش کنید';
                    try {
        ...
        function hideTeamActionReasonPanel() {
            $('#actionReasonPanel').stop(true, true).hide().addClass('hidden');
            $('#inlineActionReason').val('');
            $('#teamCommentPendingAction').val('');
        }

        function showTeamActionReasonPanel(mode) {
            $('#teamCommentPendingAction').val(mode);
            const $panel = $('#actionReasonPanel');
            const $label = $('#actionReasonDynamicLabel');
            const $ta = $('#inlineActionReason');
            const $proceed = $('#actionReasonProceedBtn');
            if (mode === 'publish') {
                $label.html('دلیل انتشار <span class="text-red-500">*</span>');
                $ta.attr('placeholder', 'دلیل انتشار این کامنت را بنویسید...');
                $proceed.removeClass('bg-amber-ring hover:bg-amber-800').addClass('bg-accent-700 hover:bg-green-700').text('تأیید و انتشار');
            } else if (mode === 'hold') {
                $label.html('دلیل عدم نمایش <span class="text-red-500">*</span>');
                $ta.attr('placeholder', 'دلیل عدم نمایش این کامنت را بنویسید...');
                $proceed.removeClass('bg-accent-700 hover:bg-green-700').addClass('bg-amber-ring hover:bg-amber-800').text('تأیید عدم نمایش');
            }
            $ta.val('');
            $panel.removeClass('hidden').hide().slideDown(200);
            setTimeout(function() {
                $ta.trigger('focus');
            }, 220);
        }
        ...
        function closeModal() {
            ...
            $("#currentCommentApproved").val("");
            hideTeamActionReasonPanel();
            $('#modalTrashNote').addClass('hidden');
            $('#publishBtn, #hideBtn, #editCommentBtn, #showDeleteReason').show();
            // Reset button states
            ...
            $("#editReason").val('');
            $('#actionReasonProceedBtn').prop('disabled', false).removeClass('bg-amber-ring hover:bg-amber-800').addClass('bg-accent-700 hover:bg-green-700').text('تأیید و انتشار');
        }

        function parseTeamAjaxError(xhr, fallback) {
            let msg = fallback;
            try {
                const j = JSON.parse(xhr.responseText || '{}');
                if (j.data && j.data.message) {
        ...
        function showToast(message, type = 'success', duration = 3000) {
            ...
            const toast = $(`
                <div id="${toastId}" class="fixed bottom-4 left-4 ${bgColor} text-white px-6 py-4 rounded-lg shadow-lg z-9999 flex items-center gap-3 min-w-d300 max-w-d400 transform -translate-x-full transition-transform duration-300 ease-in-out">
        ...
        //   -----modal-page-comments---------------------------------------
        function applyTeamCommentModalActions(approved) {
            const a = String(approved === undefined || approved === null ? '' : approved);
            $('#publishBtn, #hideBtn, #editCommentBtn, #showDeleteReason').show();
            $('#modalTrashNote').addClass('hidden');
            if (a === '1') {
                $('#publishBtn').hide();
                ...
                $('#modalTrashNote').removeClass('hidden');
                $('#publishBtn, #hideBtn, #editCommentBtn, #showDeleteReason').hide();
            }
        }
        ...
        $('body').on('click', ".openModal", function() {
            ...
            $("#currentCommentApproved").val(approved);
            hideTeamActionReasonPanel();
            ...
            applyTeamCommentModalActions(approved);
        ...
        // Button state management (انتشار/عدم‌نمایش پنل دلیل دارند؛ قفل دکمه‌ها باعث گیر UX می‌شود)
        $('body').on('click', ".modal-action-btn", function(e) {
            const bid = $(this).attr('id');
            if (bid !== 'publishBtn' && bid !== 'hideBtn') {
        ...
        $('body').on('click', "#publishBtn", function() {
            showTeamActionReasonPanel('publish');
            $(".modal-action-btn").removeClass("opacity-50 cursor-not-allowed").prop("disabled", false);
        });

        $('body').on('click', "#hideBtn", function() {
            showTeamActionReasonPanel('hold');
            $(".modal-action-btn").removeClass("opacity-50 cursor-not-allowed").prop("disabled", false);
        });

        $('body').on('click', "#actionReasonProceedBtn", function() {
            const mode = $('#teamCommentPendingAction').val();
            const ar = ($('#inlineActionReason').val() || '').trim();
            if (!mode || (mode !== 'publish' && mode !== 'hold')) {
                return;
            }
            if (!ar) {
                showToast(mode === 'publish' ? 'وارد کردن دلیل انتشار الزامی است.' : 'وارد کردن دلیل عدم نمایش الزامی است.', 'error', 5000);
                return;
            }
            ...
            const swalBase = mode === 'publish' ? swalPub : swalHold;
            ...
            Swal.fire(Object.assign({
            ...
            }, swalBase)).then((result) => {
                if (!result.isConfirmed) {
                    return;
                }
                const $proceed = $('#actionReasonProceedBtn');
                const originalProceedText = $proceed.text();
                $proceed.prop('disabled', true).html(`
                    <div class="flex items-center justify-center gap-2">
                        <svg class="animate-spin h-4 w-4 text-white" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
                            <circle class="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" stroke-width="4"></circle>
                            <path class="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4zm2 5.291A7.962 7.962 0 014 12H0c0 3.042 1.135 5.824 3 7.938l3-2.647z"></path>
                ...
                $.ajax({
                    ...
                    data: {
                        ...
                        'approve_type': mode === 'publish' ? 'approve' : 'hold',
                        'action_reason': ar,
                        'comment_id': $("#currentCommentId").val(),
                    },
                    success: function(data) {
                        closeModal();
                        showToast(mode === 'publish' ? 'کامنت با موفقیت منتشر شد' : 'کامنت با موفقیت پنهان شد', 'success', 4000);
                        let status = $("#filterTabs div.active").data('status');
                        let product_id = $("#current_product_id").val();
                        let term = $("#term_filter_text").val();
                        get_data(status, product_id, term, 1);
                    ...
                    error: function(xhr) {
                        $proceed.prop('disabled', false).text(originalProceedText);
                        showToast(parseTeamAjaxError(xhr, mode === 'publish' ? 'خطا در انتشار کامنت. لطفاً دوباره تلاش کنید' : 'خطا در پنهان کردن کامنت. لطفاً دوباره تلاش کنید'), 'error', 5000);
                    }
                });
            });
        });
        ...
        $('body').on('click', ".toggle-btn", function() {
            ...
            if (isOpen) {
                $(this)
                    .text("بسته")
                    .removeClass("bg-accent-550 text-white")
                    .addClass("bg-rail text-black");
            } else {
                $(this)
                    .text("باز")
                    .removeClass("bg-rail text-black")
                    .addClass("bg-accent-550 text-white");
            }
        });
    });
</script>