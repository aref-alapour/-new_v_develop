...
<form id="game-finder-form" class="mt-6">
        ...
        <div class="flex justify-between gap-5">
            <div class="relative">
                <input
                    ...
                    class="w-d236 h-d54 rounded-xl border border-slate-105 text-xs font-yekan-bold p-4 outline-none transition-colors duration-150"
            ...
            <button
                ...
                class="h-d54 w-28 text-center content-center text-base font-yekan-heavy text-white bg-gray-400 rounded-xl cursor-not-allowed text-nowrap"
                disabled>
                ارسال پیامک
            </button>
        </div>
    ...
    <section
        ...
        <div class="grid grid-cols-3 gap-x-6 gap-y-5 grow py-8">
            <div class="w-full">
                <div class="mb-2 text-steel font-bold">شهر</div>
            ...
            <div class="w-full">
                <div class="mb-2 text-steel font-bold">نوع بازی</div>
                <div class="relative w-full max-w-xs">
                    <div class="sans-dropdown-container relative">
                        <button type="button"
                            class="sans-dropdown-button w-full bg-white border border-gray-100/80 rounded-lg max-lg:shadow-13 h-d48 px-4 py-2 text-right flex items-center justify-between">
            ...
            <div class="w-full">
                <div class="mb-2 text-steel font-bold">تعداد نفرات</div>
                <div class="relative w-full max-w-xs">
                    <div class="sans-dropdown-container relative">
                        <button type="button"
                            class="sans-dropdown-button w-full bg-white border border-gray-100/80 rounded-lg max-lg:shadow-13 h-d48 px-4 py-2 text-right flex items-center justify-between">
        ...
        <div class="bg-slate-105 self-stretch w-0.5"></div>
        <div class="flex items-center gap-x-5 shrink-0 py-8">
            ...
            <button type="submit"
                class="w-42 h-d48 bg-primary-500 hover:bg-primary-600 shadow-13 shrink-0 rounded-8 self-end">
        ...
        $('#mobile-input-sansyab').on('input', function() {
            ...
            if (isValid) {
                $btn.prop('disabled', false)
                    ...
                    .addClass('bg-accent-450 cursor-pointer');
                $input.removeClass('border-red-500');
                $error.addClass('hidden');
            } else {
                $btn.prop('disabled', true)
                    .removeClass('bg-accent-450 cursor-pointer')
