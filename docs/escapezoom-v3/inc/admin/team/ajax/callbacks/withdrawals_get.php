...
$date_format = 'Y.m.d | H:i'; ?>
    ...
    <section class="mt-7">
        ...
        if ($status == 'pending') : ?>
            ...
            <div id="tableHeader">
                <div class="grid grid-cols-[1fr,3fr,2fr,2fr,3fr,3fr,3fr,2fr,2fr,3fr] text-sm font-yekan-bold text-text-3 font-semibold text-center bg-edge w-full rounded-t-xl">
                    <p class="py-4">ردیف</p>
                    ...
                    <p class="py-4 bg-yellow-400 rounded-t-xl text-white">مبلغ درخواستی</p>
                ...
                if (!empty($transactions)) :
                    ...
                    foreach ($transactions as $trans) :
                        ...
                        <div data-id="<?php echo $trans->ID ?>" class="grid grid-cols-[1fr,3fr,2fr,2fr,3fr,3fr,3fr,2fr,2fr,3fr] text-sm font-yekan-bold text-grayy text-center">
                            <p class="py-4 text-text-3"><?php echo ++$count; ?></p>
                            ...
                            <p class="py-4 bg-yellow-400/40 text-navyBlue"><?php echo number_format(abs($trans->amount)) ?></p>
                            ...
                            if ( array_intersect( ['administrator', 'accounting'], wp_get_current_user()->roles ) ) : ?>
                                ...
                                <div class="transaction_function flex justify-center py-4 gap-x-5">
                                    ...
                                    <button type="button" class="cursor-pointer shrink-0 grow-0 hover:opacity-80 w-9 h-9 btn-reject rounded-full border border-accent-450/60 shadow-2 bg-white"
                                            data-trans_id="<?php echo $trans->ID; ?>"
        ...
        elseif ($status == 'paid') : ?>
            ...
            <div id="tableHeader">
                <div class="grid grid-cols-[1fr,4fr,2fr,2fr,4fr,4fr,6fr] text-sm font-yekan-bold text-text-3 font-semibold text-center bg-edge w-full rounded-t-xl">
                    <p class="py-4">ردیف</p>
                    ...
                    <p class="py-4">شماره تراکنش</p>
                    <p class="py-4">زمان درخواست</p>
                    <p class="py-4 bg-yellow-400 rounded-t-xl text-white">مبلغ پرداخت شده</p>
