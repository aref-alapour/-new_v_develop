...
foreach ($requests as $request) :
    ...
    <section class="request-card flex justify-center items-center mt-5">
        ...
        <div class="rounded-2.5xl overflow-hidden w-full pt-d20 border border-rail shadow-rail-lip <?php echo $request_cart_color ?>">
            <div class="flex justify-between px-d20">
                ...
                <div class="flex justify-center items-center gap-d6 bg-white rounded-6 py-1 px-2 ml-d120">
                    ...
                    <p class="text-text-3 text-base font-extrabold"><?php echo human_time_diff($request['created_at'], $now) . ' قبل' ?></p>
                </div>
                <div class="flex justify-center bg-white gap-d6 px-2 py-1 rounded-md">
            ...
            <div class="flex justify-between px-d20 my-d20">
                ...
                if ($request_type == 'customer') {
                    ...
                    <?php
                        ...
                        <button class="openModalBtn admin_approval_btn text-base font-extrabold text-white bg-accent-450 px-4 py-3 rounded-xl cursor-pointer" data-request-id="<?php echo $request['ID']; ?>">تایید و لغو سانس</button>
                    <?php
                    }
                } else { ?>
                    <button class="openModalBtn text-base font-extrabold text-white bg-accent-450 px-4 py-3 rounded-xl cursor-pointer" data-request-id="<?php echo $request['ID']; ?>">تایید و لغو سانس!</button>
                <?php
                } ?>
            ...
            <div class="flex-col items-center justify-center bg-gray-20 px-d20 pt-2 pb-d20 description hidden">
                ...
                <div class="flex justify-between items-center mt-d14 mx-d20">
                    ...
                    <div class="flex">
                        ...
                        <div class="rounded-24 h-5.5 px-2.5 leading-none content-center text-2xs text-center <?php echo esc_attr( $themeColor ); ?>" style="background-color: <?php echo esc_attr( $badge_bg ); ?>">
