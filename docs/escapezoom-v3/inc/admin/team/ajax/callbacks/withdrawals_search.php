...
<section class="grid justify-center items-center mt-7">
    ...
    if ( $status == 'pending' ) : ?>
        ...
        <div id="tableHeader" class="px-d34">
            <div class="grid grid-cols-[46px_140px_71px_91px_143px_99px_126px_99px_112px_63px_104px] text-sm font-yekan-bold text-grayy text-center bg-text-3">
                <p class="py-4">ردیف</p>
        ...
        <div id="settlementTableBody" class="w-full h-full px-d34 rounded-b-2.5xl grid">
