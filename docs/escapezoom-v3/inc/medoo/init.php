...
function ez_medoo_crm_config(): array {
	...
	$pass = defined( 'DB_PASSWORD' ) ? DB_PASSWORD : 'arefpassword';
...
function ez_medoo_queries_config(): array {
	...
	$user = defined( 'DB_EXT_USER' ) ? DB_EXT_USER : ( defined( 'DB_USER' ) ? DB_USER : 'root' );
	$pass = defined( 'DB_EXT_PASSWORD' ) ? DB_EXT_PASSWORD : ( defined( 'DB_PASSWORD' ) ? DB_PASSWORD : 'arefpassword' );
