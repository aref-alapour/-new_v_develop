<?php
/**
 * ez_queryable_set_products_data2_nactive (+1 more)
 *
 * توابع: ez_queryable_set_products_data2_nactive, ez_queryable_set_products_data_nactive هوک‌ها: woocommerce_after_register_post_type
 *
 * منبع: saeed-codes.php (بازهٔ خطوط 628-765)
