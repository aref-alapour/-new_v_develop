...
<head>
    ...
    <?php
    /*
     * EZ AJAX Gateway: boot data MUST be emitted before wp_head() so HTMX configRequest hooks
     * (queued by main-js / brands-page.js) can read window.__EZ_BOOT__ on first paint.
     * Rule 00-modularity carves out a real exception for per-request boot blobs — they cannot
     * live in a static asset and must run before any other inline/external script.
     */
    if ( function_exists( 'ez_ajax_boot_print_inline' ) ) {
    ...
    <script>
        ...
        var ezSearchAjaxUrl = '<?php echo esc_url_raw( get_template_directory_uri() . '/inc/http/func/main-search-ajax.php' ); ?>';

        // Cities data for modal
        var citiesData = <?php echo json_encode($cities_menu); ?>;
    </script>
    <?php if ( function_exists( 'ez_theme_should_load_mediaad' ) && ez_theme_should_load_mediaad() ) : ?>
        <script type="text/javascript" src="https://s1.mediaad.org/serve/115280/retargeting.js" async defer></script>
    <?php endif; ?>
</head>
...
<body <?php body_class('overflow-x-hidden'); ?>>
    ...
    <?php if (! is_wc_login_page()) { ?>
        ...
        <header class="container mx-auto max-lg:min-h-d66 lg:min-h-d75 relative">
            <div class="px-4 sm:px-6 md:divide-y md:divide-slate-60 md:px-8">
                <nav class="hidden flex-wrap items-center justify-between pt-7 lg:flex">
                    ...
                    <div class="flex flex-wrap items-center justify-between gap-5">
                        ...
                        <div class="max-lg:hidden city-selection-wrapper border-l border-solid border-gray-200 pl-4 py-2.5 ml-2 relative group">
                            ...
                            <div class="hidden group-hover:block absolute top-full left-0 z-50">
                                <div class="border border-solid border-gray-200 w-d262 bg-white rounded-br-lg rounded-bl-lg shadow-lg" style="max-height: 450px;">
                                    <div class="py-5 px-3">
                                        <!-- Search Box -->
                                        <div class="relative w-full">
                                            <input id="city-search-input-lg" type="text"
                                                class="w-full h-d38 border border-gray-200 px-1.5 rounded-lg py-4 ps-4 text-sm focus:outline-none focus:border-primary-500"
                                        ...
                                        <div id="city-search-mode-lg" class="hidden">
                                            ...
                                            <div id="city-search-results-lg" class="max-h-d220 overflow-y-auto flex flex-col gap-1 pr-1 custom-scrollbar">
                        ...
                        <div class="max-lg:hidden relative" id="search-container-desktop">
                            <button type="button" id="search-btn-desktop"
                                class="flex gap-4 items-center justify-center relative text-sm font-semibold focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 transition-all duration-300 ease-in-out disabled:bg-slate-110 disabled:text-disabled disabled:cursor-not-allowed disabled:shadow-none bg-white text-gray-900 border border-gray-100 hover:bg-button-gradient focus-visible:bg-button-gradient p-2 shadow-wrapper h-11.5 min-w-12 rounded-lg hover:shadow-none">
                                <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 18 18" fill="none" class="icon-default-desktop block">
                                    <path
                                ...
                                <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 18 18" fill="none" class="icon-active-desktop hidden">
                                    <path
                                        d="M8.53418 0.751953C10.5859 0.712459 12.5733 1.46913 14.0791 2.86328C15.5847 4.25732 16.4918 6.18007 16.6104 8.22852C16.7243 10.2001 16.0966 12.1387 14.8594 13.6709L17.0107 15.8213L17.0137 15.8242L17.0684 15.8857C17.1873 16.0358 17.2517 16.223 17.25 16.416C17.2481 16.6366 17.1599 16.8479 17.0039 17.0039C16.8479 17.1599 16.6366 17.2481 16.416 17.25C16.1954 17.2519 15.9829 17.1669 15.8242 17.0137L13.6709 14.8604C12.1387 16.0974 10.1999 16.7243 8.22852 16.6104C6.18007 16.4918 4.25732 15.5847 2.86328 14.0791C1.46913 12.5733 0.712459 10.5859 0.751953 8.53418C0.791453 6.48244 1.62315 4.52528 3.07422 3.07422C4.52528 1.62315 6.48244 0.791453 8.53418 0.751953ZM8.6875 2.43262C7.02875 2.43262 5.43756 3.09173 4.26465 4.26465C3.09173 5.43756 2.43262 7.02875 2.43262 8.6875C2.43274 10.3461 3.09186 11.9366 4.26465 13.1094C5.43756 14.2823 7.02875 14.9414 8.6875 14.9414C10.3461 14.9413 11.9366 14.2822 13.1094 13.1094C14.2822 11.9366 14.9413 10.3461 14.9414 8.6875C14.9414 7.02875 14.2823 5.43756 13.1094 4.26465C11.9366 3.09186 10.3461 2.43274 8.6875 2.43262Z"
                ...
                <nav class="bg-white fixed z-100 mobile-navbar">
                    <div class="fixed bg-white top-0 w-full right-0 z-50">
                        <div
                            class="lg:hidden px-5 py-3 flex items-center justify-between text-slate-800 transition-all z-90 shadow-mobile-nav">
                            <div class="flex items-center">
                                <div class="cursor-pointer max-md:ml-4" id="open-mobile-nav2">
                                    ...
                                    <svg class="close-icon hidden" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                            ...
                            <div class="flex flex-wrap items-center justify-between gap-8">
                                <div class="relative group">
                                    <div class="flex items-center city-selection rounded-lg border border-solid border-gray-200 px-2 py-1">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
                                            <path
                                                d="M9.99967 1.66669C6.33301 1.66669 3.33301 4.66669 3.33301 8.33335C3.33301 12.8334 9.16634 17.9167 9.41634 18.1667C9.58301 18.25 9.83301 18.3334 9.99967 18.3334C10.1663 18.3334 10.4163 18.25 10.583 18.1667C10.833 17.9167 16.6663 12.8334 16.6663 8.33335C16.6663 4.66669 13.6663 1.66669 9.99967 1.66669ZM9.99967 16.4167C8.24967 14.75 4.99967 11.1667 4.99967 8.33335C4.99967 5.58335 7.24967 3.33335 9.99967 3.33335C12.7497 3.33335 14.9997 5.58335 14.9997 8.33335C14.9997 11.0834 11.7497 14.75 9.99967 16.4167ZM9.99967 5.00002C8.16634 5.00002 6.66634 6.50002 6.66634 8.33335C6.66634 10.1667 8.16634 11.6667 9.99967 11.6667C11.833 11.6667 13.333 10.1667 13.333 8.33335C13.333 6.50002 11.833 5.00002 9.99967 5.00002ZM9.99967 10C9.08301 10 8.33301 9.25002 8.33301 8.33335C8.33301 7.41669 9.08301 6.66669 9.99967 6.66669C10.9163 6.66669 11.6663 7.41669 11.6663 8.33335C11.6663 9.25002 10.9163 10 9.99967 10Z"
                                                fill="#90A1B9" />
                                    ...
                                    <!-- City Selection Modal -->
                                    <div class="hidden group-hover:block absolute top-full left-5 z-50 mt-d15">
                                        <div class="border border-solid border-gray-200 w-d262 bg-white rounded-br-lg rounded-bl-lg shadow-lg" style="max-height: 400px;">
                                            <div class="py-5 px-3">
                                                        ...
                                                        <div id="city-carousel-track-sm" class="flex transition-transform duration-300 ease-in-out" style="transform: translateX(0%);">
                                                            ...
                                                            foreach ($city_chunks as $chunk): ?>
                                                                <div class="w-full flex-shrink-0 grid grid-cols-2 gap-2 items-start">
                                                                    <?php foreach ($chunk as $city): ?>
                                                                        <a href="<?= esc_url( $city['slug'] ) ?>" 
                                                                        class="h-d38 rounded-lg px-2 flex items-center justify-center cursor-pointer bg-gray-50 border border-gray-100 hover:bg-slate-100 hover:text-primary-500 hover:border-gray-200 transition-colors text-sm truncate">
                                                                            <?php echo esc_html($city['name']); ?>
                                                                        </a>
                                                                    <?php endforeach; ?>
                                                                </div>
                                                ...
                                                <div id="city-search-mode-sm" class="hidden">
                                                    <div class="mb-2 text-xs text-gray-500 px-1">نتایج جستجو</div>
                                                    <div id="city-search-results-sm" class="max-h-d220 overflow-y-auto flex flex-col gap-1 pr-1 custom-scrollbar">
                                ...
                                <button type="button" id="search-btn"
                                    ...
                                    <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 18 18" fill="none" class="icon-default block">
                                        <path
                                            d="M8.53418 0.751953C10.5859 0.712459 12.5733 1.46913 14.0791 2.86328C15.5847 4.25732 16.4918 6.18007 16.6104 8.22852C16.7243 10.2001 16.0966 12.1387 14.8594 13.6709L17.0107 15.8213L17.0137 15.8242L17.0684 15.8857C17.1873 16.0358 17.2517 16.223 17.25 16.416C17.2481 16.6366 17.1599 16.8479 17.0039 17.0039C16.8479 17.1599 16.6366 17.2481 16.416 17.25C16.1954 17.2519 15.9829 17.1669 15.8242 17.0137L13.6709 14.8604C12.1387 16.0974 10.1999 16.7243 8.22852 16.6104C6.18007 16.4918 4.25732 15.5847 2.86328 14.0791C1.46913 12.5733 0.712459 10.5859 0.751953 8.53418C0.791453 6.48244 1.62315 4.52528 3.07422 3.07422C4.52528 1.62315 6.48244 0.791453 8.53418 0.751953ZM8.6875 2.43262C7.02875 2.43262 5.43756 3.09173 4.26465 4.26465C3.09173 5.43756 2.43262 7.02875 2.43262 8.6875C2.43274 10.3461 3.09186 11.9366 4.26465 13.1094C5.43756 14.2823 7.02875 14.9414 8.6875 14.9414C10.3461 14.9413 11.9366 14.2822 13.1094 13.1094C14.2822 11.9366 14.9413 10.3461 14.9414 8.6875C14.9414 7.02875 14.2823 5.43756 13.1094 4.26465C11.9366 3.09186 10.3461 2.43274 8.6875 2.43262Z"
                                            fill="#0F172B" stroke="#0F172B" stroke-width="0.5" />
                                    </svg>
                                    <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 18 18" fill="none" class="icon-active hidden">
                                        <path
                                            d="M8.53418 0.751953C10.5859 0.712459 12.5733 1.46913 14.0791 2.86328C15.5847 4.25732 16.4918 6.18007 16.6104 8.22852C16.7243 10.2001 16.0966 12.1387 14.8594 13.6709L17.0107 15.8213L17.0137 15.8242L17.0684 15.8857C17.1873 16.0358 17.2517 16.223 17.25 16.416C17.2481 16.6366 17.1599 16.8479 17.0039 17.0039C16.8479 17.1599 16.6366 17.2481 16.416 17.25C16.1954 17.2519 15.9829 17.1669 15.8242 17.0137L13.6709 14.8604C12.1387 16.0974 10.1999 16.7243 8.22852 16.6104C6.18007 16.4918 4.25732 15.5847 2.86328 14.0791C1.46913 12.5733 0.712459 10.5859 0.751953 8.53418C0.791453 6.48244 1.62315 4.52528 3.07422 3.07422C4.52528 1.62315 6.48244 0.791453 8.53418 0.751953ZM8.6875 2.43262C7.02875 2.43262 5.43756 3.09173 4.26465 4.26465C3.09173 5.43756 2.43262 7.02875 2.43262 8.6875C2.43274 10.3461 3.09186 11.9366 4.26465 13.1094C5.43756 14.2823 7.02875 14.9414 8.6875 14.9414C10.3461 14.9413 11.9366 14.2822 13.1094 13.1094C14.2822 11.9366 14.9413 10.3461 14.9414 8.6875C14.9414 7.02875 14.2823 5.43756 13.1094 4.26465C11.9366 3.09186 10.3461 2.43274 8.6875 2.43262Z"
                                            fill="#FF6900" stroke="#FF6900" stroke-width="0.5" />
                                    </svg>
                ...
                <!-- Mobile Menu -->
                <div id="mobile-menu"
                    class="fixed top-0 right-0 h-full w-d290 bg-white z-[70] transform translate-x-full transition-transform duration-300 ease-out lg:hidden">
                    ...
                    ?>
                        <div class="flex-1 submenu-container mt-16">
                            ...
                            <div class="mt-auto">
                                <!-- Licenses -->
                                <div class="flex items-center bg-surface-sunken px-7 py-5">
                                    <span class="text-sm text-slate-700 border-l border-slate-110 pl-4 ml-4">مجوزها</span>
                                ...
                                <!-- Social Media Icons -->
                                <div class="flex items-center justify-between bg-slate-110 px-7.25 py-4">
                                    <a href="#" class="">
                            ...
                            <nav id="escape-room-submenu" class="py-2 hidden submenu-item">
                                <!-- Submenu Header -->
                                <div class="flex items-center bg-surface-sunken rounded-lg h-9 justify-center mx-8 gap-x-3 mt-3">
                                    <button type="button"
                                        ...
                                        <span class="text-sm text-slate-700">بازگشت به منو اصلی</span>
                                    </button>
                                </div>

                                <!-- Submenu Title -->
                                <div class="px-4 py-3">
                                    <h3 class="text-2xl font-bold text-slate-700">اتاق فرار</h3>
                                    <hr class="mt-4">
                                </div>
                            ...
                            <nav id="cooperation-submenu" class="py-2 hidden submenu-item">
                                ...
                                <!-- Submenu Title -->
                                <div class="px-4 py-3">
                                    <h3 class="text-2xl font-bold text-slate-700">همکاری با ما</h3>
                                    <hr class="mt-4">
                                </div>
                ...
                <div id="search-overlay"
                    class="fixed inset-0 bg-white z-[60] hidden top-d66 bottom-10 pb-4 lg:bottom-auto lg:absolute lg:inset-auto lg:top-full lg:left-0 lg:w-d340 lg:max-h-d700 lg:mt-2 lg:rounded-lg lg:shadow-xl lg:border lg:border-gray-100 lg:overflow-y-auto">
                    <!-- Search Header -->
                    <div
                    ...
                    <div class="flex-1 lg:flex-none overflow-y-auto px-5 py-4 lg:px-4 lg:py-3">
                        <?php
                        require_once get_template_directory() . '/inc/http/func/get-user-searches.php';
                        ...
                        ?>
                            <div id="recent-searches" class="mb-6">
                                <div class="flex items-center justify-between mb-3">
                                    <h3 class="flex items-center gap-2 text-sm font-bold text-steel">
                        ...
                        <?php
                        require_once get_template_directory() . '/inc/http/func/get-popular-searches.php';
                        ...
                        <?php if (!empty($popular_searches)) : ?>
                            <div id="popular-searches-section">
                                <div class="flex items-center gap-2 mb-3">
                                    ...
                                    <h3 class="text-sm font-bold text-steel">جستجوهای محبوب</h3>
                                </div>
                        ...
                        <div id="main-search-results"
                            class="max-h-[calc(100vh-200px)] lg:max-h-d500 overflow-y-auto max-lg:pb-15 scrollbar-hide"
                            style="display: none;">
            ...
            if (query.length > 0) {
                ...
                if (filtered.length > 0) {
                    searchResultsContainer.innerHTML = filtered.map(city => `
                        <a href="${city.slug}" class="flex items-center text-sm text-slate-800 hover:bg-slate-100 hover:text-primary-500 rounded-lg px-3 py-2 transition-colors">
                            ${city.name}
                        </a>
                    `).join("");
                } else {
