...
<section class="mt-10 grid lg:flex lg:gap-x-17 max-lg:px-4.5">
    <div class="lg:mt-3 lg:w-[57%] shrink-0">
        ...
        <p class="lg:max-w-d580 font-medium mt-4"><?= get_field('short-description', 'product_tag_ ' . $term_id); ?></p>
        <div class="lg:hidden">
        ...
        <div class="my-10 lg:flex lg:justify-between w-full max-lg:max-w-[calc(100vw-4rem)]">
            ...
            <div class="embla-cities relative w-full lg:max-w-d500 flex items-center gap-x-2.5">
            <button class="next-city-btn !w-d38 h-d38 shrink-0 cursor-pointer hover:scale-105 transition rounded-8 bg-slate-100 text-text-3">
                ...
                <div class="embla__viewport overflow-hidden">
                    <div class="embla__container flex gap-x-2.5 will-change-transform">
                        <?php foreach ($featuredCities as $city): ?>
                            <button
                                class="city-btn embla__slide flex-[0_0_77px] cursor-pointer hover:scale-105 transition w-d77 h-d38 rounded-8 bg-slate-100 shrink-0 text-text-3 <?= ($city['slug'] == 'tehran') ? '!bg-primary-500 !text-white' : '' ?>"
                ...
                <button class="prev-city-btn !w-d38 h-d38 shrink-0 cursor-pointer hover:scale-105 transition rounded-8 bg-slate-100 text-text-3">
            ...
            <div id="city-search-container" class="relative max-lg:mt-5">
                <form id="city-search-form">
                    <div class="relative">
                        <div id="city-selected" class="absolute inset-0 px-6 flex items-center justify-between bg-white rounded-lg border text-sm h-d48 lg:h-d58 w-full lg:w-d250 hidden">
                        ...
                        <input id="city-search" class="text-gray-900 block w-full border bg-white p-1.5 text-sm outline-none placeholder:text-right placeholder:text-slate-200 focus:shadow-none focus:ring-2 focus:ring-inset focus:ring-primary-500 py-2 px-3.5 pl-12 h-d38 rounded-lg placeholder:text-2xs lg:w-d250" placeholder="شهر خود را از اینجا انتخاب کن..." data-path="search" type="text" value="" name="s">
...
if ($city_genre_ids && !empty($city_genre_ids)) {
    $purchased_products_html = ez_products_snapshot_swiper_by_ids($city_genre_ids);
}
?>

<section id="games_suggests" class="max-w-full py-8 md:py-5 max-md:px-8 max-md:bg-slate-105 max-md:max-w-none max-md:-ml-4 max-md:-mr-4 <?= ($city_genre_ids && !empty($city_genre_ids)) ? '' : 'hidden' ?>">
        ...
        <div class="relative w-full max-sm:max-w-bleed-2 max-sm:w-bleed-2 max-sm:-mr-4">
            <div class="relative overflow-hidden embla_normal slider-event" data-slider-event="discount-slider">
                <div class="embla__viewport">
                    <div id="genre-games-slider" class="embla__container child:bg-white child:p-2.5 md:child:p-5 child:rounded-3xl flex gap-x-4 md:gap-x-6 child:shrink-0 child:grow-0 child:w-d176 md:child:w-d230" style="transform: translate3d(0px, 0px, 0px);">
        ...
        function createSliderForProductType(productType, cityId, cityName, counter) {
            ...
            let sliderHtml = `
                <section class="max-w-full py-4 md:py-5 lg:py-9">
                    ...
                    <div class="relative overflow-hidden embla_normal horizontal dragFree">
                        <div class="embla__viewport">
                            <div id="trends-rooms-${counter}-slider" class="embla__container first-child:before:hidden child:before:w-px child:before:absolute child:before:bg-gradient-to-t child:before:from-white child:before:via-slate-110 child:before:to-white child:before:-right-3.5 child:lg:before:-right-6 child:before:h-full min-h-d200 child:box-content lg:min-h-d300 flex child:ml-7 md:child:ml-12 last-child:ml-0 child:relative child:shrink-0 child:grow-0 child:w-d156 md:child:w-d190 child:py-2.5">
