...
const EzDropdown = class {
    ...
    render() {
        return (index.h(index.Host, { key: '50b528af74edbb7467faf9394a3181cc4f99e7c1', class: "relative inline-block text-right" }, index.h("button", { key: '496e6178757ab45098b4f5911fb85fb8b126f4cc', class: "flex items-center gap-2 px-4 py-3 bg-white border border-slate-105 rounded-xl text-sm font-yekan-bold text-navyBlue hover:bg-gray-50 transition-colors w-full justify-between", onClick: this.toggleDropdown, type: "button" }, index.h("div", { key: 'eca0a17da18fd1c4bdbb8e73770bfae1841de09b', class: "flex items-center gap-2" }, index.h("span", { key: 'cf469836cfa58b2e5aee002de6eded77d00cb8c2', innerHTML: this.icon }), index.h("span", { key: '247bf25ed6ad4bc0635a2168a98d9a0892c6ab52' }, this.selectedLabel))), index.h("div", { key: '74e7678e67888291c6cf89c37b37f7b88a5122fe', class: {
            ...
            } }, index.h("div", { key: '6951cadb02d4c5f243249f00a266965d1806b964', class: "py-2" }, index.h("slot", { key: '17b9bd5c630a3a99d7e5dda4547a3b2c223e7e2c' })))));
    }
};
