  ...
  render() {
    return (
      <Host class="relative inline-block text-right">
        <button
          class="flex items-center gap-2 px-4 py-3 bg-white border border-slate-105 rounded-xl text-sm font-yekan-bold text-navyBlue hover:bg-gray-50 transition-colors w-full justify-between"
