  ...
  render() {
    ...
    return (
      ...
      >
        ...
        <div class={`bg-white rounded-xl shadow-xl w-full ${sizeClasses[this.size]} mx-4 flex flex-col max-h-modal`}>
          <div class="flex justify-between items-center p-6 border-b border-slate-105">
          ...
          <div class="px-6 py-4 border-t border-slate-105 flex justify-end gap-3 bg-gray-50 rounded-b-xl">
            <slot name="footer" />
          </div>
        </div>
      </Host>
