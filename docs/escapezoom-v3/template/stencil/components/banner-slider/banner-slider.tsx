...
export class EzBannerSlider {
  ...
  render() {
    ...
    return (
      <div class={`relative w-full overflow-hidden embla_fade rounded-14 lg:rounded-20 ${this.sliderModel === 'wide' ? 'mt-7.5 lg:mt-10' : ''}`}>
        <div class="embla__viewport relative min-h-d350 md:min-h-d500">
          <div class="embla__container relative w-full min-h-d350 md:min-h-d500 flex">
            {this._items.map((item: any) => (
              <div class="embla__slide adv-banner relative w-full min-h-d350 md:min-h-d500 select-none shrink-0 grow-0 basis-full">
