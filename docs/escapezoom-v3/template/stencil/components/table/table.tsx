    ...
    return (
      <Host class="block w-full">
        <div class="bg-white rounded-xl border border-slate-105 overflow-hidden">
          {this.caption && (
            <div class="px-6 py-4 border-b border-slate-105 bg-frost">
          ...
          <div class="overflow-x-auto">
            <div class="w-full table min-w-full">
              {colCount > 0 && (
                <div class="table-header-group bg-frost">
                  <div class="table-row">
                    {cols.map((col: string) => (
              ...
              <div class="table-row-group bg-white">
                {this.loading ? (
                  Array.from({ length: this.skeletonCount }).map((_, rowIndex) => (
                    <div class="table-row border-b border-slate-105" key={`skeleton-${rowIndex}`}>
