      ...
      <div class="relative w-full">
        <div class="relative">
          <input
            ...
            type="text"
            class="w-full h-12 px-4 rounded-lg text-right border border-slate-105 placeholder:text-gray-400 focus:outline-none focus:ring-1 focus:ring-primary-500 bg-white"
        ...
        {this.isOpen && (
          <div class="absolute w-full mt-2 bg-white rounded-xl shadow-lg border border-gray-100 overflow-hidden z-[60]">
            {this.loading ? (
              ...
              <ul class="max-h-d300 overflow-y-auto">
