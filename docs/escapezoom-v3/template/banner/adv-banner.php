...
if ($items):
?>
    <div class="relative w-full overflow-hidden embla_fade rounded-14 lg:rounded-20 <?= ($slider_model == 'wide') ? 'mt-7.5 lg:mt-10' : '' ?>">
        <div class="embla__viewport relative min-h-d350 md:min-h-d500">
            <div class="embla__container relative w-full min-h-d350 md:min-h-d500 md:h-d440">
                <?php foreach ($items as $item): ?>
                    <div class="embla__slide adv-banner absolute w-full min-h-d350 md:min-h-d500 md:h-d440 select-none" style="opacity: 0;transition: opacity 1.5s ease;" data-title="<?= @$item['title'] ?>">
