...
<section class="py-4 md:py-5 lg:py-9 overflow-hidden">
    ...
    <div class="max-md:flex max-md:items-center max-md:justify-between max-md:gap-x-8 max-md:h-d267">
        <div class="embla_comments_main_lg relative overflow-hidden  max-md:h-d267 max-md:hidden">
            <div class="embla__viewport  max-md:h-d267 relative py-2.5 grow md:before:h-full md:before:w-24 md:before:bg-gradient-to-l md:before:from-white md:before:to-white/0 md:before:absolute md:before:z-10 md:after:h-full md:after:w-24 md:after:bg-gradient-to-l md:after:to-white md:after:from-white/0 md:after:absolute md:after:left-0 md:after:top-0 md:after:z-10 max-md:before:h-30 max-md:before:w-full max-md:before:bg-gradient-to-b max-md:before:from-white max-md:before:to-white/0 max-md:before:absolute max-md:before:top-0 max-md:before:z-10 max-md:after:h-30 max-md:after:w-full max-md:after:bg-gradient-to-b max-md:after:to-white max-md:after:from-white/0 max-md:after:absolute max-md:after:bottom-0 max-md:after:z-10">
                <div class="embla__container flex max-md:flex-col child:relative child:before:absolute max-md:gap-y-20 md:child:mx-3 child:md:pr-6 child:md:before:w-px child:md:before:absolute child:md:before:bg-gradient-to-t child:md:before:from-white child:md:before:via-slate-110 child:md:before:to-white child:md:before:right-0 child:md:before:h-full">
                    <?php foreach ($comment_items as $comment): ?>
                        <div class="embla__slide shrink-0 grow-0 md:w-d320 h-d240">
                            <div class="flex max-md:gap-x-5 md:justify-between items-start w-full">
                                ...
                                <div class="grow">
                                    <div class="space-x-8 space-x-reverse select-none">
                                        <bdo dir="rtl" class="text-text-3 text-md">
                                            <?= $comment['author'] ?>
                                        </bdo>
                            ...
                            <p class="text-text-3 text-sm font-medium-yekanbakh my-6 leading-[1.7] line-clamp-4 select-none">
                                <?= $comment['content'] ?>
                            </p>
                            <div class="flex items-center justify-between select-none">
                                <div class="text-text-3 text-sm font-medium-yekanbakh flex items-center gap-x-2">
                                ...
                                <span class="text-text-3 text-sm font-medium-yekanbakh">
        ...
        <div class="embla_comments_main_md md:hidden overflow-hidden w-full h-d267">
            <div class="embla__viewport  max-md:h-d267 relative py-2.5 grow md:before:h-full md:before:w-24 md:before:bg-gradient-to-l md:before:from-white md:before:to-white/0 md:before:absolute md:before:z-10 md:after:h-full md:after:w-24 md:after:bg-gradient-to-l md:after:to-white md:after:from-white/0 md:after:absolute md:after:left-0 md:after:top-0 md:after:z-10 max-md:before:h-12 max-md:before:w-full max-md:before:bg-gradient-to-b max-md:before:from-white max-md:before:to-white/0 max-md:before:absolute max-md:before:top-0 max-md:before:z-10 max-md:after:h-12 max-md:after:w-full max-md:after:bg-gradient-to-b max-md:after:to-white max-md:after:from-white/0 max-md:after:absolute max-md:after:bottom-0 max-md:after:z-10">
                <div class="embla_comments_main_md__container w-full flex flex-col h-d267">
                    <?php foreach ($comment_items as $comment): ?>
                        <div class="embla__slide shrink-0 grow-0 md:w-d320 h-d267 content-center">
                            <div class="flex max-md:gap-x-5 md:justify-between items-start w-full">
                                <div class="w-14 h-14 md:w-11 md:h-11 rounded-xl overflow-hidden shrink-0 md:order-1">
                                    <a href="<?= home_url() . $comment['product_url'] ?>">
                                        <img alt="بازیکن سایت اسکیپ‌زوم - <?= $comment['product_title'] ?>" loading="lazy" width="58" height="58" decoding="async" data-nimg="1" class="h-full w-full object-cover" src="<?= $comment['author_image'] ?>" style="color: transparent;">
        ...
        <div class="embla_comments_thumbs_md overflow-hidden w-11 h-d267 shrink-0 md:hidden">
            <div class="embla__viewport  max-md:h-d267 relative py-2.5 grow md:before:h-full md:before:w-24 md:before:bg-gradient-to-l md:before:from-white md:before:to-white/0 md:before:absolute md:before:z-10 md:after:h-full md:after:w-24 md:after:bg-gradient-to-l md:after:to-white md:after:from-white/0 md:after:absolute md:after:left-0 md:after:top-0 md:after:z-10 max-md:before:h-12 max-md:before:w-full max-md:before:bg-gradient-to-b max-md:before:from-white max-md:before:to-white/0 max-md:before:absolute max-md:before:top-0 max-md:before:z-10 max-md:after:h-12 max-md:after:w-full max-md:after:bg-gradient-to-b max-md:after:to-white max-md:after:from-white/0 max-md:after:absolute max-md:after:bottom-0 max-md:after:z-10">
                <div class="embla_comments_thumbs_md__container flex flex-col h-d267">
                    <?php foreach ($comment_items as $comment): ?>
                        <div class="embla-thumbs__slide shrink-0 grow-0 w-11 h-11 rounded-xl overflow-hidden fill-primary-500 bg-secondary-100 flex items-center justify-center child:mx-none">
                            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="21" viewBox="0 0 20 21" fill="colorCurrent">
