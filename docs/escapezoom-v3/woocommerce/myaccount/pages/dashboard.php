...
$collections      = $wpdb->get_results(
	$wpdb->prepare(
		'SELECT * FROM collections WHERE active = %d AND user_id = %d ORDER BY likes_count DESC LIMIT %d',
		1,
		(int) $user_id,
		3
	)
    ...
    <section class="border-edge lg:h-full lg:rounded-3xl lg:border lg:p-8">
        <div class="flex flex-col max-lg:gap-y-8 lg:flex-row lg:gap-x-6 lg:items-start">
            <div class="grid shrink-0 grid-cols-2 max-lg:gap-x-5 lg:order-1 lg:w-5/12 lg:grid-cols-1 lg:gap-y-6 items-start">
                <div class="rounded-xlh bg-primary-100 p-4 lg:flex lg:items-center lg:justify-between lg:gap-x-12 lg:px-5 lg:py-6">
                    <div class="font-bold lg:text-lg flex items-center gap-3">موجودی کیف پول</div>
                    <div class="space-x-2.5 space-x-reverse">
                        <span class="text-h4 font-bold lg:text-40">
                            <?php echo number_format($balance) ?>
                        </span>
                        <span class="text-sm font-bold lg:text-xl">تومان</span>
                    </div>
                </div>
                <div class="rounded-xlh bg-blue p-4 lg:flex lg:items-center lg:justify-between lg:gap-x-12 lg:px-5 lg:py-6">
                    <div class="font-bold lg:text-lg flex items-center gap-3">
                        اعتبار تخفیف
                    </div>
                    <div class="space-x-2.5 space-x-reverse">
                        <span class="text-h4 font-bold lg:text-40"><?php echo number_format($coupon_credit) ?></span>
                        <span class="text-sm font-bold lg:text-xl">تومان</span>
                    </div>
                </div>
            </div>
            ...
            <div class="lg:w-7/12 flex flex-col">
                <div class="mb-6 flex items-center justify-between">
                    ...
                    <a href="<?php echo get_permalink(wc_get_page_id('myaccount')); ?>orders" class="flex items-center gap-2 text-sm text-slate-350">
                        مشاهده لیست
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" width="10" viewBox="0 0 24 24" stroke="currentColor" stroke-width="{1.5}" stroke-linecap="round" stroke-linejoin="round">
                ...
                <?php if (! empty($in_progress_orders)) { ?>
                    <div class="space-y-4">
                        <?php foreach ($in_progress_orders as $order_data) { ?>
                            <div class="border-edge lg:rounded-3xl lg:border lg:p-4.5 lg:shadow-13 max-lg:border-t border-t-2 pt-4">
                                <div class="flex justify-between">
                                    <div class="flex gap-x-4">
                                        <div class="max-lg:hidden cursor-pointer" onclick="window.location.href='<?php echo $order_data['product_url']; ?>'">
                                            <?php echo wp_get_attachment_image($order_data['image'], 'full', false, [
                                                'class' => 'h-d100 w-d80 rounded-lg object-cover',
                                            ]) ?>
                                        </div>
                                        <div class="flex lg:h-full flex-col lg:justify-between max-lg:gap-y-2 lg:gap-y-5">
                                            <div class="flex gap-x-1 cursor-pointer" onclick="window.location.href='<?php echo $order_data['product_url']; ?>'">
                                                <span class="font-bold text-text-3">اتاق فرار</span>
                                            ...
                                            <div class="max-lg:flex max-lg:items-center max-lg:gap-x-6">
                                                ...
                                                <div class="text-sm font-bold text-text-3 max-lg:hidden">
                                                    تعداد بلیت
                                                </div>
                                    ...
                                    <div class="flex flex-col lg:justify-between max-lg:gap-y-1 lg:flex-row lg:gap-x-13">
                                        <div class="font-bold leading-normal text-accent-950 max-lg:mr-auto max-lg:w-fit lg:hidden max-lg:p-2.5 max-lg:text-center" style="color: <?php echo $order_data['color'] ?>">
                                        ...
                                        <div class="flex flex-col justify-between">
                                            <div class="flex">
                                                ...
                                                switch ($order_data['cancellation_status']) {
                                                    case 'pending':
                                                        ...
                                                        $button_class = 'bg-slate-100 text-blue-link h-d18 rounded px-2 text-xs font-bold flex items-center justify-center';
                                                        $modal_id = 'pending-cancel-modal-' . $order_data['order_id'];
                                                        break;
                                                    case 'approved':
                                                        $button_text = 'لغو شد ×';
                                                        $button_class = 'bg-slate-100 text-amber-ring h-d18 rounded px-2 text-xs font-bold flex items-center justify-center';
                                                    ...
                                                    default:
                                                        ...
                                                        $button_class = 'bg-slate-100 text-danger-hot h-d18 rounded px-2 text-xs font-bold flex items-center justify-center';
                                            ...
                                            <div class="max-lg:hidden">
                                                ...
                                                <div class="font-bold leading-normal text-accent-950 max-lg:mr-auto max-lg:w-fit max-lg:rounded-lg max-lg:bg-accent-50 max-lg:p-2.5 max-lg:text-center" style="color: <?php echo $order_data['color'] ?>">
                                                    <?php echo $order_data['status'] ?>
                                                </div>
                                            </div>
                                        </div>
                ...
                <?php } else { ?>
                    <div class="border-edge lg:rounded-3xl lg:border lg:p-4.5 lg:shadow-13 grow flex flex-col justify-center items-center">
        ...
        <div class="mt-10 flex flex-col max-lg:gap-y-8 lg:mt-7.5 lg:flex-row lg:gap-x-6 lg:items-start">
            <div class="max-lg:order-1 lg:w-7/12 flex flex-col">
                ...
                <div class="space-y-5 rounded-3xl border border-edge bg-gray-50 p-4 shadow-13 lg:p-6 grow">
                        ...
                        <div
                            ...
                            <div class="lg:flex lg:w-full lg:justify-between lg:gap-x-1">
                                <div>
                                    ...
                                    <div class="font-semibold text-slate-250 text-12 notification-excerpt line-clamp-1">
                ...
                <div class="max-lg:border-b max-lg:border-b-4 max-lg:border-t max-lg:border-t-4 max-lg:border-b-slate-120 max-lg:border-t-slate-120 max-lg:pb-6 max-lg:pt-6">
                    ...
                    <div class="space-y-5">
                        <?php if (count($last_invitations) > 0) { ?>
                            ...
                            <?php } ?>
                        <?php } else { ?>
                            <div class="border-edge rounded-3xl border p-4 shadow-13 h-d300 flex flex-col justify-center items-center gap-2">
                    ...
                    <div class="space-y-5">
                        <?php if (count($collection_items) > 0) { ?>
                            <?php foreach ($collection_items as $collection) { ?>
                                <div class="flex items-center justify-between rounded-3xl border border-edge p-4 shadow-13 lg:bg-slate-700">
                                        ...
                                        <?php foreach (array_slice($collection['items'], 0, 3) as $item) { ?>
                                            <div href="<?php echo $item['url']; ?>">
                                                <?php echo wp_get_attachment_image($item['image'], 'large', false, [
                                                    'class' => 'h-d40 w-d30 rounded object-cover lg:h-d50 lg:w-d40',
                                                ]) ?>
                                            </div>
                                        <?php } ?>

                                        <?php for ($i = 0; $i < 4 - count($collection['items']); $i++) { ?>
                                            <div class="h-d40 w-d30 rounded object-cover lg:h-d50 lg:w-d40"></div>
                                        <?php } ?>
                            ...
                            <?php } ?>
                        <?php } else { ?>
                            <a href="<?php echo get_permalink(wc_get_page_id('myaccount')); ?>my-collections" class="border-edge rounded-3xl border p-4 shadow-13 h-d200 flex justify-center items-center gap-2">
                                ایجاد لیست
...
<?php if (! empty($in_progress_orders)) { ?>
    <?php foreach ($in_progress_orders as $order_data) { ?>
        ...
        <div id="cancel-modal-<?php echo $order_data['order_id']; ?>" class="fixed inset-0 bg-black bg-opacity-50 hidden z-50 flex items-center justify-center">
            <div class="flex flex-col border rounded-xl w-d234 p-8 bg-white">
                ...
                <div class="flex gap-2">
                    ...
                    <p class="text-xs font-bold leading-20 text-yellow-900">
                ...
                <div class="flex justify-between mt-6">
                    <button
                        ...
                        class="bg-slate-100 px-7 rounded-lg border border-slate-130 w-d78 h-d33 text-base font-bold">
                        بله
                    </button>

                    <button
                        onclick="closeModal('cancel-modal-<?php echo $order_data['order_id']; ?>')"
                        class="bg-slate-100 rounded-lg border border-slate-130 w-d78 h-d33 text-base font-bold text-muted-blue">
                        بستن
                    </button>
                </div>
            </div>
        ...
        <div id="pending-cancel-modal-<?php echo $order_data['order_id']; ?>" class="fixed inset-0 bg-black bg-opacity-50 hidden z-50 flex items-center justify-center">
            <div class="flex flex-col border rounded-xl max-w-d234 p-6 bg-white">
                ...
                <div class="flex justify-between mt-6">
                    <button onclick="cancelCancellationRequest(<?php echo $order_data['order_id']; ?>)" class="bg-slate-100 text-slate-250 rounded-lg border border-slate-130 w-d121 h-d33 text-base font-bold">
                        بله، رزرو را نگه‌دار!
                    </button>

                    <button onclick="closeModal('pending-cancel-modal-<?php echo $order_data['order_id']; ?>')" class="bg-slate-100 rounded-lg border border-slate-130 w-d53 h-d33 text-base font-bold text-muted-blue">
                        خیر
                    </button>
                </div>
            </div>
        ...
        <div id="not-allowed-modal-<?php echo $order_data['order_id']; ?>" class="fixed inset-0 bg-black bg-opacity-50 hidden z-50 flex items-center justify-center">
            <div class="flex flex-col border rounded-xl max-w-d234 p-8 bg-white">
                <img src="<?= Theme_ASSET_URL ?>images/exclamation-mark.avif" alt="" srcset="" class="w-10 h-10 mx-auto">
                ...
                <div class="flex justify-center">
                    <button onclick="closeModal('not-allowed-modal-<?php echo $order_data['order_id']; ?>')" class="bg-slate-100 rounded-lg border border-slate-130 w-d78 h-d33 text-base font-bold text-muted-blue">
                        متوجه شدم
                    </button>
                </div>
            </div>
        ...
        <div id="approved-cancel-modal-<?php echo $order_data['order_id']; ?>" class="fixed inset-0 bg-black bg-opacity-50 hidden z-50 flex items-center justify-center">
            <div class="flex flex-col border rounded-xl max-w-d234 p-8 bg-white">
                ...
                <div class="flex justify-center">
                    <button onclick="closeModal('approved-cancel-modal-<?php echo $order_data['order_id']; ?>')" class="bg-slate-100 rounded-lg border border-slate-130 w-d78 h-d33 text-base font-bold text-muted-blue">
                        متوجه شدم
                    </button>
                </div>
            </div>
        ...
        <div id="rejected-cancel-modal-<?php echo $order_data['order_id']; ?>" class="fixed inset-0 bg-black bg-opacity-50 hidden z-50 flex items-center justify-center">
            <div class="flex flex-col border rounded-xl max-w-d234 p-8 bg-white">
                ...
                <div class="flex justify-center">
                    <button onclick="closeModal('rejected-cancel-modal-<?php echo $order_data['order_id']; ?>')" class="bg-slate-100 rounded-lg border border-slate-130 w-d78 h-d33 text-base font-bold text-muted-blue">
                        متوجه شدم
                    </button>
                </div>
            </div>
        ...
        <div id="cancelled-cancel-modal-<?php echo $order_data['order_id']; ?>" class="fixed inset-0 bg-black bg-opacity-50 hidden z-50 flex items-center justify-center">
            <div class="flex flex-col border rounded-xl max-w-d234 p-8 bg-white">
                ...
                <div class="flex justify-center">
                    <button onclick="closeModal('cancelled-cancel-modal-<?php echo $order_data['order_id']; ?>')" class="bg-slate-100 rounded-lg border border-slate-130 w-d78 h-d33 text-base font-bold text-muted-blue">
                        متوجه شدم
                    </button>
                </div>
            </div>
        ...
        <div id="expired-cancel-modal-<?php echo $order_data['order_id']; ?>" class="fixed inset-0 bg-black bg-opacity-50 hidden z-50 flex items-center justify-center">
            <div class="flex flex-col border rounded-xl max-w-d234 p-8 bg-white">
                ...
                <div class="flex justify-center">
                    <button onclick="closeModal('expired-cancel-modal-<?php echo $order_data['order_id']; ?>')" class="bg-slate-100 rounded-lg border border-slate-130 w-d78 h-d33 text-base font-bold text-muted-blue">
                        متوجه شدم
                    </button>
                </div>
            </div>
    ...
    function updateButtonStatus(orderId, status) {
        ...
        switch (status) {
            case 'pending':
                ...
                buttonClass = 'bg-slate-100 text-blue-link h-d18 rounded px-2 text-xs font-bold flex items-center justify-center';
                modalId = 'pending-cancel-modal-' + orderId;
                break;
            case 'approved':
                buttonText = 'لغو شد ×';
                buttonClass = 'bg-slate-100 text-amber-ring h-d18 rounded px-2 text-xs font-bold flex items-center justify-center';
            ...
            default:
                buttonText = 'لغو سانس ×';
                buttonClass = 'bg-slate-100 text-danger-hot h-d18 rounded px-2 text-xs font-bold flex items-center justify-center';
...
<div id="ez-credit-form-overlay" class="fixed inset-0 z-[100] flex items-center justify-center p-4 bg-black/50" style="display: none;">
	<div class="flex min-h-full w-full items-center justify-center p-4">
		<div id="ez-credit-form-modal" class="bg-white rounded-2xl shadow-xl max-w-2xl w-full max-h-modal overflow-y-auto border border-slate-200 relative">
