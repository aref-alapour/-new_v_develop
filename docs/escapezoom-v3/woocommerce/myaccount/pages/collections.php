    ...
    <section class="rounded-2xl border border-slate-120 px-8 shadow-12 max-lg:mb-0 max-lg:rounded-none max-lg:px-0 max-lg:shadow-none py-12 max-lg:border-0 max-lg:py-0">
        <div class="md:mb-8 mb-0 lg:mb-8 max-lg:border-b max-lg:border-slate-120 max-lg:pb-6">
            <div class="grid grid-cols-2 gap-4 lg:flex">
                ...
                <div class="space-x-6 grow order-3 lg:order-2 col-span-2 space-x-reverse overflow-hidden flex max-lg:h-12.5 max-lg:rounded-10 max-lg:border max-lg:border-slate-105">
                    ...
                    <button type="button" data-status="collection-2" class="grow lg:grow-0 text-text-3">
                        اتاق های خوفناک
                    </button>
                    <button type="button" data-status="collection-3" class="grow lg:grow-0 text-text-3">
                        سینما ترس
                    </button>
                </div>
                    ...
                    <div class="add-collection-modal hidden">
                        ...
                        <div class="fixed bg-white w-d430 max-w-[100%] h-auto right-[50%] translate-x-[50%] top-[50%] -translate-y-[50%] p-6 rounded-xl border z-50 flex flex-col gap-4">
                            ...
                            <div class="border rounded-xl flex overflow-hidden">
                                ...
                                <button type="button" class="category-selector grow p-2 text-text-3">
                                    اتاق های خوفناک
                                </button>
                                <button type="button" class="category-selector grow p-2 text-text-3">
                                    سینما ترس
        ...
        <div class="relative">
            <div class="lg:mb-5 lg:grid lg:grid-cols-2 lg:items-center lg:gap-x-24">
                ...
                <div class="flex items-center gap-x-4 mb-4 lg:mb-0 rounded-10 border border-edge px-6 py-3 shadow-13 relative">
                    ...
                    <div id="search-result" class="items-center gap-x-4 rounded-10 border border-edge bg-white px-6 py-3 shadow-13 absolute top-[calc(100%+10px)] right-0 w-full hidden">
                        در حال جست و جو
                    </div>
                </div>
            </div>
            <div id="collection-1" class="collection grid border-slate-120 lg:grid-cols-2 gap-7 lg:pb-8 2xl:grid-cols-3 2xl:gap-5 3xl:gap-10">
                <div class="col-span-1 border rounded-xl">
                    <div class="p-4 flex items-center gap-4">
                        <img src="../assets/images/thumbnail.png" class="w-d62 rounded-xl">
                        <div>
        ...
        <div class="flex gap-4 mt-8 justify-center">
            <a href="#" class="border-edge h-12 rounded-xl border aspect-square flex items-center justify-center shadow-13 text-lg hover:text-white hover:shadow-none hover:bg-primaryColor duration-300">
            ...
            <a href="#" class="border-edge h-12 rounded-xl aspect-square flex items-center justify-center text-lg text-white bg-primaryColor">
                3
            </a>
            <a href="#" class="border-edge h-12 rounded-xl border aspect-square flex items-center justify-center shadow-13 text-lg hover:text-white hover:shadow-none hover:bg-primaryColor duration-300">
                4
...
<script>
    jQuery(document).ready(function($) {
        ...
        $('.category-selector').on('click', function() {
            $('.category-selector').removeClass('bg-primary-500 text-white').addClass('text-text-3');
            $(this).removeClass('text-text-3').addClass('bg-primary-500 text-white');
        });
