...
<div class="lg:col-span-8 2xl:col-span-9">
    <section class="border-edge lg:h-full lg:rounded-3xl lg:border lg:p-8">
        ...
        <a href="<?= home_url('/panel/cancellation-requests/') ?>" class="flex items-center justify-center gap-2 max-lg:h-d45 max-lg:w-d45 lg:h-auto lg:w-auto text-gray-700 font-extrabold text-base cursor-pointer hover:text-gray-900 transition-colors lg:bg-transparent lg:shadow-none max-lg:bg-breserve max-lg:hover:bg-gray-200 rounded-xl max-lg:shadow-slate-lip">
                <span class="hidden lg:inline text-steel">بازگشت</span>
