    ...
    <section class="rounded-2xl border border-slate-120 px-8 shadow-12 max-lg:mb-0 max-lg:rounded-none max-lg:px-0 max-lg:shadow-none min-h-full py-10 max-lg:border-0 max-lg:py-0">
        <form class="w-full">
            <div class="flex w-full justify-between items-center">
                ...
                <button type="submit" onclick="window.history.go(-1); return false;" class="flex gap-4 items-center justify-center relative text-sm font-semibold focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 transition-all duration-300 ease-in-out disabled:bg-slate-110 disabled:text-disabled disabled:cursor-not-allowed disabled:shadow-none bg-breserve text-slate-200 shadow-13 border border-gray-50 h-12 min-w-16 px-9 py-2 rounded-xl">
            ...
            <div class="mt-4 flex justify-between gap-4 max-sm:flex-col sm:mt-8 sm:gap-8">
                ...
                <button type="submit" class="flex gap-4 items-center justify-center relative text-sm font-semibold focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 transition-all duration-300 ease-in-out disabled:bg-slate-110 disabled:text-disabled disabled:cursor-not-allowed disabled:shadow-none bg-primaryColor text-white shadow-13 shadow-primary-3 h-16 min-w-16 px-9 py-2 rounded-xl">
