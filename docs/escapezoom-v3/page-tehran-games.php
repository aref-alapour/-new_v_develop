...
?>
    <div class="max-w-2xl mx-auto mb-18 mt-d200 text-center bg-white rounded-lg shadow-lg p-10">
        <div class="mb-6">
    ...
    <div class="w-screen relative left-1/2 right-1/2 -ml-50vw -mr-50vw">
        ...
        <div class="container mx-auto">
            <?php if (!empty($ads_title) || !empty($ads_content)): ?>
                <div class="absolute top-15 lg:top-24 max-w-d600 mx-auto px-8">
                    <div>
...
<section class="w-screen relative left-1/2 right-1/2 -ml-50vw -mr-50vw overflow-hidden my-3 lg:my-6">
    <div class="container mx-auto px-4 sm:px-6 md:px-8">
        <div id="first-purchase-discount-box" class="relative bg-gradient-to-br from-promo-1 via-promo-2 to-promo-3 rounded-lg lg:rounded-2xl p-3 lg:p-5 shadow-xl overflow-hidden transform transition-all duration-500 hover:scale-[1.02]">
            ...
            <div class="relative z-10 flex flex-col lg:flex-row items-center justify-between gap-2.5 lg:gap-4">
                ...
                <div class="flex flex-row items-center gap-2.5 lg:gap-3 bg-white/20 backdrop-blur-sm rounded-lg lg:rounded-xl px-3 py-2 lg:px-6 lg:py-3.5 border border-white/30 w-full lg:w-auto justify-between lg:justify-center">
                    ...
                    <button id="copy-first-purchase-promo" type="button" class="flex items-center justify-center gap-1.5 bg-white text-promo-3 px-3 py-1.5 lg:px-4 lg:py-2 rounded-lg font-bold text-xs lg:text-base hover:bg-white/90 transition-all duration-300 hover:scale-105 active:scale-95 shadow-lg shrink-0" title="کپی کد تخفیف">
            ...
            ?>
                ...
                <section class="max-w-full py-2 md:py-3 lg:py-4 md:pb-10 lg:pb-12 relative" data-section="<?php echo $section_counter; ?>" style="<?php echo $carousel_bg_style; ?>">
                    ...
                    <div class="relative overflow-hidden embla_normal horizontal dragFree">
                        <div class="embla__viewport">
                            <div id="ads-carousel-<?php echo $section_counter; ?>-slider" class="embla__container first-child:before:hidden child:before:w-px child:before:absolute child:before:bg-gradient-to-t child:before:from-white child:before:via-slate-110 child:before:to-white child:before:-right-3.5 child:lg:before:-right-6 child:before:h-full min-h-d200 child:box-content lg:min-h-d300 flex child:ml-7 md:child:ml-12 last-child:ml-0 child:relative child:shrink-0 child:grow-0 child:w-d156 md:child:w-d190 child:py-2.5">
                                <div class="ez-loader">
                            ...
                            <button class="embla__button embla__button--prev <?php echo $section_counter; ?>-btn absolute right-0 top-1/2 -translate-y-115 rotate-180 z-50 cursor-pointer touch-manipulation appearance-none -mr-px hidden" type="button">
                            ...
                            <button class="embla__button embla__button--next <?php echo $section_counter; ?>-btn absolute left-0 top-1/2 -translate-y-115 z-50 cursor-pointer touch-manipulation appearance-none -ml-px hidden" type="button">
                                <svg xmlns="http://www.w3.org/2000/svg" width="30" fill="none" viewBox="0 0 30 113">
                                    <g clip-path="url(#arrow_aa)">
                                        <path fill="#BFCBD9" fill-rule="evenodd" d="M0 3.75c0 28.814 30 32.928 30 52.823 0 21.023-30 26.414-30 56.595V3.75Z" clip-rule="evenodd"></path>
                                        <path fill="#fff" fill-rule="evenodd" d="M0 1c0 28.814 27 33.679 27 53.573 0 21.022-27 23.914-27 54.094V1Z" clip-rule="evenodd"></path>
                ...
                <?php if (!$is_last): ?>
                    ...
                    <div class="mx-auto mb-8 md:mb-10 lg:mb-12 max-w-full px-4">
                        <div class="h-0.5 bg-gradient-to-r from-transparent via-gray-300 to-transparent rounded-full" style="box-shadow: 0 2px 8px rgba(0, 0, 0, 0.15), 0 1px 4px rgba(0, 0, 0, 0.1); border-radius: 50px;"></div>
                    </div>
                <?php endif; ?>
            <?php
                $section_counter++;
    ...
    <div class="container mx-auto px-4 sm:px-6 md:px-8">
        <a href="tel:02191307900" class="block w-full">
            <picture>
                ...
                <img class="w-full h-auto rounded-14 lg:rounded-20" src="<?php echo esc_url(Theme_ASSET_URL . 'images/call-z-sm.jpg'); ?>" alt="تماس با اسکیپ زوم" />
            </picture>
        </a>
    </div>
</section>
