...
/**
 * Generic JSON CRUD under /wp-json/escapezoom-core/v1/data/{resource}[/{id}].
 *
 * Permission: filter `ez_core_data_rest_permission` — default manage_options for all methods.
 * For mobile apps later: hook the filter or use Application Passwords with a dedicated capability.
 */
final class WpDataCrudRestController
{
    ...
    public function index(WP_REST_Request $request)
    {
        ...
        $payload = $ctrl::index($page, $perPage);
