...
<div class="lg:col-span-8 2xl:col-span-9">
    <section class="border-[#E8EDF1] lg:h-full lg:rounded-3xl lg:border lg:shadow-13 lg:p-8">
        <div class="lg:flex lg:items-center lg:justify-between">
            <h2 class="text-[22px] font-bold lg:text-lg">فروش های من</h2>
            <div class="flex items-center max-lg:my-7 max-lg:justify-between lg:gap-x-11">
                ...
                <button type="button" class="change-date text-md font-bold text-[#91A0A7]" data-id="one-week">
                    یک هفته
                </button>
                <button type="button" class="change-date text-md font-bold text-[#91A0A7]" data-id="one-month">
                    یک ماه
                </button>
                <button type="button" class="change-date text-md font-bold text-[#91A0A7]" data-id="three-month">
                    سه ماه
                </button>
            </div>
            <div class="flex items-center gap-2 max-lg:grid grid-cols-2">
                <span class="max-lg:hidden">از</span>
                <input type="text" id="start-date" class="persian-date-picker grow col-span-1 min-h-8 rounded-md border border-[#DBE2EA] bg-[#F9F9F9] px-2.5 max-lg:p-2.5 text-right text-sm shadow-13"/>
                <span class="max-lg:hidden">تا</span>
                <input type="text" id="end-date" class="persian-date-picker grow col-span-1 min-h-8 rounded-md border border-[#DBE2EA] bg-[#F9F9F9] px-2.5 max-lg:p-2.5 text-right text-sm shadow-13"/>
