    ...
    <div class="py-6 px-5 bg-bgErrorDoubleSubdued rounded-xl flex flex-col">
        <div class="flex max-lg:flex-col justify-between">
            ...
            <div class="flex max-lg:flex-col justify-between items-center lg:gap-5">
                <div class="flex justify-between gap-3 lg:gap-5 max-lg:my-5">
                    <div class="relative">
                        <div class="dropdown-toggle w-full max-lg:w-[158px] lg:w-[162px] flex justify-between items-center text-txSecondary bg-white px-5 py-3 rounded-lg shadow-1 cursor-pointer">
                        ...
                        <div class="dropdown-menu absolute top-full mt-2 hidden flex-col bg-white p-3 rounded-2xl w-full max-lg:w-[158px] lg:w-[162px] shadow-1 z-10">
                            ...
                            <div class="w-full h-[1px] bg-bgSecondary my-4"></div>
                ...
                <button id="sans_settings_instant_off_btn" data-type="normals" class="bg-[#02C96F] w-full p-2 px-[50px] rounded-lg text-white text-text-bold-s3 font-black" style="box-shadow: 0 2px 0 0 var(--Text-Success-Secondary, #02A159)">ثبت</button>
            </div>
        </div>

        <div class="w-full h-[1px] bg-bgSecondary my-8"></div>
        ...
        <div class="flex max-lg:flex-col justify-between">
            ...
            <div class="flex max-lg:flex-col justify-between items-center lg:gap-5">
                ...
                <button id="sans_settings_instant_off_btn" data-type="holidays" class="bg-[#02C96F] w-full p-2 px-[50px] rounded-lg text-white text-text-bold-s3 font-black" style="box-shadow: 0 2px 0 0 var(--Text-Success-Secondary, #02A159)">ثبت</button>
            </div>
        </div>
    </div>
</div>
...
<div class="border border-borderDefault rounded-2xl p-6 shadow-1 mt-7">
    ...
    <div class="py-6 px-5 bg-bgTertiary rounded-xl flex flex-col">
        <div class="flex max-lg:flex-col justify-between">
            ...
            <div class="flex justify-between max-lg:justify-around flex-wrap items-center lg:gap-[60px]" id="auto-disable-options">
            ...
            <button id="auto_disable_submit" class="bg-[#02C96F] py-2 px-[80px] rounded-lg text-white text-text-bold-s3 font-black max-lg:mt-7" style="box-shadow: 0 2px 0 0 var(--Text-Success-Secondary, #02A159)">ثبت</button>
