...
<div class="lg:col-span-8 2xl:col-span-9">
        ...
        <div class="m-auto flex gap-8 max-lg:flex-col max-lg:items-center max-lg:py-10" style="max-width: 786px">
            ...
            <div class="grow max-lg:w-full">
                <div class="flex flex-col gap-4">
                    <div class="payment-accordion bg-[#EDF2F5] rounded-2xl">
                        ...
                        <?php
                            ...
                            <div class="payment-accordion-content p-5 pt-0" style="display: none">
                                ...
                                <form action="#" method="post" class="flex flex-col gap-3 hidden">
                                    ...
                                    <button class="bg-[#1ED982] text-white shadow text-xl h-16 py-2 px-6 rounded-2xl">
                                        پرداخت
                                    </button>
                                </form>
                            </div>
    ...
    <div class="mb-8">
        <div class="space-x-6 max-lg:order-1 space-x-reverse max-lg:w-full lg:grow overflow-hidden max-lg:grid max-lg:h-12 max-lg:grid-cols-2 max-lg:rounded-[10px] max-lg:border max-lg:border-[#E4EBF0]">
            ...
            <button type="button" data-list="my-transactions" class="change-table text-[#889BAD]">
                تراکنش های من
            </button>
        </div>
    </div>
