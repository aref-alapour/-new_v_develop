...
<div class="lg:col-span-8 2xl:col-span-9">
    <section class="border-[#E8EDF1] lg:h-full lg:rounded-3xl lg:border lg:p-8">
        ...
        <div class="flex justify-between items-center mb-6">
            ...
            <a href="<?= home_url('/panel/cancellation-history/'); ?>" class="block text-center content-center h-10 w-28 px-[20px] text-primaryColor font-extrabold text-base bg-[#F9FAFB] hover:bg-[#d8d8d8] rounded-xl cursor-pointer"
