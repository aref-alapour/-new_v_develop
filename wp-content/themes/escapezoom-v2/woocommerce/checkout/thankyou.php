...
$vm = function_exists( 'ez_thankyou_view_model' ) ? ez_thankyou_view_model( (int) $order_id ) : null;
if ( ! $vm ) {
    echo '<style>section.woocommerce-customer-details { display: none; } .coupon-frame,h4.tac { display: none!important; }</style>';
                        ...
                        <div class="flex justify-between gap-x-4 px-6 pt-12 lg:mt-12.5 lg:w-full lg:border-t lg:border-t-[#E4EBF0]">
                            ...
                            <div class="lg:w-full">
                                <div class="lg:flex lg:items-center lg:gap-x-5">
                                    <h2 class="text-xl font-bold text-[#09192D] max-lg:mb-4"><?php echo $brand_data ? esc_html($brand_data->name) : ''; ?></h2>
