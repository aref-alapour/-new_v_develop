<?php if (! is_wc_login_page()) { ?>
    ...
    <div class="menu flex justify-between lg:hidden fixed -bottom-px w-screen right-1/2 left-1/2 -ml-[50vw] -mr-[50vw] bg-white z-50 bg-cover rounded-t-3xl px-4"
        ...
        <svg class="absolute top-[-11.5px] left-1/2 right-1/2 translate-x-1/2" width="74" height="12"
        ...
        <div class="grid grid-cols-5 gap-x-3.5 w-full pt-2">
            <a href="<?= home_url(); ?>" class=" flex flex-col items-center cursor-pointer pb-2 text-[#90A1B9]" style="<?= is_front_page() ? 'color:#f97316;' : '' ?>">
                ...
                <p class="menu-label text-sm font-bold text-[#889BAD] mt-3" style="<?= is_front_page() ? 'color:#09192D;' : ''; ?>">خانه</p>
            </a>

            <div id="game-list-toggle" class=" flex flex-col items-center cursor-pointer pb-2 text-[#90A1B9]">
                <svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" viewBox="0 0 28 28" fill="none">
                ...
                <p class="menu-label text-sm font-bold text-[#889BAD] mt-3">لیست بازی</p>
            </div>

            <a href="<?= home_url('/game-finder') . '/'; ?>" class=" flex flex-col items-center cursor-pointer pb-2 relative">
                <div class="w-13 h-13 rounded-full -mt-3 flex items-center justify-center text-[#90A1B9]"
                ...
                <p class="menu-label text-sm font-bold text-[#889BAD] -mt-0.5" style="<?= is_page('game-finder') ? 'color: #09192D;' : '' ?>">سانس یاب</p>
            </a>

            <a href="<?= home_url('/maps') . '/'; ?>" class=" flex flex-col items-center cursor-pointer pb-2 text-[#90A1B9]" style="<?= is_page('maps') ? 'color:#f97316;' : ''; ?>">
                <svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" viewBox="0 0 28 28" fill="none">
                ...
                <p class="menu-label text-sm font-bold text-[#889BAD] mt-3" style="<?= is_page('maps') ? 'color: #09192D;' : '' ?>">زوم مپ</p>
            </a>

            <a href="<?= home_url('/panel') . '/'; ?>" class=" flex flex-col items-center cursor-pointer pb-2 text-[#90A1B9]" style="<?= is_page('panel') ? 'color:#f97316;' : ''; ?>">
                ...
                <p class="menu-label text-sm font-bold text-[#889BAD] mt-3" style="<?= is_page('panel') ? 'color: #09192D;' : '' ?>">پنل کاربری</p>
            </a>
        </div>
    </div>
    <!------------------menu-listGames----------------------------->
    ...
    <div
        ...
        <a href="<?= home_url('/city/اتاق-فرار') . '/'; ?>" class="flex justify-start gap-6 bg-[#F1F5F9] rounded-2xl w-full p-4">
            <svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" viewBox="0 0 28 28" fill="none"
                class="mx-0">
                <path
        ...
        <a href="<?= home_url('/city/سینما-ترس') . '/'; ?>" class="flex justify-start gap-6 bg-[#F1F5F9] rounded-2xl w-full p-4">
            <svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" viewBox="0 0 28 28" fill="none"
                class="mx-0">
                <path
        ...
        <a href="<?= home_url('/city/لیزرتگ/') . '/'; ?>" class="flex justify-start gap-6 bg-[#F1F5F9] rounded-2xl w-full p-4">
            <svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" viewBox="0 0 28 28" fill="none"
                class="mx-0">
        ...
        <div class="relative bg-slate-200 text-white">
            <div class="container mx-auto">
                <div class="px-4 pb-1 sm:px-6 2xl:relative">
                    <div class="flex justify-between gap-20 lg:gap-[70px] lg:mr-2.5">
                        <div class="w-full">
                            ...
                            <div class="flex justify-between gap-8 pt-9 max-md:flex-wrap lg:pt-11 2xl:gap-15 lg:mr-[120px]">
                                <div class="text-justify text-2xs leading-8 md:border-l md:border-white/10 md:pl-8 2xl:pl-15 lg:max-w-[500px]">
                                            ...
                                            <div class="<?php echo esc_attr($column_class); ?>">
                                                <?php if ($column_class === 'max-lg:text-right'): ?>
                                                    <div class="mb-4 flex items-center justify-between gap-x-4">
                                                        ...
                                                        <div class="h-px w-full bg-[#C4C4C4] lg:hidden"></div>
                                                    </div>
                                                <?php else: ?>
                            ...
                            <div class="flex items-center justify-between gap-20 lg:mr-[120px]">
    ...
    window.onload = function() {
        ...
        if (!currentURL.includes("/blog/")) {
            ...
            ?>
                ...
                zebline.event.track("page_view_track", trackingData);
            <?php endif; ?>
        }
    }
</script>
