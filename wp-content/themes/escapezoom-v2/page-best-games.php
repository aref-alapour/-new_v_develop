...
<div class="w-screen relative left-1/2 right-1/2 -ml-[50vw] -mr-[50vw]">
    <div class="relative container mx-auto grid grid-cols-1 lg:grid-cols-5 gap-4 max-lg:px-8 max-lg:mt-8">
        <div class="lg:col-span-3 lg:max-w-[600px] lg:mr-10 lg:mt-16 lg:mb-10 container mx-auto">
            <?php
            ...
            ?>
            <h1 class="text-32 lg:text-52 font-black text-[#0041AC]"><?= esc_html($page_title) ?></h1>
            <div class="text-18 lg:text-22 text-[#09192D] font-medium">
                <?= $page_content ?>
            </div>
        </div>
    </div>
    <div class="lg:max-w-[750px] lg:absolute lg:left-0 lg:top-1/2 lg:-translate-y-1/2 max-lg:-mt-12.5 lg:mt-12.5 z-[-2]">
...
<!--<div class="w-screen relative left-1/2 right-1/2 -ml-[50vw] -mr-[50vw]">-->
<!--    <div class="max-lg:rounded-b-[40px] lg:rounded-b-[50px] overflow-hidden">-->
...
<!--        <div class="">-->
            ...
            //$page_content = !empty($page_content) ? $page_content : 'وقتشه یه تجربه پر از هیجان داشته باشی و از روزمرگی فاصله بگیری! بازی های منتخب تهران و کرج آماده ان تا تو رو چند ساعت از همه چی جدا کنن! اونم با تخفیف ویژه';
            ?>
<!--            <h1 class="text-32 lg:text-52 font-black text-[#FD7013] text-center w-full leading-snug"><?= esc_html($page_title) ?></h1>-->
<!--            <div class="text-18 lg:text-22 text-[#09192D] font-medium text-center w-full leading-normal mt-2.5">-->
<!--                <?= $page_content ?>-->
<!--            </div>-->
<!--        </div>-->
<!--    </div>-->
...
<div class="w-screen relative left-1/2 right-1/2 -ml-[50vw] -mr-[50vw] overflow-hidden max-lg:-mt-15">
    <?php if ($campaign_mode === 'by_city'): ?>
        <div class="w-[140px] h-[140px] lg:w-[250px] lg:h-[250px] rounded-[40px] lg:rounded-[70px] rotate-[-110deg] opacity-30 absolute left-[-70px] top-[270px] lg:top-5 lg:left-0 z-[-1]" style="background: linear-gradient(290deg, #5091FB -31.32%, rgba(80, 145, 251, 0.00) 59.62%);"></div>
    <?php endif; ?>
    <div class="relative container mx-auto lg:mt-6 mb-4 flex max-lg:flex-col max-lg:gap-y-8 items-center justify-between">
        <div id="promo-timer" class="flex items-center lg:order-1">
            <div class="w-11 h-11 lg:w-14 lg:h-14 flex items-center justify-center rounded-[10px] bg-white shadow-md text-rose-600 text-2xl lg:text-36 font-extrabold timer-second">00</div>
            <div class="text-[#9AA8B7] mx-2.5 text-xl lg:text-29">:</div>
            <div class="w-11 h-11 lg:w-14 lg:h-14 flex items-center justify-center rounded-[10px] bg-white shadow-md text-rose-600 text-2xl lg:text-36 font-extrabold timer-minute">00</div>
            <div class="text-[#9AA8B7] mx-2.5 text-xl lg:text-29">:</div>
            <div class="w-11 h-11 lg:w-14 lg:h-14 flex items-center justify-center rounded-[10px] bg-white shadow-md text-rose-600 text-2xl lg:text-36 font-extrabold timer-hour">00</div>
        </div>
        <div class="max-lg:order-1 flex max-lg:flex-col items-center gap-3">
            ...
            <div class="flex items-center gap-2 flex-wrap lg:flex-nowrap">
                <div class="text-[#5091FB] font-bold text-lg">
                    <span>کد تخفیف:</span>
                    <code id="promo-code" class="select-all"><?= esc_html($promo_code) ?></code>
                </div>
                <button id="copy-promo" type="button" class="text-[#5091FB] flex items-center" title="کپی کد">
    ...
    <?php if ($campaign_mode === 'by_city'): ?>
        <div class="container mx-auto lg:my-10 lg:flex lg:justify-between">
            ...
            <div class="grid grid-cols-4 max-lg:gap-5.5 lg:grid-cols-8 lg:gap-x-4.5 child:cursor-pointer child-hover:scale-105 child:transition child:w-[77px] child:h-[38px] child:lg:w-[109px] child:lg:h-[58px] child:rounded-[14px] child:bg-slate-100 child:text-[#889BAD] max-xl:mx-8">
                <?php
            ...
            <div id="city-search-container" class="relative max-lg:mt-5 max-xl:mx-8">
                <form id="city-search-form">
                    <div class="relative">
                        <div id="city-selected" class="absolute inset-0 px-6 hidden items-center justify-between bg-white rounded-lg border text-sm h-[48px] lg:h-[58px] w-full 2xl:min-w-69 4xl:min-w-75">
                        ...
                        <input id="city-search" class="text-gray-900 block w-full border bg-white p-1.5 text-sm outline-none placeholder:text-right placeholder:text-slate-200 focus:shadow-none focus:ring-2 focus:ring-inset focus:ring-primary-500 py-2 px-6 pl-12 h-[48px] lg:h-[58px] rounded-lg placeholder:text-2xs 2xl:min-w-69 4xl:min-w-75" placeholder="شهر خود را از اینجا انتخاب کن..." type="text" value="" name="s">
                ...
                for (const [citySlug, cityInfo] of Object.entries(promotionalDataByCity)) {
                    ...
                    for (const [typeSlug, productIds] of Object.entries(types)) {
                        if (productIds && productIds.length > 0) {
                            ...
                            const decorClass = isOdd ? 'absolute top-[100px] right-[-300px] w-[330px] h-[330px] opacity-30 z-0 rounded-[70px] rotate-[-40deg] max-md:hidden' : 'absolute bottom-0 left-[-300px] w-[250px] h-[250px] opacity-30 z-0 rounded-full max-md:hidden';
                                ...
                                <section class="max-w-full py-4 md:py-5 lg:py-9 relative" data-section="${sectionCounter}">
                                    ...
                                    <div class="relative overflow-hidden embla_normal horizontal dragFree">
                                        <div class="embla__viewport">
                                            <div id="promo-section-${sectionCounter}-slider" class="embla__container first:child:before:hidden child:before:w-px child:before:absolute child:before:bg-gradient-to-t child:before:from-white child:before:via-slate-110 child:before:to-white child:before:-right-3.5 child:lg:before:-right-6 child:before:h-full min-h-[200px] child:box-content lg:min-h-[300px] flex child:ml-7 md:child:ml-12 last:child:ml-0 child:relative child:shrink-0 child:grow-0 child:w-[156px] md:child:w-[190px] child:py-2.5">
                                                <div class="ez-loader">
                                                    <span class="ez-dot ez-dot-1"></span>
                                                    <span class="ez-dot ez-dot-2"></span>
                                                    <span class="ez-dot ez-dot-3"></span>
