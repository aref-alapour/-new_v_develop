                ...
                <ul data-orientation="horizontal" class="group flex flex-1 list-none items-center justify-center gap-3" dir="rtl">
                    <li class="<?php echo $has_children ? 'group' : ''; ?>">
                        <?php if ($has_children): ?>
                            ...
                            <!-- Dropdown Menu -->
                            <div class="hidden right-0 group-hover:grid grid-cols-3 min-w-[900px] items-center justify-between bg-[url('../images/menu-1.png')] bg-white bg-cover bg-left-bottom bg-no-repeat absolute shadow-13 shadow rounded-xl">
