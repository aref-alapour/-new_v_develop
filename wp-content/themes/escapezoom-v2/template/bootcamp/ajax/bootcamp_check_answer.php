...
function get_puzzle_2_html() {
    ...
    return '
    <div id="puzzle-2" class="puzzle-section mt-8 max-lg:mb-[30px]">
        <div class="flex flex-col lg:justify-center relative w-full h-full rounded-4xl bg-[#F1F5F9] mt-[82px] pt-8 pb-11 px-5">
            <div class="absolute right-7 top-[-30px]">
            ...
            <div class="flex justify-center items-center gap-5 mt-7">
                <div class="lg:hidden max-lg:flex flex-col justify-between items-center h-[235px]">
                    <p class="text-2xl font-bold h-12 flex items-center text-[#F21543]">1</p>
                    <p class="text-2xl font-bold h-12 flex items-center text-[#F21543]">2</p>
                    <p class="text-2xl font-bold h-12 flex items-center text-[#F21543]">3</p>
                    <p class="text-2xl font-bold h-12 flex items-center text-[#F21543]">4</p>
                </div>
                ...
                <div class="grid grid-cols-4 gap-px text-white child:text-center child:flex child:items-center child:justify-center child:text-2xl child:font-bold">
                    <div class="w-16 h-16 bg-[#F21543] rounded-tr-3xl">ر</div>
                    <div class="w-16 h-16 bg-[#F21543]">ق</div>
                    <div class="w-16 h-16 bg-[#F21543]">ک</div>
                    <div class="w-16 h-16 bg-[#F21543] rounded-tl-3xl">ف</div>
                    <div class="w-16 h-16 bg-[#F21543]">ش</div>
                    <div class="w-16 h-16 bg-[#F21543]">ف</div>
                    <div class="w-16 h-16 bg-[#F21543]">ر</div>
                    <div class="w-16 h-16 bg-[#F21543]">ق</div>
                    <div class="w-16 h-16 bg-[#F21543]">ک</div>
                    <div class="w-16 h-16 bg-[#F21543]">گ</div>
                    <div class="w-16 h-16 bg-[#F21543]">ل</div>
                    <div class="w-16 h-16 bg-[#F21543]">و</div>
                    <div class="w-16 h-16 bg-[#F21543] rounded-br-3xl">ل</div>
                    <div class="w-16 h-16 bg-[#F21543]">ز</div>
                    <div class="w-16 h-16 bg-[#F21543]">ش</div>
                    <div class="w-16 h-16 bg-[#F21543] rounded-bl-3xl">ک</div>
                </div>

                <div class="flex flex-col max-lg:hidden">
                    <p class="text-lg font-medium text-[#62748E]">حروفی که در ردیف‌های دیگر صحیح نبودند، در این ردیف هم صحیح نیستند.</p>
                    <hr class="border-t border-[#CAD5E2] my-4" />
                    <p class="text-lg font-medium text-[#62748E]">حرفی که با بقیه متفاوت است، حرف صحیح است.</p>
                    <hr class="border-t border-[#CAD5E2] my-4" />
                    <p class="text-lg font-medium text-[#62748E]">حروفی که ترتیب را رعایت کرده‌اند، حروف صحیحی نیستند.</p>
                    <hr class="border-t border-[#CAD5E2] my-4" />
                    <p class="text-lg font-medium text-[#62748E]">تنها حرف خط نخورده در جدول، حرف صحیح است.</p>
                </div>
            </div>

            <div class="lg:hidden max-lg:flex flex-col items-start mx-auto gap-5 mt-8">
                <div class="flex items-center gap-6">
                    <div class="rounded-full shrink-0 bg-[#62748E] text-center text-white text-base font-bold w-[18px] h-[18px] flex items-center justify-center">1</div>
                    <p class="text-sm font-bold text-[#62748E]">حروفی که در ردیف‌های دیگر صحیح نبودند، در این ردیف هم صحیح نیستند.</p>
                </div>
                <div class="flex items-center gap-6">
                    <div class="rounded-full shrink-0 bg-[#62748E] text-center text-white text-base font-bold w-[18px] h-[18px] flex items-center justify-center">2</div>
                    <p class="text-sm font-bold text-[#62748E]">کلمه‌ای که با بقیه متفاوت است، کلمۀ صحیح است.</p>
                </div>
                <div class="flex items-center gap-6">
                    <div class="rounded-full shrink-0 bg-[#62748E] text-center text-white text-base font-bold w-[18px] h-[18px] flex items-center justify-center">3</div>
                    <p class="text-sm font-bold text-[#62748E]">حروفی که ترتیب را رعایت کرده‌اند، حروف صحیحی نیستند.</p>
                </div>
                <div class="flex items-center gap-6">
                    <div class="rounded-full shrink-0 bg-[#62748E] text-center text-white text-base font-bold w-[18px] h-[18px] flex items-center justify-center">4</div>
                    <p class="text-sm font-bold text-[#62748E]">تنها حرف منحصربه‌فرد در جدول، کلمۀ صحیح است.</p>
                </div>
            </div>

            <div class="flex lg:justify-center max-lg:flex-col items-center lg:gap-6 lg:mt-[58px]">
                <p class="text-[#62748E] text-center max-lg:mt-[78px] text-base font-bold max-lg:mb-3">کلمه ای که پیدا کردی رو وارد کن.</p>
                ...
                <div class="flex items-center justify-center gap-4 lg:mt-3">
                    <div class="flex justify-center items-center z-1" id="puzzle-2-inputs">
                        <input type="text" maxlength="1" class="puzzle-2-input w-[38px] lg:w-12 h-[38px] lg:h-12 border border-[#CAD5E2] outline-none pr-4 text-lg rounded-tr-lg rounded-br-lg" data-index="0" />
                        <input type="text" maxlength="1" class="puzzle-2-input w-[38px] lg:w-12 h-[38px] lg:h-12 border border-[#CAD5E2] outline-none pr-4 text-lg" data-index="1" />
                        <input type="text" maxlength="1" class="puzzle-2-input w-[38px] lg:w-12 h-[38px] lg:h-12 border border-[#CAD5E2] outline-none pr-4 text-lg" data-index="2" />
                        <input type="text" maxlength="1" class="puzzle-2-input w-[38px] lg:w-12 h-[38px] lg:h-12 border border-[#CAD5E2] outline-none pr-4 text-lg rounded-bl-lg rounded-tl-lg" data-index="3" />
                    </div>

                    <button id="submit-puzzle-2" class="cursor-pointer z-1 w-[38px] h-[38px] lg:w-12 lg:h-12 rounded-lg bg-[#2B7FFF] flex items-center justify-center transition-all hover:bg-[#2563EB] disabled:opacity-50 disabled:cursor-not-allowed relative">
...
function get_puzzle_3_html() {
    ...
    return '
    <div id="puzzle-3" class="puzzle-section mt-8 max-lg:mb-[30px]">
        <div class="flex flex-col justify-center relative w-full h-full max-lg:h-[344px] rounded-4xl bg-[#F1F5F9] mt-[82px] px-5 py-8">
            <div class="absolute right-4 lg:right-7 top-[-30px]">
                <p class="text-[70px] font-black leading-[70px] text-transparent bg-clip-text bg-gradient-to-b from-[#FD7013] to-[#FD7013]/10">3</p>
            </div>
            ...
            <p class="text-[#62748E] text-center mt-2 mb-3">کلمه ای که پیدا کردی رو وارد کن.</p>

            <!-- Single input for both desktop and mobile -->
            <div class="flex justify-center items-center w-full z-1 gap-4">
                <input type="text" id="puzzle-3-input" class="puzzle-3-input w-full max-w-[200px] lg:max-w-[300px] h-12 border border-[#CAD5E2] outline-none pr-4 text-lg rounded-lg" placeholder="کلمه را وارد کنید" />

                <button id="submit-puzzle-3" class="cursor-pointer z-1 w-12 h-12 bg-[#2B7FFF] rounded-lg flex items-center justify-center transition-all hover:bg-[#2563EB] disabled:opacity-50 disabled:cursor-not-allowed relative">
...
function get_puzzle_3_success_html() {
    return '
    <div id="puzzle-3-success" class="my-8 relative max-lg:mb-[30px]">
        <div class="text-center relative py-16">
            <div id="success-shapes-container" class="absolute inset-0 pointer-events-none"></div>
            <h2 id="success-text" class="text-4xl lg:text-6xl font-black text-[#FD7013] relative z-10 inline-block" style="opacity: 0; transform: scale(0.8);">رزرو، بازی، خاطره سازی</h2>
        </div>
    </div>
    ';
}
...
function get_puzzle_4_html() {
    return '
    <div id="puzzle-4" class="puzzle-section mt-8 max-lg:mb-[30px] w-full max-w-full">
        <div class="flex flex-col justify-center relative w-full h-full rounded-4xl bg-[#F1F5F9] mt-[82px] px-5 py-8">
            <div class="absolute right-4 lg:right-7 top-[-30px]">
                <p class="text-[70px] font-black leading-[70px] text-transparent bg-clip-text bg-gradient-to-b from-[#FD7013] to-[#FD7013]/10">4</p>
            </div>
            ...
            <div class="flex flex-col lg:flex-row justify-center items-center gap-8 lg:gap-12 mb-6 w-full max-w-full" id="puzzle-4-envelopes">
                ...
                <div class="envelope-container" data-envelope="1">
                    <div class="envelope-wrapper">
                        ...
                        <div class="envelope-content relative">
                            <div class="absolute top-[115px] w-full flex items-center justify-center max-w-[200px]">
                                <input type="text" id="puzzle-4-input-1" class="envelope-input w-full h-11 border-2 border-[#2B7FFF] outline-none px-2 text-center text-base rounded-lg bg-white/95 shadow-md focus:border-[#1E40AF] focus:ring-2 focus:ring-[#2B7FFF]/20 transition-all" placeholder="کلمه اول" />
                            </div>
                        </div>
                        ...
                        <div class="envelope-card">
                            <div class="text-center h-full flex flex-col justify-center">
                                <div class="mb-3">
                                    <div class="w-16 h-16 mx-auto mb-3 bg-gradient-to-br from-[#FD7013]/10 to-[#FD7013]/5 rounded-full flex items-center justify-center border-2 border-[#FD7013]/20">
                                        <svg class="w-8 h-8 text-[#FD7013]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                ...
                                <p class="text-2xl font-black text-[#FD7013] drop-shadow-sm">آتن</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="envelope-container" data-envelope="2">
                    <div class="envelope-wrapper">
                        ...
                        <div class="envelope-content relative">
                            <div class="absolute top-[115px] w-full flex items-center justify-center max-w-[200px]">
                                <input type="text" id="puzzle-4-input-2" class="envelope-input w-full h-11 border-2 border-[#2B7FFF] outline-none px-2 text-center text-base rounded-lg bg-white/95 shadow-md focus:border-[#1E40AF] focus:ring-2 focus:ring-[#2B7FFF]/20 transition-all" placeholder="کلمه دوم" />
                            </div>
                        </div>
                        ...
                        <div class="envelope-card">
                            <div class="text-center h-full flex flex-col justify-center">
                                ...
                                <p class="text-2xl font-black text-[#FD7013] drop-shadow-sm">دوومیدانی</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="envelope-container" data-envelope="3">
                    <div class="envelope-wrapper">
                        ...
                        <div class="envelope-content relative">
                            <div class="absolute top-[115px] w-full flex items-center justify-center max-w-[200px]">
                                <input type="text" id="puzzle-4-input-3" class="envelope-input w-full h-11 border-2 border-[#2B7FFF] outline-none px-2 text-center text-base rounded-lg bg-white/95 shadow-md focus:border-[#1E40AF] focus:ring-2 focus:ring-[#2B7FFF]/20 transition-all" placeholder="کلمه سوم" />
                            </div>
                        </div>
                        ...
                        <div class="envelope-card">
                            <div class="text-center h-full flex flex-col justify-center">
                                ...
                                <p class="text-2xl font-black text-[#FD7013] drop-shadow-sm">حلقه</p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="flex justify-center mb-8">
                <button id="submit-puzzle-4-all" class="bg-[#2B7FFF] text-white rounded-lg font-bold text-lg flex items-center justify-center hover:bg-[#2563EB] disabled:opacity-50 disabled:cursor-not-allowed transition-all relative w-10 h-10">
            ...
            <div id="puzzle-4-typing-text" class="text-center text-base lg:text-xl font-bold text-[#62748E] hidden">
            ...
            <div id="puzzle-4-final-input-container" class="flex flex-col items-center gap-4" style="display: none;">
                <p id="puzzle-4-final-text" class="text-center text-base lg:text-xl font-bold text-[#62748E] mb-2 min-h-[60px]">
                </p>
                <div class="flex items-center gap-4">
                    <input type="text" id="puzzle-4-final-input" class="w-full max-w-[200px] lg:max-w-[300px] h-12 border border-[#CAD5E2] outline-none pr-4 text-lg rounded-lg" placeholder="نام را وارد کنید" />
                    <button id="submit-puzzle-4-final" class="cursor-pointer z-1 w-12 h-12 bg-[#2B7FFF] rounded-lg flex items-center justify-center transition-all hover:bg-[#2563EB] disabled:opacity-50 disabled:cursor-not-allowed relative">
            ...
            <div id="puzzle-4-form-container" class="hidden mt-8">
                <div class="flex flex-col justify-center relative w-full h-full rounded-4xl bg-[#F1F5F9] px-5 py-8">
                    <div class="flex flex-col">
                        <div class="grid grid-cols-1 lg:grid-cols-3 gap-4 items-center mt-2">
                            <div class="flex items-center gap-2">
                                ...
                                <input id="bootcamp-name" placeholder="نام و نام خانوادگی" type="text" class="border border-[#CAD5E2] rounded-lg p-2 flex-1 min-w-0" pattern="[\u0600-\u06FF\s]+" />
                            </div>

                            <div class="flex items-center max-lg:gap-9 gap-2">
                                <p class="text-sm font-bold text-gray-700 whitespace-nowrap">شماره تماس: </p>
                                <input id="bootcamp-phone" placeholder="09120000000" type="tel" pattern="^(09\d{9}|(\+98)?9\d{9})$" inputmode="numeric" onkeypress="return event.charCode >= 48 && event.charCode <= 57" maxlength="11" class="border border-[#CAD5E2] rounded-lg p-2 flex-1 min-w-0" dir="ltr" />
                            </div>

                            <div class="flex items-center max-lg:gap-3 gap-2">
                                <p class="text-sm font-bold text-gray-700 whitespace-nowrap">شماره دانشجویی: </p>
                                <input id="bootcamp-student-id" placeholder="" type="text" inputmode="numeric" onkeypress="return event.charCode >= 48 && event.charCode <= 57" class="border border-[#CAD5E2] rounded-lg p-2 flex-1 min-w-0" />
                            </div>
                        </div>

                        <button id="submit-bootcamp-form" class="lg:w-[100px] h-10 lg:mx-auto w-full cursor-pointer bg-[#2B7FFF] text-white rounded-lg p-2 mt-4 flex items-center justify-center relative">
