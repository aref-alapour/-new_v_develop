...
if (!is_null($products->products) and !empty($products->products) and (strlen($products->products) > 0)): ?>
    ...
    <section id="trends-rooms-slider" class="grid grid-cols-2 child:box-content child:relative child:shrink-0 child:grow-0 child:w-[156px] md:child:w-[190px] child:py-2.5 justify-between max-lg:gap-5.5 sm:grid-cols-3 lg:grid-cols-5 2xl:grid-cols-6 3xl:grid-cols-7 gap-6 mt-8">
        <?= $products->products ?>
    </section>
<?php else: ?>
