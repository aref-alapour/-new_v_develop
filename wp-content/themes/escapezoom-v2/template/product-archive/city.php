...
<section class="space-y-5 lg:space-y-8">
    ...
    if (get_field('icon', $city_id) || get_field('short-description', $city_id)) { ?>
        <div class="bg-slate-100/50 w-full flex items-center justify-between py-2.5 px-4 lg:px-12.5 rounded-[14px] lg:rounded-[20px]">
            <div class="lg:flex lg:items-center lg:gap-x-5">
                <h1 class="text-[21px] lg:text-[27px] text-textColor lg:pl-5 lg:border-l font-black"><?= $city_name ?></h1>
                <p class="text-[11px] lg:text-[13px] lg:leading-6 max-lg:hidden"><?= get_field('short-description', $city_id); ?></p>
            </div>
    ...
    if ($sliderItems): ?>
        <div class="relative embla_fade w-full rounded-[14px] lg:rounded-[20px] overflow-hidden">
...
if (isset($city_type_cats_id['escaperoom'])):
    ...
    $city_rooms = json_decode(ez_webservice(array('type' => 'sort_products_get', 'data' => $args)));
...
?>
        <section class="max-w-full py-4 md:py-5 lg:py-9 md:mt-7.5">
                ...
                <div class="flex justify-between">
                    ...
                    <div class="flex items-center gap-6">
                        <a href="<?= esc_url($term_link) ?>">
                            <div class="flex items-center gap-1.5 text-[10px] lg:gap-3.5 lg:text-[12px] hover:text-primary-500 transition">مشاهده همه <svg xmlns="http://www.w3.org/2000/svg" fill="none" width="20" viewBox="0 0 24 24" class="max-lg:hidden">
            ...
            <div class="relative overflow-hidden embla_normal">
                <div class="embla__viewport">
                    <div id="city-rooms-slider" class="embla__container first:child:before:hidden child:before:w-px child:before:absolute child:before:bg-gradient-to-t child:before:from-white child:before:via-slate-110 child:before:to-white child:before:-right-3.5 child:lg:before:-right-6 child:before:h-full min-h-[200px] child:box-content lg:min-h-[300px] flex child:ml-7 md:child:ml-12  last:child:ml-0 child:relative child:shrink-0 child:grow-0 child:w-[156px] md:child:w-[190px] child:py-2.5">
                        <?= $city_rooms ?>
                    </div>
                </div>
                <button class="embla__button embla__button--prev city-rooms-btn absolute right-0 top-1/2 translate-y-[-115px] rotate-180 z-50 cursor-pointer touch-manipulation appearance-none -mr-px hidden" type="button">
                ...
                <button class="embla__button embla__button--next city-rooms-btn absolute left-0 top-1/2 translate-y-[-115px] z-50 cursor-pointer touch-manipulation appearance-none -ml-px hidden" type="button">
                    <svg xmlns="http://www.w3.org/2000/svg" width="30" fill="none" viewBox="0 0 30 113">
                        <g clip-path="url(#arrow_aa)">
                            <path fill="#BFCBD9" fill-rule="evenodd" d="M0 3.75c0 28.814 30 32.928 30 52.823 0 21.023-30 26.414-30 56.595V3.75Z" clip-rule="evenodd"></path>
                            <path fill="#fff" fill-rule="evenodd" d="M0 1c0 28.814 27 33.679 27 53.573 0 21.022-27 23.914-27 54.094V1Z" clip-rule="evenodd"></path>
...
if (isset($city_type_cats_id['cinema'])):
    ...
    $city_cinema = json_decode(ez_webservice(array('type' => 'sort_products_get', 'data' => $args)));
...
foreach ($city_type_cats_id as $cat_type => $city_type_cat_id) :
    ...
    $games = json_decode(ez_webservice(array('type' => 'sort_products_get', 'data' => $args)));
...
?>
    <section class="max-w-full py-4 md:py-5 lg:py-9 md:mt-7.5">
        ...
        <div class="relative overflow-hidden embla_normal">
            <div class="embla__viewport">
                <div id="city-<?= $cat_type ?>-slider" class="embla__container first:child:before:hidden child:before:w-px child:before:absolute child:before:bg-gradient-to-t child:before:from-white child:before:via-slate-110 child:before:to-white child:before:-right-3.5 child:lg:before:-right-6 child:before:h-full min-h-[200px] child:box-content lg:min-h-[300px] flex child:ml-7 md:child:ml-12  last:child:ml-0 child:shrink-0 child:grow-0 child:w-[156px] md:child:w-[190px] child:py-2.5 child:relative">
                    <?= $games->products ?>
                </div>
            </div>
            <button class="embla__button embla__button--prev city-<?= $cat_type ?>-btn absolute right-0 top-1/2 translate-y-[-115px] rotate-180 z-50 cursor-pointer touch-manipulation appearance-none -mr-px hidden" type="button">
                <svg xmlns="http://www.w3.org/2000/svg" width="30" fill="none" viewBox="0 0 30 113">
                    <g clip-path="url(#arrow_aa)">
                        <path fill="#BFCBD9" fill-rule="evenodd" d="M0 3.75c0 28.814 30 32.928 30 52.823 0 21.023-30 26.414-30 56.595V3.75Z" clip-rule="evenodd"></path>
                        <path fill="#fff" fill-rule="evenodd" d="M0 1c0 28.814 27 33.679 27 53.573 0 21.022-27 23.914-27 54.094V1Z" clip-rule="evenodd"></path>
            ...
            <button class="embla__button embla__button--next city-<?= $cat_type ?>-btn absolute left-0 top-1/2 translate-y-[-115px] z-50 cursor-pointer touch-manipulation appearance-none -ml-px hidden" type="button">
                <svg xmlns="http://www.w3.org/2000/svg" width="30" fill="none" viewBox="0 0 30 113">
                    <g clip-path="url(#arrow_aa)">
                        <path fill="#BFCBD9" fill-rule="evenodd" d="M0 3.75c0 28.814 30 32.928 30 52.823 0 21.023-30 26.414-30 56.595V3.75Z" clip-rule="evenodd"></path>
                        <path fill="#fff" fill-rule="evenodd" d="M0 1c0 28.814 27 33.679 27 53.573 0 21.022-27 23.914-27 54.094V1Z" clip-rule="evenodd"></path>
