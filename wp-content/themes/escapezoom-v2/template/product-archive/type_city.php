...
if ($product_type != 'سینما ترس') : ?>
        ...
        <nav class="flex" aria-label="Breadcrumb">
            <ol class="inline-flex items-center gap-2">
                <li class="inline-flex items-center">
                    <a class="inline-flex items-center gap-1.5 font-medium text-[9px] text-slate-400 hover:text-primary-600 transition-colors duration-200" href="<?= home_url() ?>">
                ...
                <li class="inline-flex items-center gap-2">
                    ...
                    <a class="font-medium text-[9px] text-slate-400 hover:text-primary-600 transition-colors duration-200" href="<?= get_term_link($current_archive_obj->parent, "product_cat") ?>">
                        <?= $product_type ?>
                    </a>
                </li>
                <li class="inline-flex items-center gap-2">
                    ...
                    <span class="font-medium text-[9px] text-slate-600">
                        <?= $city_name ?>
                    </span>
                </li>
            </ol>
    ...
    <section class="space-y-5 lg:space-y-8">
        ...
        if (get_field('icon', "product_cat_$category") || get_field('short-description', "product_cat_$category")) { ?>
            <div class="bg-slate-100/50 w-full flex items-center justify-between py-2.5 px-4 lg:px-12.5 rounded-[14px] lg:rounded-[20px]">
                <div class="lg:flex lg:items-center lg:gap-x-5">
                    <h1 class="text-[21px] lg:text-[27px] text-textColor lg:pl-5 lg:border-l"><?= $product_type ?> <span class="font-black"><?= $city_name ?></span></h1>
                    <p class="text-[11px] lg:text-[13px] lg:leading-6 max-lg:hidden"><?= get_field('short-description', "product_cat_$category"); ?></p>
                </div>
        ...
        if ($sliderItems): ?>
            <div class="relative embla_fade w-full rounded-[14px] lg:rounded-[20px] overflow-hidden <?= ($slider_model == 'wide') ? 'mt-7.5 lg:mt-10' : '' ?>">
                            ...
                            <div class="embla__slide flex-[0_0_100%]" data-title="<?= @$item['title'] ?>">
                                <a class="block w-full" href="<?= $item_url ?>">
                                    <picture>
                                        ...
                                        <img class="w-full h-auto rounded-[14px] lg:rounded-[20px]" src="<?= $item['mobile-image']['url']; ?>" alt="<?= @$item['title'] ?>" />
                                    </picture>
                                </a>
                            </div>
                        <?php endforeach; ?>
...
$ads_products = json_decode(ez_webservice(array('type' => 'sort_products_get', 'data' => $args)));
...
if (!is_null($ads_products->products) and !empty($ads_products->products) and (strlen($ads_products->products) > 0)):
    if ($product_type == 'سینما ترس') {
        ...
        <style>
            ...
            .horror-products-list-wrapper article .text-\[#62748E\] {
                color: #d1d5db !important;
            }

            .horror-products-list-wrapper article .text-\[#565656\] {
                color: #e5e7eb !important;
            }

            .horror-products-list-wrapper article .text-\[#90A1B9\] {
                color: #d1d5db !important;
            }

            /* Keep original colors for price section with bg-[#ECECEE] - Override all white text styles */
            .horror-products-list-wrapper article .bg-\[#ECECEE\] {
            ...
            /* Specific styles for text-[#62748E] inside bg-[#ECECEE] */
            .horror-products-list-wrapper article .bg-\[#ECECEE\] .text-\[#62748E\] {
                color: #62748E !important;
            }

            /* Price inside bg-[#ECECEE] */
            .horror-products-list-wrapper article span[name="price"] {
                color: #1f2937 !important;
                font-weight: bold !important;
            }

            .horror-products-list-wrapper article span.text-\[\#62748E\] {
                color: #62748E !important;
            }

            /* All divs inside bg-[#ECECEE] */
            .horror-products-list-wrapper article .bg-\[#ECECEE\] div {
                color: #1f2937 !important;
            }

            /* All spans inside divs inside bg-[#ECECEE] - override white text */
            .horror-products-list-wrapper article .bg-\[#ECECEE\] div span {
                color: inherit !important;
            }

            /* text-[#62748E] inside divs inside bg-[#ECECEE] */
            .horror-products-list-wrapper article .bg-\[#ECECEE\] div .text-\[#62748E\] {
                color: #62748E !important;
            }

            /* Price inside divs inside bg-[#ECECEE] */
            .horror-products-list-wrapper article .bg-\[#ECECEE\] div [name="price"] {
                color: #1f2937 !important;
                font-weight: bold !important;
            }

            /* Override all white/light text styles that might affect bg-[#ECECEE] section */
            .horror-products-list-wrapper article .bg-\[#ECECEE\] p {
                color: #1f2937 !important;
            }

            .horror-products-list-wrapper article .bg-\[#ECECEE\] span:not([name="rate"]) {
                color: inherit !important;
            }
            ...
            .horror-products-list-wrapper article .bg-\[#ECECEE\] div div {
                color: #1f2937 !important;
            }

            .horror-products-list-wrapper article .bg-\[#ECECEE\] div div span {
                color: inherit !important;
            }

            .horror-products-list-wrapper article .bg-\[#ECECEE\] div div .text-\[#62748E\] {
                color: #62748E !important;
            }

            .horror-products-list-wrapper article .bg-\[#ECECEE\] div div [name="price"] {
                color: #1f2937 !important;
                font-weight: bold !important;
            }
...
<?php 
        ...
        <?php if ($is_tehran_escaperoom): 
            // فقط برای تهران + اتاق فرار، Three.js رو لود کن
            ...
            <div class="relative z-10 px-4">
                ...
                <div class="mb-6 md:mb-8 lg:mb-6 lg:pt-4">
                    <div class="flex flex-col lg:flex-row justify-between lg:items-center gap-4">
                        ...
                        <div class="flex items-center gap-3 lg:gap-4">
                            <svg class="scary-icon flex-shrink-0 mx-0" width="38" height="28" viewBox="0 0 38 28" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <div class="rounded-tl-none rounded-tr-none lg:px-0 pb-6">
                    <div class="relative overflow-hidden embla_normal slider-event" data-slider-event="off-slider">
                        <div class="embla__viewport">
                            <div id="discount-events-slider2" class="embla__container child:bg-white child:p-2.5 md:child:p-5 child:rounded-3xl flex gap-x-4 md:gap-x-6 child:shrink-0 child:grow-0 child:w-[176px] md:child:w-[230px]"> <?= $ads_products->products ?> </div>
                        </div>
        ...
        <script>
        (function() {
            // تابع اصلی برای راه‌اندازی particles
            function initScaryParticles() {
                // بررسی وجود Three.js
            ...
            const scaleVelocities = new Float32Array(particlesCount);
            const opacityVelocities = new Float32Array(particlesCount);
            ...
            for(let i = 0; i < particlesCount; i++) {
                ...
                // سایز بین 10 تا 30 پیکسل
                sizes[i] = Math.random() * 20 + 10;
                
                // opacity بین 0.1 تا 0.5
                opacities[i] = Math.random() * 0.4 + 0.1;
                opacityVelocities[i] = (Math.random() - 0.5) * 0.003;
                
                // scale بین 0.5 تا 1.5
                scales[i] = Math.random() + 0.5;
                scaleVelocities[i] = (Math.random() - 0.5) * 0.005;
            }
            
            particlesGeometry.setAttribute('position', new THREE.BufferAttribute(positions, 3));
            particlesGeometry.setAttribute('size', new THREE.BufferAttribute(sizes, 1));
            
            // ساخت texture با blur برای گرد و محو کردن
            const canvas2d = document.createElement('canvas');
            canvas2d.width = 64;
            canvas2d.height = 64;
            const ctx = canvas2d.getContext('2d');
            
            // گرادیانت شعاعی برای blur effect
            const gradient = ctx.createRadialGradient(32, 32, 0, 32, 32, 32);
            gradient.addColorStop(0, 'rgba(251, 146, 60, 1)');
            gradient.addColorStop(0.3, 'rgba(251, 146, 60, 0.8)');
            gradient.addColorStop(0.6, 'rgba(251, 146, 60, 0.3)');
            ...
            function animate() {
                ...
                const sizesAttr = particlesGeometry.attributes.size.array;
                ...
                for(let i = 0; i < particlesCount; i++) {
                    ...
                    // انیمیشن opacity (بین 0.1 تا 0.5)
                    opacities[i] += opacityVelocities[i];
                    if(opacities[i] > 0.5) {
                        opacities[i] = 0.5;
                        opacityVelocities[i] *= -1;
                    }
                    if(opacities[i] < 0.1) {
                        opacities[i] = 0.1;
                        opacityVelocities[i] *= -1;
                    ...
                    // انیمیشن scale (بین 0.5 تا 1.5) - با محدودیت 30px
                    scales[i] += scaleVelocities[i];
                    if(scales[i] > 1.5) {
                        scales[i] = 1.5;
                        scaleVelocities[i] *= -1;
                    }
                    ...
                    // اعمال scale به size (حداکثر 30px)
                    sizesAttr[i] = Math.min(sizes[i] * scales[i], 30);
                }
                ...
                // opacity کل مش هم تغییر کنه (برای افکت بیشتر)
                particlesMaterial.opacity = 0.4 + Math.sin(time * 0.5) * 0.1;
            ...
            // شروع particles وقتی Three.js آماده شد
            if (typeof THREE !== 'undefined') {
                initScaryParticles();
            } else {
                // اگه هنوز لود نشده، صبر کن تا window.load
                window.addEventListener('load', function() {
                    if (typeof THREE !== 'undefined') {
                        initScaryParticles();
                    } else {
                        console.warn('Three.js could not be loaded for scary particles');
                    }
                });
            }
        })();
            ...
            <div class="mb-6 md:mb-8 lg:-mb-px">
                <div class="flex justify-between">
                    <div class="items-center w-full md:flex gap-0 lg:[&>h2]:bg-slate-50 lg:[&>h2]:h-full lg:[&>h2]:rounded-tr-4xl lg:[&>h2]:rounded-tl-4xl lg:[&>h2]:py-6 [&>h2_b]:text-secondary-500">
                        <h2 class="text-[21px] flex items-center w-full gap-4">
                            <svg class="mx-0" width="38" height="28" viewBox="0 0 38 28" fill="none" xmlns="http://www.w3.org/2000/svg">
...
if ($is_escaperoom) :
    ...
    $horror_escaperooms = json_decode(ez_webservice(array('type' => 'sort_products_get', 'data' => $args)));
...
?>
        <section class="max-w-full py-4 md:py-5 lg:py-9">
                ...
                <div class="flex justify-between">
                    <div class="items-center gap-6 md:flex">
                        <h2 class="flex items-center gap-4">
                            <svg class="mx-0" width="28" height="29" viewBox="0 0 28 29" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <div class="overflow-x-auto transition-all duration-200 scrollbar-hide">
                            <div class="flex gap-2">
                                <button type="button" data-input="scary-room-product" data-params='sort_type:"hottest"'
                                    class="filter-btn text-nowrap text-center text-[12px] font-semibold focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 flex-shrink-0 whitespace-nowrap rounded-2xl bg-primary-500 text-slate-100 border border-primary-500 h-9 min-w-9 px-3 md:px-8 py-1 transition" disabled>
                                    داغ ترین
                                </button>
                                <button type="button" data-input="scary-room-product" data-params='sort_type:"topsale"'
                                    class="flex-shrink-0 px-3 py-1 text-[12px] font-semibold text-center transition bg-white border filter-btn text-nowrap focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 whitespace-nowrap rounded-2xl text-slate-350 border-gray-50 h-9 min-w-9 md:px-8 hover:bg-primary-600 hover:text-white">
                                    پرفروش‌ترین
                                </button>
                    ...
                    <div class="relative block md:hidden">
                        <div class="scrollbar-hide overflow-x-auto transition-all duration-200">
                            <div class="flex border-gray-110 justify-between gap-0 overflow-hidden rounded-lg border">
                                <button type="button" data-input="scary-room-product" data-params='sort_type:"hottest"'
                                    class="filter-btn text-nowrap text-center text-[12px] font-semibold focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 -m-px bg-primary-500 text-white w-full h-9 min-w-9 px-3 md:px-5 py-1" disabled>
                                    داغ ترین
                                </button>
                                <button type="button" data-input="scary-room-product" data-params='sort_type:"topsale"'
                                    class="w-full px-3 py-1 -m-px text-[12px] font-semibold text-center filter-btn text-nowrap focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 text-slate-350 h-9 min-w-9 md:px-5">
                                    پرفروش‌ترین
                                </button>
                                <button type="button" data-input="scary-room-product" data-params='sort_type:"popular"'
                                    class="w-full px-3 py-1 -m-px text-[12px] font-semibold text-center filter-btn text-nowrap focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 text-slate-350 h-9 min-w-9 md:px-5">
            ...
            <div class="relative overflow-hidden embla_normal">
                <div class="embla__viewport">
                    <div id="scary-room-product-slider" class="embla__container first:child:before:hidden child:before:w-px child:before:absolute child:before:bg-gradient-to-t child:before:from-white child:before:via-slate-110 child:before:to-white child:before:-right-3.5 child:lg:before:-right-6 child:before:h-full min-h-[200px] child:box-content lg:min-h-[300px] flex child:ml-7 md:child:ml-12  last:child:ml-0 child:shrink-0 child:grow-0 child:w-[156px] md:child:w-[190px] child:py-2.5 child:relative">
                        <?= $horror_escaperooms->products ?>
                    </div>
                </div>
                <button class="embla__button embla__button--prev scary-room-product-btn absolute right-0 top-1/2 translate-y-[-115px] rotate-180 z-50 cursor-pointer touch-manipulation appearance-none -mr-px hidden" type="button">
                ...
                <button class="embla__button embla__button--next scary-room-product-btn absolute left-0 top-1/2 translate-y-[-115px] z-50 cursor-pointer touch-manipulation appearance-none -ml-px hidden" type="button">
                    <svg xmlns="http://www.w3.org/2000/svg" width="30" fill="none" viewBox="0 0 30 113">
                        <g clip-path="url(#arrow_aa)">
                            <path fill="#BFCBD9" fill-rule="evenodd" d="M0 3.75c0 28.814 30 32.928 30 52.823 0 21.023-30 26.414-30 56.595V3.75Z" clip-rule="evenodd"></path>
                            <path fill="#fff" fill-rule="evenodd" d="M0 1c0 28.814 27 33.679 27 53.573 0 21.022-27 23.914-27 54.094V1Z" clip-rule="evenodd"></path>
...
if ($is_escaperoom) :
    ...
    $nonhorror_escaperooms = json_decode(ez_webservice(array('type' => 'sort_products_get', 'data' => $args)));
    ...
    ?>
        <section class="max-w-full py-4 md:py-5 lg:py-9">
            ...
            <div class="relative overflow-hidden embla_normal">
                <div class="embla__viewport">
                    <div id="noscary-room-product-slider" class="embla__container first:child:before:hidden child:before:w-px child:before:absolute child:before:bg-gradient-to-t child:before:from-white child:before:via-slate-110 child:before:to-white child:before:-right-3.5 child:lg:before:-right-6 child:before:h-full min-h-[200px] child:box-content lg:min-h-[300px] flex child:ml-7 md:child:ml-12  last:child:ml-0 child:shrink-0 child:grow-0 child:w-[156px] md:child:w-[190px] child:py-2.5 child:relative">
                        <?= $nonhorror_escaperooms->products ?>
                    </div>
                </div>
                <button class="embla__button embla__button--prev noscary-room-product-btn absolute right-0 top-1/2 translate-y-[-115px] rotate-180 z-50 cursor-pointer touch-manipulation appearance-none -mr-px hidden" type="button">
                    <svg xmlns="http://www.w3.org/2000/svg" width="30" fill="none" viewBox="0 0 30 113">
                        <g clip-path="url(#arrow_aa)">
                            <path fill="#BFCBD9" fill-rule="evenodd" d="M0 3.75c0 28.814 30 32.928 30 52.823 0 21.023-30 26.414-30 56.595V3.75Z" clip-rule="evenodd"></path>
                            <path fill="#fff" fill-rule="evenodd" d="M0 1c0 28.814 27 33.679 27 53.573 0 21.022-27 23.914-27 54.094V1Z" clip-rule="evenodd"></path>
                ...
                <button class="embla__button embla__button--next noscary-room-product-btn absolute left-0 top-1/2 translate-y-[-115px] z-50 cursor-pointer touch-manipulation appearance-none -ml-px hidden" type="button">
                    <svg xmlns="http://www.w3.org/2000/svg" width="30" fill="none" viewBox="0 0 30 113">
                        <g clip-path="url(#arrow_aa)">
                            <path fill="#BFCBD9" fill-rule="evenodd" d="M0 3.75c0 28.814 30 32.928 30 52.823 0 21.023-30 26.414-30 56.595V3.75Z" clip-rule="evenodd"></path>
                            <path fill="#fff" fill-rule="evenodd" d="M0 1c0 28.814 27 33.679 27 53.573 0 21.022-27 23.914-27 54.094V1Z" clip-rule="evenodd"></path>
                    ...
                    <div class="flex justify-between">
                        <div class="items-center gap-6 md:flex">
                            <h2 class="flex items-center gap-4">
                                ...
                                <div class="text-[13px] font-bold md:text-[15px]">
                        ...
                        <div class="relative content-center hidden md:block">
                            <div class="overflow-x-auto transition-all duration-200 scrollbar-hide">
                                <div class="flex gap-2">
                                    <button type="button" data-input="noscary-room-product" data-params='sort_type:"hottest"'
                                        class="filter-btn text-nowrap text-center text-[12px] font-semibold focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 flex-shrink-0 whitespace-nowrap rounded-2xl bg-primary-500 text-slate-100 border border-primary-500 h-9 min-w-9 px-3 md:px-5 py-1 transition" disabled>
                                        داغ ترین
                                    </button>
                                    <button type="button" data-input="noscary-room-product" data-params='sort_type:"topsale"'
...
if ($product_type != 'سینما ترس') :
    ...
    $discount_products = json_decode(ez_webservice(array('type' => 'sort_products_get', 'data' => $args)));
    if (!is_null($discount_products->products) and !empty($discount_products->products) and (strlen($discount_products->products) > 0)): ?>
                ...
                <div class="flex">
                    <div class="items-center md:flex gap-0 lg:[&>h2]:bg-slate-50 lg:[&>h2]:h-full lg:[&>h2]:rounded-tr-4xl [&>h2_b]:text-secondary-500">
                        <h2 class="flex items-center gap-4 absolute top-5 right-5">
                            ...
                            <span class="text-[25px] font-black">
                                <b>تخفیف داغ هفته</b>
                            </span>
                        </h2>
                        <div class="lg:mr-[-190px] lg:z-[-1]">
                            <svg class="" width="402" height="89" viewBox="0 0 402 89" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <section class="max-w-full py-4 md:py-5 lg:py-9 max-md:bg-[#F1F5F9] max-md:max-w-none max-md:-ml-4 max-md:-mr-4 max-md:py-2.5 max-md:px-8 relative">
                    ...
                    <div class="flex">
                        <div class="items-center md:flex gap-0 lg:[&>h2]:bg-slate-50 lg:[&>h2]:h-full lg:[&>h2]:rounded-tr-4xl lg:[&>h2]:pr-8 [&>h2_b]:text-secondary-500">
                            <h2 class="flex items-center gap-4">
                                ...
                                <span class="text-[29px] font-bold">
                                    <b>تخفیف داغ هفته</b>
                                </span>
                            </h2>
                            <div class="lg:mr-[-190px] lg:z-[-1]">
                            ...
                            <div class="absolute lg:top-px lg:left-0 lg:z-[-2]">
                                <div class="absolute left-12 top-6 countdown-timer rounded-2xl">
                                    <div class="flex items-center gap-2">
                                        ...
                                        <div class="countdown-card rounded-xl w-12 h-12 flex items-center justify-center">
                                            <span class="text-[21px] font-bold text-red-600 countdown-seconds">00</span>
                                        </div>
                                        <span class="text-white text-[17px] font-bold">:</span>
                                        <!-- Minutes -->
                                        <div class="countdown-card rounded-xl w-12 h-12 flex items-center justify-center">
                                            <span class="text-[21px] font-bold text-red-600 countdown-minutes">00</span>
                                        </div>
                                        <span class="text-white text-[17px] font-bold">:</span>
                                        <!-- Hours -->
                                        <div class="countdown-card rounded-xl w-12 h-12 flex items-center justify-center">
                                            <span class="text-[21px] font-bold text-red-600 countdown-hours">00</span>
                                        </div>
                                        <span class="text-white text-[17px] font-bold">:</span>
                                        <!-- Days -->
                                        <div class="countdown-card rounded-xl w-12 h-12 flex items-center justify-center">
                                            <span class="text-[21px] font-bold text-red-600 countdown-days">00</span>
                                        </div>
                                    </div>
                                </div>
            ...
            <div class="lg:py-8 lg:px-25.5 lg:bg-slate-50 rounded-4xl rounded-tr-none">
                <div class="relative w-full max-sm:max-w-[calc(100%+2rem)] max-sm:w-[calc(100%+2rem)] max-sm:-mr-4">
                    <div class="relative overflow-hidden embla_normal slider-event" data-slider-event="discount-slider">
                        <div class="embla__viewport">
                            <div id="discount-events-slider" class="embla__container child:bg-white child:p-2.5 md:child:p-5 child:rounded-3xl flex gap-x-4 md:gap-x-6 child:shrink-0 child:grow-0 child:w-[176px] md:child:w-[230px]"> <?= $discount_products->products ?> </div>
                        </div>
                        <div class="hidden lg:block lg:opacity-80 [&amp;>button]:block [&amp;>button]:h-full [&amp;>button]:top-0 [&amp;>button]:translate-y-0">
    ...
    <div class="horror-all-section relative">
        <div class="container mx-auto px-4">
            <div class="horror-all-wrapper relative">
                ...
                if ($list_description) : ?>
                    <div class="mt-6 mb-4 text-center relative z-10 mx-w-[500px]">
