        ...
        <div class="rounded-tl-none rounded-tr-none lg:px-4">
            <div class="relative overflow-hidden embla_normal slider-event" data-slider-event="off-slider">
                <div class="embla__viewport">
                    <div id="discount-events-slider" class="embla__container child:bg-white child:p-2.5 md:child:p-5 child:rounded-3xl flex gap-x-4 md:gap-x-6 child:shrink-0 child:grow-0 child:w-[176px] md:child:w-[230px]"> <?= $ads_products->products ?> </div>
                </div>
...
?>
    <section class="max-w-full py-4 md:py-5 lg:py-9 mt-6">
        ...
        <div class="flex justify-between mb-6 md:mb-8">
            <div class="items-center gap-6 md:flex">
                <h2 class="flex items-center gap-4">
                    <svg class="mx-0" width="24" height="19" viewBox="0 0 24 19" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M5.13318 17.3633L4.17297 15.6841L2.5006 16.6562C2.27759 16.7847 2.01264 16.8194 1.76404 16.7527C1.51543 16.6859 1.30354 16.5231 1.17497 16.3001C1.0464 16.0771 1.01168 15.8121 1.07846 15.5635C1.14524 15.3149 1.30804 15.103 1.53104 14.9745L14.0136 7.77793C13.636 6.64163 13.6937 5.40563 14.1754 4.30943C14.6572 3.21323 15.5287 2.33488 16.6211 1.84457C17.7135 1.35427 18.949 1.28691 20.0882 1.65556C21.2274 2.02422 22.1892 2.80262 22.7873 3.83996C23.3853 4.87729 23.577 6.09969 23.3253 7.2703C23.0735 8.44091 22.3961 9.47638 21.4244 10.1761C20.4527 10.8758 19.2559 11.1899 18.0659 11.0575C16.8758 10.9251 15.7773 10.3557 14.9831 9.45963L9.19439 12.7891L10.1665 14.4615C10.2295 14.5719 10.2702 14.6938 10.2861 14.82C10.302 14.9462 10.2929 15.0743 10.2591 15.197C10.2268 15.3201 10.1706 15.4355 10.0936 15.5368C10.0166 15.638 9.92033 15.7231 9.81038 15.7871C9.70009 15.8513 9.57818 15.893 9.45169 15.9098C9.3252 15.9267 9.19663 15.9183 9.07339 15.8852C8.95015 15.8521 8.83469 15.7949 8.73366 15.717C8.63263 15.639 8.54803 15.5418 8.48475 15.431L7.57121 13.7644L5.8895 14.7339L6.86156 16.4063C6.92465 16.5168 6.96532 16.6386 6.98122 16.7648C6.99713 16.891 6.98796 17.0192 6.95425 17.1418C6.92196 17.2649 6.8657 17.3803 6.78869 17.4816C6.71168 17.5829 6.61544 17.6679 6.50549 17.7319C6.39261 17.8032 6.2662 17.8503 6.13422 17.8703C6.00223 17.8903 5.86753 17.8828 5.73861 17.8481C5.60968 17.8135 5.48933 17.7526 5.38513 17.6691C5.28093 17.5857 5.19515 17.4815 5.13318 17.3633ZM21.3966 7.00863C21.5454 6.45472 21.5266 5.86913 21.3426 5.3259C21.1586 4.78268 20.8176 4.30623 20.3628 3.9568C19.908 3.60737 19.3597 3.40065 18.7875 3.36278C18.2152 3.32492 17.6445 3.45761 17.1476 3.74408C16.6507 4.03054 16.2499 4.45792 15.996 4.97216C15.742 5.4864 15.6462 6.06441 15.7207 6.63309C15.7952 7.20178 16.0367 7.7356 16.4146 8.16704C16.7925 8.59849 17.2898 8.90819 17.8437 9.05698C18.5865 9.25649 19.3781 9.15277 20.0444 8.76863C20.7107 8.38449 21.1971 7.7514 21.3966 7.00863Z" fill="#0F172B" stroke="#0F172B" />
                    </svg>
        ...
        <div class="relative overflow-hidden embla_normal horizontal dragFree">
            <div class="embla__viewport">
                <div id="cities-rooms-slider" class="embla__container first:child:before:hidden child:before:w-px child:before:absolute child:before:bg-gradient-to-t child:before:from-white child:before:via-slate-110 child:before:to-white child:before:-right-3.5 child:lg:before:-right-6 child:before:h-full min-h-[200px] child:box-content lg:min-h-[300px] flex child:ml-7 md:child:ml-12  last:child:ml-0 child:relative child:shrink-0 child:grow-0 child:w-[156px] md:child:w-[190px] child:py-2.5">
                    <?= $cities_rooms ?>
                </div>
            </div>
...
if (!$is_escaperoom) :
    ...
    foreach ($type_city_list[$product_type_equ] as $type_city_item): ?>
        ...
        $games_products = json_decode(ez_webservice(array('type' => 'sort_products_get', 'data' => $args)));
        if (!is_null($games_products->products) and !empty($games_products->products) and (strlen($games_products->products) > 0)) : ?>
            <section class="max-w-full py-4 md:py-5 lg:py-9 mt-7.5 lg:mt-12">
                ...
                <div class="relative overflow-hidden embla_normal horizontal dragFree">
                    <div class="embla__viewport">
                        <div id="games-<?= $type_city_item ?>-slider" class="embla__container first:child:before:hidden child:before:w-px child:before:absolute child:before:bg-gradient-to-t child:before:from-white child:before:via-slate-110 child:before:to-white child:before:-right-3.5 child:lg:before:-right-6 child:before:h-full min-h-[200px] child:box-content lg:min-h-[300px] flex child:ml-7 md:child:ml-12  last:child:ml-0 child:relative child:shrink-0 child:grow-0 child:w-[156px] md:child:w-[190px] child:py-2.5">
                            <?= $games_products->products ?>
                        </div>
                    </div>
                    <button class="embla__button embla__button--prev games-<?= $type_city_item ?>-btn absolute right-0 top-1/2 translate-y-[-115px] rotate-180 z-50 cursor-pointer touch-manipulation appearance-none -mr-px hidden" type="button">
                        <svg xmlns="http://www.w3.org/2000/svg" width="30" fill="none" viewBox="0 0 30 113">
                            <g clip-path="url(#arrow_aa)">
                                <path fill="#BFCBD9" fill-rule="evenodd" d="M0 3.75c0 28.814 30 32.928 30 52.823 0 21.023-30 26.414-30 56.595V3.75Z" clip-rule="evenodd"></path>
                                <path fill="#fff" fill-rule="evenodd" d="M0 1c0 28.814 27 33.679 27 53.573 0 21.022-27 23.914-27 54.094V1Z" clip-rule="evenodd"></path>
                    ...
                    <button class="embla__button embla__button--next games-<?= $type_city_item ?>-btn absolute left-0 top-1/2 translate-y-[-115px] z-50 cursor-pointer touch-manipulation appearance-none -ml-px hidden" type="button">
                        <svg xmlns="http://www.w3.org/2000/svg" width="30" fill="none" viewBox="0 0 30 113">
                            <g clip-path="url(#arrow_aa)">
                                <path fill="#BFCBD9" fill-rule="evenodd" d="M0 3.75c0 28.814 30 32.928 30 52.823 0 21.023-30 26.414-30 56.595V3.75Z" clip-rule="evenodd"></path>
                                <path fill="#fff" fill-rule="evenodd" d="M0 1c0 28.814 27 33.679 27 53.573 0 21.022-27 23.914-27 54.094V1Z" clip-rule="evenodd"></path>
...
if ($is_escaperoom) :
    ...
    $scary_escape = json_decode(ez_webservice(array('type' => 'sort_products_get', 'data' => $args)));
        ...
        <section class="max-w-full py-4 md:py-5 lg:py-9 md:mt-7.5">
            <div class="mb-6 md:mb-8">
                ...
                <div class="flex justify-between">
                    <div class="items-center gap-6 md:flex">
                        <h2 class="flex items-center gap-4">
                            <svg class="mx-0" width="24" height="19">
            ...
            <div class="relative overflow-hidden embla_normal horizontal dragFree">
                <div class="embla__viewport">
                    <div id="scary-rooms-slider" class="embla__container first:child:before:hidden child:before:w-px child:before:absolute child:before:bg-gradient-to-t child:before:from-white child:before:via-slate-110 child:before:to-white child:before:-right-3.5 child:lg:before:-right-6 child:before:h-full min-h-[200px] child:box-content lg:min-h-[300px] flex child:ml-7 md:child:ml-12  last:child:ml-0 child:relative child:shrink-0 child:grow-0 child:w-[156px] md:child:w-[190px] child:py-2.5">
                        <?= $scary_escape->products ?>
                    </div>
                </div>
                <button class="embla__button embla__button--prev scary-rooms-btn absolute right-0 top-1/2 translate-y-[-115px] rotate-180 z-50 cursor-pointer touch-manipulation appearance-none -mr-px hidden" type="button">
                    <svg xmlns="http://www.w3.org/2000/svg" width="30" fill="none" viewBox="0 0 30 113">
                        <g clip-path="url(#arrow_aa)">
                            <path fill="#BFCBD9" fill-rule="evenodd" d="M0 3.75c0 28.814 30 32.928 30 52.823 0 21.023-30 26.414-30 56.595V3.75Z" clip-rule="evenodd"></path>
                            <path fill="#fff" fill-rule="evenodd" d="M0 1c0 28.814 27 33.679 27 53.573 0 21.022-27 23.914-27 54.094V1Z" clip-rule="evenodd"></path>
                ...
                <button class="embla__button embla__button--next scary-rooms-btn absolute left-0 top-1/2 translate-y-[-115px] z-50 cursor-pointer touch-manipulation appearance-none -ml-px hidden" type="button">
                    <svg xmlns="http://www.w3.org/2000/svg" width="30" fill="none" viewBox="0 0 30 113">
                        <g clip-path="url(#arrow_aa)">
                            <path fill="#BFCBD9" fill-rule="evenodd" d="M0 3.75c0 28.814 30 32.928 30 52.823 0 21.023-30 26.414-30 56.595V3.75Z" clip-rule="evenodd"></path>
                            <path fill="#fff" fill-rule="evenodd" d="M0 1c0 28.814 27 33.679 27 53.573 0 21.022-27 23.914-27 54.094V1Z" clip-rule="evenodd"></path>
...
if ($is_escaperoom) :
    ...
    $noscary_escape = json_decode(ez_webservice(array('type' => 'sort_products_get', 'data' => $args)));
...
?>
        <section class="max-w-full py-4 md:py-5 lg:py-9 md:mt-7.5">
            ...
            <div class="relative overflow-hidden embla_normal horizontal dragFree">
                <div class="embla__viewport">
                    <div id="noscary-rooms-slider" class="embla__container first:child:before:hidden child:before:w-px child:before:absolute child:before:bg-gradient-to-t child:before:from-white child:before:via-slate-110 child:before:to-white child:before:-right-3.5 child:lg:before:-right-6 child:before:h-full min-h-[200px] child:box-content lg:min-h-[300px] flex child:ml-7 md:child:ml-12  last:child:ml-0 child:relative child:shrink-0 child:grow-0 child:w-[156px] md:child:w-[190px] child:py-2.5">
                        <?= $noscary_escape->products ?>
                    </div>
                </div>
                <button class="embla__button embla__button--prev noscary-rooms-btn absolute right-0 top-1/2 translate-y-[-115px] rotate-180 z-50 cursor-pointer touch-manipulation appearance-none -mr-px hidden" type="button">
                    <svg xmlns="http://www.w3.org/2000/svg" width="30" fill="none" viewBox="0 0 30 113">
                        <g clip-path="url(#arrow_aa)">
                            <path fill="#BFCBD9" fill-rule="evenodd" d="M0 3.75c0 28.814 30 32.928 30 52.823 0 21.023-30 26.414-30 56.595V3.75Z" clip-rule="evenodd"></path>
                            <path fill="#fff" fill-rule="evenodd" d="M0 1c0 28.814 27 33.679 27 53.573 0 21.022-27 23.914-27 54.094V1Z" clip-rule="evenodd"></path>
                ...
                <button class="embla__button embla__button--next noscary-rooms-btn absolute left-0 top-1/2 translate-y-[-115px] z-50 cursor-pointer touch-manipulation appearance-none -ml-px hidden" type="button">
                    <svg xmlns="http://www.w3.org/2000/svg" width="30" fill="none" viewBox="0 0 30 113">
                        <g clip-path="url(#arrow_aa)">
                            <path fill="#BFCBD9" fill-rule="evenodd" d="M0 3.75c0 28.814 30 32.928 30 52.823 0 21.023-30 26.414-30 56.595V3.75Z" clip-rule="evenodd"></path>
                            <path fill="#fff" fill-rule="evenodd" d="M0 1c0 28.814 27 33.679 27 53.573 0 21.022-27 23.914-27 54.094V1Z" clip-rule="evenodd"></path>
