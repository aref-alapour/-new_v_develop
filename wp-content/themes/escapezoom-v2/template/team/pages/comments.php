...
<div id="modalOverlay" class="fixed inset-0 z-50 backdrop-blur-sm bg-white/30"
    ...
    <div id="modalContent" class="bg-white rounded-lg w-full max-w-xl p-6 shadow-xl absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2">
        ...
        <div id="actionReasonPanel" class="hidden mt-4 mb-2 border border-[#E8EDF1] rounded-xl p-4 bg-[#FAFDFF]">
            ...
            <textarea id="inlineActionReason" rows="3"
                class="w-full border border-[#E8EDF1] rounded-xl p-3 shadow-3 text-sm outline-none resize-none mb-3"></textarea>
            <button type="button" id="actionReasonProceedBtn"
                class="w-full bg-[#02A159] hover:bg-green-700 text-white py-2 rounded-lg text-base font-yekan-bold cursor-pointer">تأیید و ادامه</button>
        </div>
        ...
        <div id="deleteReasonBox" style="display: none;">
            ...
            <form class="space-y-3">
                ...
                <textarea placeholder="دلیل حذف این کامنت را بنویسید..." id="reason_text" rows="3" class="w-full border border-[#E8EDF1] rounded-md p-2 text-sm resize-none outline-none"></textarea>
        ...
        <div id="editCommentBox" style="display: none;">
            ...
            <form>
                ...
                <textarea id="editReason" placeholder="دلیل ویرایش این کامنت را بنویسید..." rows="3"
                    class="w-full border border-[#E8EDF1] rounded-xl p-3 shadow-3 text-sm outline-none resize-none"></textarea>
    ...
    jQuery(document).ready(function($) {
        ...
        function showTeamActionReasonPanel(mode) {
            ...
            if (mode === 'publish') {
                ...
                $proceed.removeClass('bg-[#D08700] hover:bg-amber-800').addClass('bg-[#02A159] hover:bg-green-700').text('تأیید و انتشار');
            } else if (mode === 'hold') {
                $label.html('دلیل عدم نمایش <span class="text-red-500">*</span>');
                $ta.attr('placeholder', 'دلیل عدم نمایش این کامنت را بنویسید...');
                $proceed.removeClass('bg-[#02A159] hover:bg-green-700').addClass('bg-[#D08700] hover:bg-amber-800').text('تأیید عدم نمایش');
            }
            $ta.val('');
        ...
        function closeModal() {
            ...
            $("#editReason").val('');
            $('#actionReasonProceedBtn').prop('disabled', false).removeClass('bg-[#D08700] hover:bg-amber-800').addClass('bg-[#02A159] hover:bg-green-700').text('تأیید و انتشار');
        }
