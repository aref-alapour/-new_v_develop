<div class="flex justify-between items-center">
    ...
    <div class="flex items-center gap-x-4">
        <div class="relative w-[304px] h-[58px]">
            <input class="searchInput w-[304px] h-[58px] border border-[#E4EBF0] bg-[#FAFDFF] rounded-xl outline-none px-6 py-5 text-xs font-yekan-bold text-navyBlue" placeholder="جست و جو" />
...
<style>
    ...
    /* حذف padding اضافی از px-[34px] در res_row چون در CSS اضافه کردیم */
