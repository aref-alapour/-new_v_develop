<div class="flex justify-between items-center">
    ...
    <div class="flex items-center justify-between gap-x-25">
        <div id="cancellation_history_search" class="relative w-[304px] h-[58px]">
            <input class="w-[304px] h-[58px] border border-[#E4EBF0] bg-[#FAFDFF] rounded-xl outline-none px-6 py-5 text-xs font-bold text-navyBlue" placeholder="جست و جو" id="searchInput" />
        ...
        <a href="<?= home_url('/team/cancellation_requests/') ?>" class="font-extrabold text-[#62748E] flex items-center gap-x-4">
            بازگشت
