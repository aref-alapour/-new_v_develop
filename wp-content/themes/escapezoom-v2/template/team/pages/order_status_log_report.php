	...
	<div class="bg-slate-50 border border-slate-200 rounded-xl p-4">
		<div class="grid grid-cols-1 lg:grid-cols-12 gap-3">
			<div class="lg:col-span-3">
				...
				<input type="number" id="osl-order-id" class="w-full h-11 border border-[#E4EBF0] bg-white rounded-xl outline-none px-4 text-sm" placeholder="مثال: 123456">
			</div>
			<div class="lg:col-span-3">
				<label for="osl-user-id" class="block text-sm font-medium text-slate-700 mb-1">شناسه کاربر</label>
				<input type="number" id="osl-user-id" class="w-full h-11 border border-[#E4EBF0] bg-white rounded-xl outline-none px-4 text-sm" placeholder="مثال: 1001">
			</div>
			<div class="lg:col-span-6 flex items-end gap-2">
				<button type="button" id="osl-search-btn" class="h-11 px-5 rounded-lg bg-[#155DFC] text-white hover:bg-[#1447E6] transition-colors">جستجو</button>
