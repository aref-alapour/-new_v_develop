...
<div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-4 items-end">
    <div>
        ...
        <input type="number" id="audit_product_id" class="w-full border border-[#E4EBF0] rounded-lg px-3 py-2 text-sm" min="0" placeholder="0">
    </div>
    <div>
        <label class="block text-xs font-bold text-navyBlue mb-1">عنوان بازی (جستجو)</label>
        <input type="text" id="audit_product_title" class="w-full border border-[#E4EBF0] rounded-lg px-3 py-2 text-sm" placeholder="بخشی از عنوان">
    </div>
    <div class="md:col-span-2">
        <label class="block text-xs font-bold text-navyBlue mb-1">جستجوی نویسنده کامنت</label>
        <input type="text" id="audit_comment_user_query" class="w-full border border-[#E4EBF0] rounded-lg px-3 py-2 text-sm" placeholder="شناسه، نام، نام خانوادگی یا موبایل">
    </div>
    <div class="md:col-span-2">
        <label class="block text-xs font-bold text-navyBlue mb-1">عامل (ادمین)</label>
        <select id="audit_actor_user_id" class="w-full border border-[#E4EBF0] rounded-lg px-3 py-2 text-sm">
    ...
    <div>
        ...
        <select id="audit_filter_action" class="w-full border border-[#E4EBF0] rounded-lg px-3 py-2 text-sm">
    ...
    <div class="md:col-span-2">
        ...
        <div class="relative border border-[#E4EBF0] rounded-lg bg-[#FAFDFF]">
    ...
    <div class="flex items-end">
        <button type="button" id="audit_filter_btn" class="w-full md:w-auto bg-[#FD7013] hover:bg-[#CA5608] text-white font-bold py-2 px-8 rounded-lg cursor-pointer">
            اعمال فیلتر
        </button>
    </div>
</div>
...
<div id="audit-detail-overlay" class="bg-black/40" style="display: none; position: fixed; inset: 0; z-index: 10050; align-items: center; justify-content: center; padding: 1rem;">
    <div id="audit-detail-modal" class="bg-white rounded-xl shadow-xl max-w-2xl w-full max-h-[90vh] overflow-hidden flex flex-col">
