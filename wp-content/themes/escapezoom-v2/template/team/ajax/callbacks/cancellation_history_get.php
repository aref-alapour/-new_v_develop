...
<section id="ancellTableContainer" class="mt-7">
    <div class="w-full py-4 rounded-t-2.5xl bg-[#E4EBF0] grid">
...
//            $brand_data = get_the_terms($product_id, 'yith_product_brand')[0]; ?>
            ...
            <div class="gap-2 px-2 grid text-sm font-yekan-bold text-grayy text-center py-2.5 <?php echo $row_bg_class; ?>"
                ...
                <p class="text-base font-bold text-[#889BAD] flex gap-2 text-start items-center">
                    <span class="<?php echo $request_info1_class ?>"><?php echo $request_info1_text ?></span>
                    <svg xmlns="http://www.w3.org/2000/svg" width="6" height="6" viewBox="0 0 6 6" fill="none" class="mx-0">
