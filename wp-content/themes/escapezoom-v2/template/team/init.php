...
function get_team_menu_items(): array
{
    return [
        ...
        'collections_wallet'    => ['label' => 'کیف پول مجموعه‌داران', 'roles' => ['administrator', 'supervisor', 'accounting', 'team_admin'],                                  'icon' => 'wallet-icon'],
        ...
        'satisfaction_report'   => ['label' => 'گزارش رضایت',       'roles' => ['administrator', 'supervisor', 'marketing', 'team_admin','poshtiban','sales'],                                      'icon' => 'crm-icon-marketing-reports'],
