...
<section class="lg:mx-75 lg:mt-15 mt-16">
        ...
        <ol class="inline-flex items-center">
			<?php if ( $data['breadcrumb'] ) {
				foreach ( $data['breadcrumb'] as $index => $breadcrumb ) {
					echo '<li class="group border-r border-r-[#E4EBF0] px-2 first:border-r-0 first:pr-0"><div class="flex items-center"><a class="text-2xs font-medium text-slate-310 hover:text-primary-600" href="' . ( ( $index == 0 ) ? home_url() : home_url() . $breadcrumb["url"] ) . '">' . $breadcrumb["title"] . '</a></div></li>';
				}
			} ?>
        </ol>
    </nav>
    <h1 class="my-8.5 text-lg lg:my-10 lg:text-3xl lg:font-black"><?= $data['title'] ?></h1>
    <div class="w-full overflow-hidden rounded-[18px] lg:rounded-4xl">
    ...
    <div class="mb-12.5 mt-10 lg:mb-15">
        <div class="flex items-center justify-between max-lg:gap-3 max-lg:flex-wrap">
            <div class="lg:border-r lg:border-r-[#E4EBF0] lg:pr-5">
                <div class="mb-2">
                    <svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg"
                         class="mx-0 max-lg:hidden">
                ...
                <div class="space-x-10 space-x-reverse">
                    <div class="flex flex-col">
                        <a href="<?php echo get_author_posts_url( get_the_author_meta( 'ID' ) ); ?>" class="mb-2.5 text-16 font-bold text-[#09192d] max-lg:order-1"><?= $data['author'] ?></a>
                        <div class="text-14 font-bold leading-none text-[#889bad]">نویسنده</div>
                    </div>
                </div>
            </div>
            <div class="lg:border-r lg:border-r-[#E4EBF0] lg:pr-5">
                ...
                <div class="space-x-10 space-x-reverse flex">
                    <div class="flex flex-col">
                        <div class="mb-2.5 text-16 font-bold text-[#09192d] max-lg:order-1"><?= parsidate( 'Y.m.d', $data['date'], $lang = 'per' ) ?></div>
                        <div class="text-14 font-bold leading-none text-[#889BAD]">تاریخ انتشار</div>
                    </div>

					<?php if ( ! wp_is_mobile() ) { ?>
                        <div class="flex flex-col">
                            <div class="mb-2.5 text-16 font-bold text-[#09192d] max-lg:order-1"><?= parsidate( 'Y.m.d', $data['rewriting_date'], $lang = 'per' ) ?></div>
                            <div class="text-14 font-bold leading-none text-[#889BAD]">تاریخ بازنویسی</div>
                        </div>
					<?php } ?>
                </div>
            </div>
            <div class="lg:border-r lg:border-r-[#E4EBF0] lg:pr-5">
                ...
                <div>
                    <div class="flex flex-col">
                        <div class="mb-2.5 text-16 font-bold text-[#09192d] max-lg:order-1"><?= number_format( $data['views'] ) ?></div>
                        <div class="text-14 font-bold leading-none text-[#889BAD]">بازدید</div>
                    </div>
                </div>
            </div>
            <div class="lg:border-r lg:border-r-[#E4EBF0] lg:pr-5">
                ...
                <div>
                    <div class="flex flex-col">
                        <div class="mb-2.5 text-16 font-bold text-[#09192d] max-lg:order-1">
							<?php
							$cat    = $data['category'];
							$result = implode( "، ", $cat );
							echo $result; ?>
                        </div>
                        <div class="text-14 font-bold leading-none text-[#889BAD]">دسته بندی</div>
                    </div>
                </div>
            </div>
        </div>
		...
		<?php if ( wp_is_mobile() ) { ?>
            <div class="border-t border-t-[#E4EBF0] pt-4 flex gap-2 items-center justify-end">
                <div class="text-16 font-bold text-[#09192d] max-lg:order-1"><?= parsidate( 'Y.m.d', $data['rewriting_date'], $lang = 'per' ) ?></div>
                <div class="text-14 font-bold leading-none text-[#889BAD]">تاریخ بازنویسی</div>
            </div>
		<?php } ?>
...
<section class="mt-12.5 flex gap-x-10 lg:mt-15 blog-contents">
    <div class="w-[300px] shrink-0 max-lg:hidden">
        <div class="sticky top-0 z-10 flex flex-col items-end gap-4 pt-3">
            <a href="#comments"
               class="group -ml-5 flex flex-nowrap items-center gap-2 border-l-2 border-transparent pl-5 text-xs text-[#09192d] transition-all duration-300 hover:border-l-2 hover:border-primary-500 hover:text-primary-500">
                <span class="h-4 max-w-0 overflow-hidden transition-all duration-300 group-hover:max-w-[200px]">دیدگاه
                    ها
                </span>
                <svg width="18" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <a href="#share"
               class="group -ml-5 flex flex-nowrap items-center gap-2 border-l-2 border-transparent pl-5 text-xs text-[#09192d] transition-all duration-300 hover:border-l-2 hover:border-primary-500 hover:text-primary-500">
                <span class="h-4 max-w-0 overflow-hidden transition-all duration-300 group-hover:max-w-[200px]">اشتراک
                    با دوستان
                </span>
                   ...
                   href="<?= $data['banner1']['url'] ?>">
                    ...
                    <span>
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" width="18" viewBox="0 0 24 24" stroke="currentColor"
                             stroke-linecap="round" stroke-linejoin="round" stroke-width="3" class="text-accent-500">
                ...
                <div class="swiper relatedPostSwiper">
                    <div class="swiper-wrapper pb-12.5">
						<?php foreach ( $data['related'] as $item ): ?>
                            <div class="swiper-slide relative w-[264px] h-[300px]">
                                   ...
                                   href="<?= home_url() . $item['url'] ?>">
                                    ...
                                    <div class="absolute right-0 top-0 flex h-full w-full flex-col justify-between bg-slate-900/60 p-6 text-white/90">
                                        ...
                                        <div class="text-center">
                                            ...
                                            <p class="ez-post-desc mx-auto mt-3.5 max-w-[500px] text-2xs leading-6 lg:mt-5 line-clamp-2" style="background-image: linear-gradient(#FFFFFF, rgba(255,255,255,.6));    color: transparent;background-clip: text;"><?= $item['content'] ?></p>
            ...
            <div id="comments-list">
				...
				<?php if ( count( $data['comments']['items'] ) > 0 ) {
                    ...
                    <div class="border rounded-2xl mt-7 py-15 flex flex-col justify-center items-center gap-4">
                        ...
                        <span class="text-lg text-[#E4EBF0]">
