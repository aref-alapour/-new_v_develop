...
<section class="flex justify-between items-center max-lg:mt-10 lg:mt-8">
    ...
    <a href="javascript:void(0)" onclick="goBack()" class="text-sm font-bold flex items-center gap-x-2 text-slate-350 max-lg:bg-[#F1F5F9] max-lg:rounded-lg max-lg:w-9 max-lg:h-9 max-lg:justify-center max-lg:text-center">
        <span class="mt-1 max-lg:hidden">بازگشت</span>
        <svg class="mx-0" xmlns="http://www.w3.org/2000/svg" width="9" height="13" viewBox="0 0 9 13" fill="none">
...
<form id="game-finder-form">
    ...
    <section
        ...
        <div class="grid grid-cols-3 gap-x-1 lg:gap-x-6 lg:gap-y-5 grow py-8">
            <div class="w-full">
                <div class="mb-2 text-[#62748E] font-bold max-lg:hidden">شهر</div>
            ...
            <div class="w-full">
                <div class="mb-2 text-[#62748E] font-bold max-lg:hidden">نوع بازی</div>
                <div class="relative w-full max-w-xs">
                    <div class="sans-dropdown-container relative">
                        <button type="button"
                            class="sans-dropdown-button w-full bg-white border border-[#ecf2f7]/80 rounded-lg max-lg:shadow-13 h-[48px] px-4 py-2 text-right flex items-center justify-between">
            ...
            <div class="w-full">
                <div class="mb-2 text-[#62748E] font-bold max-lg:hidden">تعداد نفرات</div>
                <div class="relative w-full max-w-xs">
                    <div class="sans-dropdown-container relative">
                        <button type="button"
                            class="sans-dropdown-button w-full bg-white border border-[#ecf2f7]/80 rounded-lg max-lg:shadow-13 h-[48px] px-4 py-2 text-right flex items-center justify-between">
        ...
        <div class="bg-[#E4EBF0] max-lg:w-full max-lg:h-0.5 lg:self-stretch lg:w-0.5 max-lg:my-5"></div>
        <div class="lg:flex max-lg:grid max-lg:grid-cols-2 items-center gap-x-5 shrink-0 lg:py-8">
            ...
            <button type="submit"
                class="max-lg:w-full max-lg:col-span-2 max-lg:h-12 max-lg:rounded-lg lg:w-42 h-[48px] bg-[#02C96F] hover:bg-[#01a75c] shadow-13 shrink-0 rounded-[8px] self-end max-lg:my-5">
