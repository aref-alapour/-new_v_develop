...
?>
<div class="my-6 flex items-stretch justify-between max-lg:border-b max-lg:mb-0 max-lg:pb-6 lg:justify-around lg:rounded-xl lg:border lg:border-[#E8EDF1] lg:py-1 lg:shadow-13">
    <div>
        <div class="text-sm font-bold text-[#91A0A7]">تیکت</div>
        <div class="text-lg font-bold max-lg:text-2xl"><?php echo esc_html( $totals['total_tickets'] ); ?></div>
    </div>
    <div>
        <div class="text-sm font-bold text-[#91A0A7]">درآمد کل (تومان)</div>
