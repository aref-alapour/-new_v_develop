...
<section id="ancellTableContainer" class="desktop-table mt-4">
    <div class="w-full py-4 rounded-t-[12px] bg-[#E4EBF0] grid">
    ...
    <div id="tableBody" class="w-full h-full">
        <?php foreach ($requests as $index => $request) :
            ...
            $brand_data = get_the_terms($request['product_id'], 'yith_product_brand')[0];
...
<section class="mobile-cards mt-4">
    ...
    ?>
        ...
        <section class="request-card flex justify-center items-center mt-5">
            <div class="w-full pt-[20px] border-t border-[#E4EBF0] bg-white">
                <div class="lg:px-[20px]">
