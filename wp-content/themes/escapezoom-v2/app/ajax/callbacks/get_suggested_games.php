<?php
// دریافت بازی‌های پیشنهادی بر اساس citySlug
if (!defined('ABSPATH')) {
...
$city_data = get_option("suggested_products_{$city_slug}", []);
...
if (empty($city_genre_ids)) {
    wp_send_json_error([
        'message' => 'هیچ محصول پیشنهادی برای این شهر و ژانر یافت نشد',
        'city_slug' => $city_slug,
        'term_id' => $term_id
    ]);
}
...
wp_send_json_success([
    ...
    'city_slug' => $city_slug,
    'term_id' => $term_id,
    'message' => 'محصولات پیشنهادی یافت شدند'
]);
