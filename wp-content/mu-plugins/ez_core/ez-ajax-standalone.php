...
$incomingAction = trim( $incomingAction );
\EscapeZoom\Core\Core\Bootstrap::bootMinimal( $incomingAction );
\EscapeZoom\Core\Modules\Booking\BookingGatewayActions::ensureRegistered( $incomingAction );
