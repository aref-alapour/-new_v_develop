<?php
/*
Plugin Name: افزونه پرداخت امن زرین‌پال برای ووکامرس (co)
Version: 99
...
add_action('woocommerce_blocks_loaded', 'zarinpal_gateway_block_support_co');
function zarinpal_gateway_block_support_co() {
    require_once __DIR__ . '/includes/class-wc-zarinpal-gateway-blocks-support.php';
    add_action(
        'woocommerce_blocks_payment_method_type_registration',
        function (Automattic\WooCommerce\Blocks\Payments\PaymentMethodRegistry $payment_method_registry) {
            $payment_method_registry->register(new WC_Zarinpal_Gateway_Blocks_Support_co);
        }
    );
}
